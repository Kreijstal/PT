...
var modules = function(System) {
  ...
  System.registerDynamic("e", [], !0, function(t, e, n) {
    ...
    return e.getNames = r, e.getIgnore = i, e.getBinary = o, n.exports});
  System.registerDynamic("f", [], !0, function(t, e, n) {
    "use strict";

    function r(t) {
      for (var e = "", n = 0; n < t; n++) e += o[Math.floor(Math.random() * o.length)];
      return e
    }
    ...
    return e.randomString = r, e.checkRateLimit = i, n.exports});
  System.registerDynamic("10", [], !0, function(t, e, n) {
    ...
    function i(t, e, n) {
      if (t instanceof Array) {
        if (r(t)) return "writer.measureSimpleArray(" + e + ", " + t.reduce(function(t, e) {
            return t + c[e]
          }, 0) + ")";
        var o = "",
          a = 0;
    ...
    function o(t, e, n, r) {
      if (e instanceof Array)
        if (1 === e.length) t.code += r + "writer.writeArray(" + n + ", function (item) {\n", o(t, e[0], "item", r + "\t"), t.code += r + "});\n";
        else {
          t.code += r + "writer.writeArray(" + n + ", function (item) {\n";
          for (var i = 0; i < e.length; i++) o(t, e[i], "item[" + i + "]", r + "\t");
          t.code += r + "});\n"
        }
      else t.code += r + "writer.write" + f[e] + "(" + n + ");\n"
    }
    ...
    function a(t) {
      ...
      for (var n = 0; n < t.length; n++) o(e, t[n], "args[" + n + "]", "\t\t");
    ...
    function s(t, e) {
      if (t instanceof Array) {
        ...
        if (1 === t.length) n += "\n" + e + "\t" + s(t[0], e + "\t") + "\n" + e;
          ...
          n += "[\n";
          for (var r = 0; r < t.length; r++) n += e + "\t" + s(t[r], e + "\t") + ",\n";
          n += e + "]"
        }
    ...
    function u(t) {
      for (var e = "", n = 0; n < t.length; n++) e += "\t\tresult.push(" + s(t[n], "\t\t") + ");\n";
    ...
    var c = [];
    c[1] = 1, c[0] = 1, c[3] = 2, c[2] = 2, c[5] = 4, c[4] = 4, c[6] = 4, c[7] = 8, c[8] = 1;
    var f = [];
    return f[1] = "Uint8", f[0] = "Int8", f[3] = "Uint16", f[2] = "Int16", f[5] = "Uint32", f[4] = "Int32", f[6] = "Float32", f[7] = "Float64", f[8] = "Boolean", f[9] = "String", f[10] = "Object", e.createHandlers = l, n.exports});
  System.registerDynamic("11", [], !0, function(t, e, n) {
    ...
    var r = function() {
      function t(t, e, n, r, i) {
        this.readNames = t, this.remoteNames = e, this.packetWriter = n, this.packetReader = r, this.supportsBinary = !1, this.lastWriteBinary = !1, this.writeHandlers = i.write, this.readHandlers = i.read
      }
      ...
      return t.prototype.write = function(t, e, n, r) {
        ...
        if (this.supportsBinary && i) {
          ...
          return t.send(o), this.lastWriteBinary = !0, o.byteLength || o.length || 0
        }
        r.unshift(n);
        var a = JSON.stringify(r);
        return t.send(a), a.length
        ...
        var e = this.packetReader.readUint8(),
          ...
          i = [e];
        if (!r) throw new Error("Missing packet handler for: " + n + " (" + e + ")");
        return r(this.packetReader, i), i
        ...
        return c && i(a, s, c, l, o), t.length || t.byteLength || 0
      }, t
    }();
    return e.PacketHandler = r, n.exports});
    ...
    var r = this && this.__extends || function(t, e) {
      ...
      o = function(t) {
        function e(e, n, r, i, o, a, s) {
          t.call(this, e, n, r, i, o), this.ignorePackets = a, this.log = s
        }

        return r(e, t), e.prototype.send = function(t, e, n, r) {
          ...
          return c ? r(a, s, c, l, o) : this.log("invalid message: " + s, o), f
        }, e
      }(i.PacketHandler);
    return e.DebugPacketHandler = o, n.exports});
    ...
    var r = t("14"),
      i = function() {
        ...
        return t.prototype.measureString = function(t) {
          if (null == t) return this.measureLength(-1);
          ...
          if (null == t) this.writeLength(-1);
          else {
            var e = r.encodeString(t);
            this.writeLength(e.length), this.writeBytes(e)
          }
          ...
          null == t ? this.writeLength(-1) : (this.writeLength(t.length), t.forEach(e))
        }, t.prototype.writeLength = function(t) {
          if (t === -1) this.writeUint8(128), this.writeUint8(0);
          else
            do this.writeUint8(127 & t | (t >> 7 ? 128 : 0)), t >>= 7; while (t)
        }, t
      }();
    return e.BasePacketWriter = i, n.exports});
  System.registerDynamic("15", ["13"], !0, function(t, e, n) {
    ...
    var r = this && this.__extends || function(t, e) {
      ...
      o = function(t) {
        function e() {
          t.apply(this, arguments), this.offset = 0
        }

        return r(e, t), e.prototype.getBuffer = function() {
          return this.buffer
        }, e.prototype.init = function(t) {
          this.offset = 0, this.buffer = new ArrayBuffer(t), this.view = new DataView(this.buffer), this.bytes = new Uint8Array(this.buffer)
        }, e.prototype.writeInt8 = function(t) {
          this.view.setInt8(this.offset, t), this.offset += 1
        }, e.prototype.writeUint8 = function(t) {
          this.view.setUint8(this.offset, t), this.offset += 1
        }, e.prototype.writeInt16 = function(t) {
          this.view.setInt16(this.offset, t), this.offset += 2
        }, e.prototype.writeUint16 = function(t) {
          this.view.setUint16(this.offset, t), this.offset += 2
        }, e.prototype.writeInt32 = function(t) {
          this.view.setInt32(this.offset, t), this.offset += 4
        }, e.prototype.writeUint32 = function(t) {
          this.view.setUint32(this.offset, t), this.offset += 4
        }, e.prototype.writeFloat32 = function(t) {
          this.view.setFloat32(this.offset, t), this.offset += 4
        }, e.prototype.writeFloat64 = function(t) {
          this.view.setFloat64(this.offset, t), this.offset += 8
        }, e.prototype.writeBytes = function(t) {
          this.bytes.set(t, this.offset), this.offset += t.length
        }, e
      }(i.BasePacketWriter);
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = o, n.exports});
  System.registerDynamic("14", [], !0, function(t, e, n) {
    ...
    function r(t, e) {
      for (var n = 0; n < t.length; n++) {
        ...
        if (r >= 55296 && r <= 56319 && n + 1 < t.length) {
          ...
          56320 === (64512 & i) && (r = ((1023 & r) << 10) + (1023 & i) + 65536, n++)
        }
        e(r)
      }
    }
    ...
    function a(t) {
      ...
      return r(t, function(t) {
        var r = i(t);
        1 === r ? e[n++] = t : (2 === r ? e[n++] = t >> 6 & 31 | 192 : 3 === r ? (e[n++] = t >> 12 & 15 | 224, e[n++] = t >> 6 & 63 | 128) : (e[n++] = t >> 18 & 7 | 240, e[n++] = t >> 12 & 63 | 128, e[n++] = t >> 6 & 63 | 128), e[n++] = 63 & t | 128)
      }), e
    }

    function s(t, e) {
      if (e >= t.length) throw Error("Invalid byte index");
      var n = t[e];
    ...
    function u(t) {
      ...
      for (var e = "", n = 0; n < t.length;) {
        ...
        if (0 === (128 & r)) i = r;
          ...
          var o = s(t, n++);
          if (i = (31 & r) << 6 | o, i < 128) throw Error("Invalid continuation byte")
        } else if (224 === (240 & r)) {
          var o = s(t, n++),
            a = s(t, n++);
          if (i = (15 & r) << 12 | o << 6 | a, i < 2048) throw Error("Invalid continuation byte");
          if (i >= 55296 && i <= 57343) throw Error("Lone surrogate U+" + i.toString(16).toUpperCase() + " is not a scalar value")
        } else {
          if (240 !== (248 & r)) throw Error("Invalid UTF-8 detected");
          var o = s(t, n++),
            a = s(t, n++),
            u = s(t, n++);
          if (i = (15 & r) << 18 | o << 12 | a << 6 | u, i < 65536 || i > 1114111) throw Error("Invalid continuation byte")
        }
        i > 65535 && (i -= 65536, e += String.fromCharCode(i >>> 10 & 1023 | 55296), i = 56320 | 1023 & i), e += String.fromCharCode(i)
      }
      return e
    }

    return e.stringLengthInBytes = o, e.encodeString = a, e.decodeString = u, n.exports});
  System.registerDynamic("16", ["14"], !0, function(t, e, n) {
    ...
    return e.BasePacketReader = i, n.exports});
  System.registerDynamic("17", ["16"], !0, function(t, e, n) {
    ...
    var r = this && this.__extends || function(t, e) {
      ...
      o = function(t) {
        function e() {
          t.apply(this, arguments), this.offset = 0, this.view = null, this.buffer = null
        }

        return r(e, t), e.prototype.setBuffer = function(t) {
          this.offset = 0, this.buffer = t, this.view = new DataView(this.buffer)
        }, e.prototype.readInt8 = function() {
          return this.offset += 1, this.view.getInt8(this.offset - 1)
        }, e.prototype.readUint8 = function() {
          return this.offset += 1, this.view.getUint8(this.offset - 1)
        }, e.prototype.readInt16 = function() {
          return this.offset += 2, this.view.getInt16(this.offset - 2)
        }, e.prototype.readUint16 = function() {
          return this.offset += 2, this.view.getUint16(this.offset - 2)
        }, e.prototype.readInt32 = function() {
          return this.offset += 4, this.view.getInt32(this.offset - 4)
        }, e.prototype.readUint32 = function() {
          return this.offset += 4, this.view.getUint32(this.offset - 4)
        }, e.prototype.readFloat32 = function() {
          return this.offset += 4, this.view.getFloat32(this.offset - 4)
        }, e.prototype.readFloat64 = function() {
          return this.offset += 8, this.view.getFloat64(this.offset - 8)
        }, e.prototype.readBytes = function(t) {
          return this.offset += t, new Uint8Array(this.view.buffer, this.offset - t, t)
        }, e
      }(i.BasePacketReader);
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = o, n.exports});
  System.registerDynamic("18", ["d", "e", "19", "f", "10", "11", "12", "15", "17", getCodeName("BufferForTheBrowser")], !0, function(t, e, n) {
    return function(n) {
      "use strict";
        ...
        h = function() {
          function t(t, e, n, r) {
            ...
            void 0 === n && (n = function(t) {
              return t()
            }), void 0 === r && (r = console.log.bind(console)), this.options = t, this.errorHandler = e, this.apply = n, this.log = r, this.client = {}, this.server = {}, this.sentSize = 0, this.receivedSize = 0, this.isConnected = !1, this.special = {}, this.connecting = !1, this.lastPing = 0, this.lastSentId = 0, this.versionValidated = !1, this.beforeunload = function() {
              if (i.socket) try {
                i.socket.onclose = null, i.socket.close(), i.socket = null
              } catch (t) {}
            }, this.defers = [], this.inProgressFields = {}, this.rateLimits = [], this.options.server.forEach(function(t, e) {
              "string" == typeof t ? i.createMethod(t, e, {}) : (i.createMethod(t[0], e, t[1]), t[1].rateLimit && (i.rateLimits[e] = {
          ...
          return t.prototype.getWebsocketUrl = function() {
            ...
            if (this.connecting = !0, !this.socket) {
              var e = this.options;
              this.socket = new WebSocket(this.getWebsocketUrl()), window.addEventListener("beforeunload", this.beforeunload);
              var r = new p.default,
                i = new f.default,
              ...
              e.debug ? this.packet = new c.DebugPacketHandler(h, s, i, r, a, d, this.log) : this.packet = new l.PacketHandler(h, s, i, r, a), this.packet.supportsBinary = !!this.socket.binaryType, this.socket.binaryType = "arraybuffer", this.socket.onmessage = function(e) {
                if (e.data) try {
                  t.receivedSize += t.packet.recv(e.data, t.client, t.special)
                } catch (n) {
                  if (!t.errorHandler) throw n;
                  t.errorHandler.handleRecvError(n, e.data)
                } else t.sendPing()
              }, this.socket.onopen = function() {
                e.debug && t.log("socket opened"), t.lastSentId = 0, t.isConnected = !0, t.socket && t.packet.supportsBinary && t.socket.send("undefined" != typeof n ? new n(0) : new ArrayBuffer(0)), t.client.connected && t.client.connected(), e.pingInterval && (t.pingInterval = setInterval(function() {
                  return t.sendPing()
                }, e.pingInterval))
              }, this.socket.onerror = function(n) {
                e.debug && t.log("socket error", n)
              }, this.socket.onclose = function(n) {
                e.debug && t.log("socket closed", n), t.socket = null, t.versionValidated = !1, t.isConnected && (t.isConnected = !1, t.client.disconnected && t.client.disconnected()), t.connecting && (t.reconnectTimeout = setTimeout(function() {
                  t.connect(), t.reconnectTimeout = null
                }, e.reconnectTimeout)), t.defers.forEach(function(t) {
                  return t[1].reject(new Error("disconnected"))
                }), t.defers = [], Object.keys(t.inProgressFields).forEach(function(e) {
                  return t.inProgressFields[e] = 0
                }), t.pingInterval && (clearInterval(t.pingInterval), t.pingInterval = null)
              }
            }
          }, t.prototype.disconnect = function() {
            this.connecting = !1, this.reconnectTimeout && (clearTimeout(this.reconnectTimeout), this.reconnectTimeout = null), this.pingInterval && (clearInterval(this.pingInterval), this.pingInterval = null), this.socket && (this.socket.close(), this.socket = null), window.removeEventListener("beforeunload", this.beforeunload)
          }, t.prototype.sendPing = function() {
            try {
              var t = Date.now();
              this.socket && this.versionValidated && t - this.lastPing > this.options.pingInterval && (this.socket.send(""), this.lastPing = Date.now())
            } catch (t) {}
            ...
            this.server[t] = function() {
              ...
              return !!s.checkRateLimit(e, n.rateLimits) && (n.sentSize += n.packet.send(n.socket, t, e, r), n.lastSentId++, !0)
            }
          }, t.prototype.createPromiseMethod = function(t, e, n) {
            var o = this;
            n && (this.inProgressFields[n] = 0, Object.defineProperty(this.server, n, {
              get: function() {
                return !!o.inProgressFields[n]
              }
            })), this.server[t] = function() {
              for (var u = [], l = 0; l < arguments.length; l++) u[l - 0] = arguments[l];
              if (!o.isConnected) return i.reject(new Error("not connected"));
              if (!s.checkRateLimit(e, o.rateLimits)) return i.reject(new Error("rate limit exceeded"));
              o.sentSize += o.packet.send(o.socket, t, e, u);
              var c = ++o.lastSentId,
                f = r();
              return a.set(o.defers, c, f), o.inProgressFields[n]++, f.promise
            }, this.special["*resolve:" + t] = function(t, e) {
              var r = a.get(o.defers, t);
              r && (a.remove(o.defers, t), o.inProgressFields[n]--, o.apply(function() {
                return r.resolve(e)
              }))
      ...
      e.ClientSocket = h
    }(t(getCodeName("BufferForTheBrowser")).Buffer), n.exports});
  System.registerDynamic("19", [], !0, function(t, e, n) {
    ...
    function i(t, e, n) {
      for (var r = 0; r < t.length; r++)
        if (t[r][0] === e) return void(t[r][1] = n);
      t.push([e, n])
    }
    ...
    return e.get = r, e.set = i, e.remove = o, n.exports});
  System.registerDynamic("1b", ["19"], !0, function(t, e, n) {
    ...
    var l = t("19"),
      c = [],
      f = [];
    return e.Method = r, e.Socket = i, e.getSocketMetadata = o, e.getMethodMetadata = a, e.getMethods = u, n.exports});
  System.registerDynamic("1c", ["e", "18", "1b"], !0, function(t, e, n) {
    ...
    var o = t("1b");
    return e.Method = o.Method, n.exports});
  System.registerDynamic("1d", ["1c"], !0, function(t, e, n) {
    return n.exports = t("1c"), n.exports});
  System.registerDynamic("1e", ["1f", "20", "21", "22", "23", "24"], !0, function(t, e, n) {
    ...
    var r = t("1f"),
      ...
      p = function() {
        function t(t, e, n) {
          this.id = t, this.x = e, this.y = n, this.entities = [], this.entitiesDrawn = 0, this.tiles = new Uint8Array(o.REGION_SIZE * o.REGION_SIZE), this.tileIndices = new Int16Array(o.REGION_SIZE * o.REGION_SIZE), this.randoms = new Int16Array(o.REGION_SIZE * o.REGION_SIZE);
          for (var r = 0; r < this.tiles.length; r++) this.tiles[r] = s.TileType.Dirt, this.tileIndices[r] = -1, this.randoms[r] = Math.floor(1e3 * Math.random())
        }
        ...
        return t.prototype.getTiles = function() {
          ...
          this.tiles = t;
          for (var e = 0; e < this.tiles.length; e++) this.tileIndices[e] = -1
        }, t.prototype.canWalk = function(t, e) {
          if (t < 0 || e < 0 || t > o.REGION_SIZE || e > o.REGION_SIZE) return !1;
          ...
          var n = this;
          this.entitiesDrawn = 0, this.entities.sort(function(t, e) {
            ...
            r.draw && e.isVisible(r) && (r.draw(t), n.entitiesDrawn++), i.debugOptions.showHelpers && (t.globalAlpha = .3, r.collider && t.drawRect(u.RED, f((r.x + r.collider.x) * o.tileWidth), f((r.y + r.collider.y) * o.tileHeight), f(r.collider.w * o.tileWidth), f(r.collider.h * o.tileHeight)), a(r.bounds, u.ORANGE), a(r.coverBounds, u.BLUE), a(r.interactBounds, u.PURPLE), t.globalAlpha = 1)
          })
          ...
          if (e.isRectVisible(r * o.tileWidth, i * o.tileHeight, o.REGION_SIZE * o.tileWidth, o.REGION_SIZE * o.tileHeight))
            for (var s = a.clamp(l(e.x / o.tileWidth - r), 0, o.REGION_SIZE), u = a.clamp(l(e.y / o.tileHeight - i), 0, o.REGION_SIZE), f = a.clamp(c((e.x + e.w) / o.tileWidth - r), 0, o.REGION_SIZE), p = a.clamp(c((e.y + e.h) / o.tileHeight - i), 0, o.REGION_SIZE), h = u; h <= p; h++)
              for (var d = s; d < f; d++) this.drawMapTile(t, d, h, d + r, h + i, n)
          ...
          var r, i = this.getTile(t, e),
            a = 0;
          i === s.TileType.Dirt ? r = 47 : i === s.TileType.Grass && (a += this.getTileType(t - 1, e - 1, n) === i ? 1 : 0, a += this.getTileType(t, e - 1, n) === i ? 2 : 0, a += this.getTileType(t + 1, e - 1, n) === i ? 4 : 0, a += this.getTileType(t - 1, e, n) === i ? 8 : 0, a += this.getTileType(t + 1, e, n) === i ? 16 : 0, a += this.getTileType(t - 1, e + 1, n) === i ? 32 : 0, a += this.getTileType(t, e + 1, n) === i ? 64 : 0, a += this.getTileType(t + 1, e + 1, n) === i ? 128 : 0, r = s.TILE_MAP[a]);
    ...
    return e.Region = p, n.exports});
  System.registerDynamic("25", ["21"], !0, function(t, e, n) {
    "use strict";
    var r = t("21"),
      i = function() {
        function t(t, e, n, r) {
          this.id = t, this.x = e, this.y = n, this.sprite = r, this.type = "doodad";
          var i = this.sprite.w,
            o = this.sprite.h;
          this.bounds = {
            x: -i / 2,
  ...
  System.registerDynamic("26", ["21"], !0, function(t, e, n) {
    ...
    var r = t("21"),
      ...
      o = function() {
        function t(t, e, n, r) {
          this.id = t, this.x = e, this.y = n, this.sprites = r, this.type = "animated", this.time = 5 * Math.random();
          var i = r[0],
            o = i.w,
            a = i.h;
          this.bounds = {
  ...
  System.registerDynamic("27", [getCodeName("Lodash"), "1f", "22", "21", "24"], !0, function(t, e, n) {
    ...
    function o(t, e, n, i) {
      return {
        ...
        draw: function(r) {
          ...
          r.drawSprite(e, x.SHADOW_COLOR, o, a), r.drawSprite(t, null, o, a)
        }
      }
    }
    ...
    function a() {
      ...
      return {
        ...
        draw: function(r) {
          ...
          r.drawSprite(n, x.SHADOW_COLOR, o, a), r.drawSprite(t, null, o, a), r.globalAlpha = 1 - .6 * (this.coverLifting || 0), r.drawSprite(i, null, o, a), r.globalAlpha = 1
        }
      }
    }
    ...
    function s() {
      ...
      return {
        ...
        draw: function(r) {
          ...
          r.drawSprite(n, x.SHADOW_COLOR, i, o), r.globalAlpha = 1 - .6 * (this.coverLifting || 0), r.drawSprite(t, null, i, o), r.globalAlpha = 1
        }
      }
    }
    ...
    return e.treeOffsetX = 72, e.treeOffsetY = 162, e.treeOffset = 30, e.createApple = f, e.createSign = p, e.createRock = h, e.createPumpkin = d, e.createTree = v, e.createTreeCrown = m, e.createTreeStump = g, n.exports});
  System.registerDynamic("29", [getCodeName("Lodash"), "1d", "22", "21", "2a", "2b", "1e", "25", "26", "27", "1f", "2c", "2d"], !0, function(t, e, n) {
    ...
    var r = this && this.__decorate || function(t, e, n, r) {
      ...
      g = t("2d"),
      y = function(t, e) {
        t.player = e, t.player.interactive = !1, s.setupSetTes(e)
      },
      b = m.default.game,
      _ = [5, 9, 10, 6, 6, 6, 6, 1],
      w = function() {
        function t(t, e, n) {
          this.gameService = t, this.server = e, this.$timeout = n
        }

        return t.prototype.connected = function() {
          b.player = null, b.map = new c.Map(0, 0), this.gameService.joined()
        }, t.prototype.disconnected = function() {
          this.gameService.disconnected()
        }, t.prototype.invalidVersion = function() {
          location.reload()
        }, t.prototype.map = function(t) {
          b.baseTime = Date.now() - t.time, b.map = new c.Map(t.regionsX, t.regionsY)
        }, t.prototype.subscribeRegion = function(t, e, n) {
          var r = new f.Region(0, t, e);
          r.load(n), b.map.setRegion(t, e, r)
        }, t.prototype.unsubscribeRegion = function(t, e) {
          b.map.setRegion(t, e, null)
          ...
          var c;
          if ("cloud" === e) c = new p.Doodad(t, r, i, v.cloud);
          else if ("apple" === e) c = d.createApple(t, r, i);
          else if ("rock" === e) c = d.createRock(t, r, i);
          else if ("sign" === e) c = d.createSign(t, r, i, n);
          else if ("tree" === e) c = d.createTree(t, r, i);
          else if ("tree-crown" === e) c = d.createTreeCrown(t, r, i);
          else if ("tree-stump" === e) c = d.createTreeStump(t, r, i);
          else if ("pumpkin" === e) c = d.createPumpkin(t, r, i);
          else if ("butterfly" === e) c = new h.Animated(t, r, i, v.butterfly);
          else if ("pony" === e) {
            var f = n.info,
              m = n.site,
              g = this.gameService.account;
            g.settings.filterSwearWords && f.cmo && t !== this.myId && (f.cm = null), delete n.info, delete n.site, c = new l.Pony(t, f, u, m), o.assign(c, n), c.name = this.filterText(g, c.name, t === this.myId)
          } else console.error("unknown entity type", e);
          c && (c.id = t, c.x = r, c.y = i, c.vx = a, c.vy = s, b.map.addEntity(c), t === this.myId && this.$timeout(function() {
            return y(b, c)
          }))
        }, t.prototype.removeEntity = function(t) {
          b.map.removeEntity(t), b.isSelected(t) && this.$timeout(function() {
            b.isSelected(t) && b.select(null)
          }, 15e3)
        }, t.prototype.updateEntity = function(t, e, n, r, i) {
          var o = b.map.findEntity(t);
          o !== b.player && (o ? (o.x = e, o.y = n, o.vx = r, o.vy = i) : console.error("updateEntity: missing entity", t))
          ...
          var n = b.map.findEntity(t);
          n ? o.assign(n, e) : console.error("updateEntityOptions: missing entity", t)
        }, t.prototype.says = function(t, e, n) {
          var r = b.map.findEntity(t);
          if (r) {
            var i = r.id === this.myId,
              o = this.gameService.account;
            if (!i && o.settings.filterCyrillic && g.containsCyrillic(e)) return;
            if (r.ignored && 2 !== n) return;
            r.says = {
              message: this.filterText(o, e, i),
              timer: u.SAYS_TIME,
              type: n
            }
          } else console.error("says: missing entity", t)
        }, t.prototype.left = function() {
          b.player = null, b.map = new c.Map(0, 0), this.gameService.left()
        }, t.prototype.filterText = function(t, e, n) {
          var r = !n && (t.settings.filterSwearWords || this.gameService.server.filter);
          return r ? g.filterBadWords(e) : e
        }, r([a.Method(), i("design:type", Function), i("design:paramtypes", [Object]), i("design:returntype", void 0)], t.prototype, "map", null), r([a.Method({
          binary: [1, 1, [1]]
        }), i("design:type", Function), i("design:paramtypes", [Number, Number, Array]), i("design:returntype", void 0)], t.prototype, "subscribeRegion", null), r([a.Method({
          binary: [1, 1]
        }), i("design:type", Function), i("design:paramtypes", [Number, Number]), i("design:returntype", void 0)], t.prototype, "unsubscribeRegion", null), r([a.Method({
          binary: [3, 3, 1]
        }), i("design:type", Function), i("design:paramtypes", [Number, Number, Number]), i("design:returntype", void 0)], t.prototype, "updateTile", null), r([a.Method({
          binary: [5]
        }), i("design:type", Function), i("design:paramtypes", [Number]), i("design:returntype", void 0)], t.prototype, "myEntityId", null), r([a.Method({
          binary: [_]
        }), i("design:type", Function), i("design:paramtypes", [Array]), i("design:returntype", void 0)], t.prototype, "addEntities", null),
          r([a.Method({
            binary: _
          }), i("design:type", Function), i("design:paramtypes", [Number, String, Object, Number, Number, Number, Number, Number]), i("design:returntype", void 0)], t.prototype, "addEntity", null), r([a.Method({
          binary: [
            [5, 6, 6, 6, 6, 1],
            [5]
          ]
        }), i("design:type", Function), i("design:paramtypes", [Array, Array]), i("design:returntype", void 0)], t.prototype, "updateEntities", null), r([a.Method(), i("design:type", Function), i("design:paramtypes", [Number, Object]), i("design:returntype", void 0)], t.prototype, "updateEntityOptions", null), r([a.Method(), i("design:type", Function), i("design:paramtypes", [Number, String, Number]), i("design:returntype", void 0)], t.prototype, "says", null), r([a.Method(), i("design:type", Function), i("design:paramtypes", []), i("design:returntype", void 0)], t.prototype, "left", null), t
      }();
    return e.ClientActions = w, n.exports});
  System.registerDynamic("2e", [getCodeName("BlueBird"), getCodeName("Lodash"), "1d", "22", "2c", "29", "20"], !0, function(t, e, n) {
    ...
    var r = t(getCodeName("BlueBird")),
      ...
      f = function() {
        function t(t, e) {
          this.$timeout = t, this.model = e, this.playing = !1, this.joining = !1, this.offline = !1, this.protectionError = !1, this.servers = [], this.initialized = !1, this.updateStatus()
        }
        ...
        return Object.defineProperty(t.prototype, "selected", {
          ...
          r.resolve().then(function() {
            return t.joining || t.playing || !t.account ? null : t.model.status().then(function(e) {
              t.initialized = !0, t.offline = !1, t.version = e.version, i.merge(t.servers, e.servers), !t.server && t.account.settings.defaultServer && (t.server = t.servers.find(function(e) {
                return e.id === t.account.settings.defaultServer
              }), l.debugOptions.autoJoin && setTimeout(function() {
                return t.join(t.model.pony.id)
              }))
            }).catch(function(e) {
              t.offline = e.message === a.OFFLINE_ERROR, t.protectionError = e.message === a.PROTECTION_ERROR
            })
          }).then(function() {
          ...
          var e = this;
          return this.playing || this.joining ? r.resolve() : (this.joining = !0, this.model.join(this.server.id, t).then(function(t) {
            var n = new o.ClientSocket(t);
            n.client = new u.ClientActions(e, n.server, e.$timeout), n.connect(), c.startup(n, function(t) {
              return e.$timeout(t)
            });
            var r = a.start(c),
              i = r.promise,
              s = r.cancel;
            return e.cancelGameLoop = s, i
          }).catch(function(t) {
            throw e.left(), t
          }))
        }, t.prototype.leave = function() {
          c.socket && (c.socket.isConnected ? c.socket.server.leave() : c.socket.disconnect()), this.left()
        }, t.prototype.joined = function() {
          var t = this;
          this.$timeout.cancel(this.disconnectedTimeout), this.$timeout(function() {
            t.joining = !1, t.playing = !0
          })
        }, t.prototype.left = function() {
          var t = this;
          this.cancelGameLoop && (this.cancelGameLoop(), this.cancelGameLoop = null), this.$timeout.cancel(this.disconnectedTimeout), this.$timeout(function() {
            t.joining = !1, t.playing = !1
          }), c.release()
        }, t.prototype.disconnected = function() {
          var t = this;
          this.$timeout.cancel(this.disconnectedTimeout), this.disconnectedTimeout = this.$timeout(function() {
            return t.left()
          }, 1e4)
        }, t.$inject = ["$timeout", "model"], t
      }();
    return e.GameService = f, n.exports});
  System.registerDynamic("30", [], !0, function(t, e, n) {
    ...
    function i(t, e) {
      console.error(t), "undefined" != typeof Rollbar && Rollbar.error(t, e)
    }

    return e.configureUser = r, e.reportError = i, n.exports});
  System.registerDynamic("31", [getCodeName("BlueBird"), getCodeName("Lodash"), "32", "22", "30", "20", "2d"], !0, function(t, e, n) {
    ...
    var o = t(getCodeName("BlueBird")),
      ...
      h = function() {
        function t(t) {
          var e = this;
          this.$http = t, this.loading = !0, this.ponies = [], this.saving = !1, this.sites = [p], this._pony = s.createDefaultPony(), this.getAccount().then(function(t) {
            l.configureUser({
              id: t.id,
              username: t.name,
              custom: {
            ...
            }), e.account = t, e.sites = [p].concat(t.sites.map(f.toSocialSiteInfo)), e.ponies = t.ponies.map(s.decompressPonyInfo).sort(i), e.selectPony(r(e.ponies))
          }).catch(function(t) {
        ...
        return Object.defineProperty(t.prototype, "pony", {
          ...
          return u.toPromise(this.$http.post("/api/account", {
            sri: !window.__sri
          }))
          ...
          var e = this;
          return this.saving ? o.reject(new Error("Saving in progress")) : (this.saving = !0, u.toPromise(this.$http.post("/api/pony/save", {
            pony: t
          })).then(s.decompressPonyInfo).tap(function(n) {
            a.remove(e.ponies, function(e) {
              return e.id === t.id
            }), e.ponies.push(n), e.ponies.sort(i), e.pony === t && e.selectPony(n)
          }).finally(function() {
            return e.saving = !1
          }))
  ...
  System.registerDynamic("33", ["22"], !0, function(t, e, n) {
    ...
    var r = t("22"),
      ...
      o = function() {
        function t(t) {
          this.rect = i, this.scrollLeft = 0, this.scrollTop = 0, this.startX = 0, this.startY = 0, this.button = 0, this.dragging = !1, window.navigator.pointerEnabled ? this.setupEvents(t, "pointerdown", "pointermove", "pointerup") : (this.setupEvents(t, "mousedown", "mousemove", "mouseup"), this.setupEvents(t, "touchstart", "touchmove", "touchend"))
        }
        ...
        return t.prototype.setupEvents = function(t, e, n, o) {
          ...
          t.addEventListener(e, function(e) {
            if (!a.dragging) {
              "self" === a.relative ? (a.rect = t.getBoundingClientRect(), a.scrollLeft = -window.scrollX, a.scrollTop = -window.scrollY) : "parent" === a.relative ? (a.rect = t.parentElement.getBoundingClientRect(), a.scrollLeft = t.parentElement.scrollLeft, a.scrollTop = t.parentElement.scrollTop) : (a.rect = i, a.scrollLeft = 0, a.scrollTop = 0), a.dragging = !0, a.button = r.getButton(e), a.startX = r.getX(e), a.startY = r.getY(e), a.send(e, "start");
              var s, u = e,
                l = function(t) {
                  u = t, t.preventDefault(), a.send(t, "drag")
                },
                c = function(t) {
                  r.getButton(t) === a.button && (r.isTouch(t) || (u = t), s())
                };
              s = function() {
                a.send(u, "end"), window.removeEventListener(n, l), window.removeEventListener(o, c), window.removeEventListener("blur", s), a.dragging = !1
              }, window.addEventListener(n, l), window.addEventListener(o, c), window.addEventListener("blur", s), e.stopPropagation(), a.prevent && e.preventDefault()
            }
          })
    ...
    return e.AgDrag = o, Object.defineProperty(e, "__esModule", {
      value: !0
  ...
  System.registerDynamic("35", ["22", "36", "34"], !0, function(t, e, n) {
    ...
    var r = t("22"),
      ...
      a = function() {
        function t(t) {
          this.$timeout = t, this.s = 0, this.v = 0, this.h = 0, this.lastColor = ""
        }
        ...
        return Object.defineProperty(t.prototype, "inputColor", {
          ...
          get: function() {
            return this.updateHsv(), 100 * this.s
          },
          enumerable: !0,
          configurable: !0
        }), Object.defineProperty(t.prototype, "svTop", {
          get: function() {
            return this.updateHsv(), 100 * (1 - this.v)
          },
          enumerable: !0,
          configurable: !0
        }), Object.defineProperty(t.prototype, "hueTop", {
          get: function() {
            return this.updateHsv(), 100 * this.h / 360
          },
          enumerable: !0,
          configurable: !0
        }), Object.defineProperty(t.prototype, "hue", {
          get: function() {
            return this.updateHsv(), i.default.fromHsva(this.h, 1, 1, 1).css()
          },
          enumerable: !0,
          configurable: !0
        }), t.prototype.focus = function(t) {
          this.open = !0, t.target.select()
        }, t.prototype.dragSV = function(t) {
          var e = t.event,
            n = t.x,
            i = t.y;
          e.preventDefault(), this.updateHsv(), this.s = r.clamp(n / o, 0, 1), this.v = 1 - r.clamp(i / o, 0, 1), this.updateColor()
        }, t.prototype.dragHue = function(t) {
          var e = t.event,
            n = t.y;
          e.preventDefault(), this.updateHsv(), this.h = r.clamp(360 * n / o, 0, 360), this.updateColor()
          ...
          if (this.lastColor !== this.color) {
            var t = i.default.parseWithAlpha(this.color, 1).hsva(this.h),
              ...
              n = t.s,
              r = t.v;
            this.h = e, this.s = n, this.v = r, this.lastColor = this.color
          }
        }, t.prototype.updateColor = function() {
          var t = i.default.fromHsva(this.h, this.s, this.v, 1).css(),
            e = this.color !== t;
          this.lastColor = this.color = t, e && this.changed && this.changed({
            $value: t
          })
  ...
  System.registerDynamic("37", [], !0, function(t, e, n) {
    ...
    var r = function() {
      ...
      return t.prototype.toggle = function() {
        this.disabled || (this.checked = !this.checked, this.changed && this.changed({
          $value: this.checked
        }))
      }, t
    }();
    ...
    var r = t("3a"),
      i = function() {
        ...
        return t.prototype.fillChanged = function(t) {
          ...
          t && (this.fill = this.base, this.outlineLockChanged(this.outlineLocked))
        }, t.prototype.outlineLockChanged = function(t) {
          t && (this.outline = r.fillToOutline(this.fill))
        }, t.prototype.$onChanges = function(t) {
          this.locked && t.base && (this.fill = t.base.currentValue, this.outlineLockChanged(this.outlineLocked))
        }, t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
  ...
  System.registerDynamic("3b", ["22", "36", "3c"], !0, function(t, e, n) {
    ...
    function r(t, e) {
      if (e && 0 !== e.w && 0 !== e.h)
        if (0 === t.w || 0 === t.h) t.x = e.ox, t.y = e.oy, t.w = e.w, t.h = e.h;
        else {
          var n = Math.min(t.x, e.ox),
            r = Math.min(t.y, e.oy);
          t.w = Math.max(t.x + t.w, e.ox + e.w) - n, t.h = Math.max(t.y + t.h, e.oy + e.h) - r, t.x = n, t.y = r
        }
    }

    function i(t, e) {
      r(t, e.fill), r(t, e.outline), r(t, e.extra)
    }

    function o(t, e, n, r, i) {
      var o = Math.round((t.canvas.width / 2 - i.w) / 2 - i.x),
        a = Math.round((t.canvas.height / 2 - i.h) / 2 - i.y);
      e.fill && l.drawColoredSprite(t, e.fill, n, o, a), e.outline && l.drawColoredSprite(t, e.outline, r, o, a), e.extra && l.drawSprite(t, e.extra, o, a)
    }
    ...
    var s = t("22"),
      ...
      f = function() {
        function t(t, e) {
          var n = this;
          this.$element = e, t.$watch("vm.sprite", function() {
            return n.redraw()
          }), t.$watch("vm.circle", function() {
            return n.redraw()
          });
          for (var r = 0; r < 6; r++) t.$watch("vm.fill[" + r + "]", function() {
            return n.redraw()
        ...
        return t.prototype.redraw = function() {
          ...
          clearTimeout(this.timeout), this.timeout = setTimeout(function() {
            ...
            n.save(), n.clearRect(0, 0, e.width, e.height);
            var r = t.sprite;
            if (r) {
              t.circle && (n.fillStyle = u.default.parse(t.circle).css(), n.beginPath(), n.arc(e.width / 2, e.height / 2, e.width / 3, 0, 2 * Math.PI), n.fill()), n.scale(2, 2), s.disableImageSmoothing(n);
              var l = {
                x: 0,
                y: 0,
                w: 0,
              ...
              })) : (i(l, r), o(n, r, a(t.fill, 0), a(t.outline, 0), l))
            }
            n.restore()
          })
  ...
  System.registerDynamic("3d", [], !0, function(t, e, n) {
    return n.exports = '<div class="selection-list"><div class="selection-list-content"><sprite-box ng-repeat="i in vm.sprites track by $index" ng-class="{ active: vm.selected === $index }" ng-click="vm.selected = $index" sprite="i" fill="vm.fill" outline="vm.outline" circle="vm.circle" class="selection-item"></sprite-box></div></div>', n.exports});
        ...
        return t.prototype.$onChanges = function(t) {
          if (t.width || t.height) {
            ...
            for (var e = 0; e < this.height; e++) {
              this.rows[e] = [];
              for (var n = 0; n < this.width; n++) this.rows[e][n] = n + this.width * e
            }
          }
        }, t.prototype.draw = function(t) {
    ...
    var r = t("22"),
      ...
      l = function() {
        ...
        return t.prototype.$onInit = function() {
          var t = this;
          return this.canvas = this.$element[0].querySelector("canvas"), this.interval = setInterval(function() {
            return t.draw()
          }, 1e3 / 24), s.loadSpriteSheets()
          ...
          this.buffer = this.buffer || r.createCanvas(e, n), o.resizeCanvas(this.buffer, e, n);
          var s = this.buffer.getContext("2d"),
            l = Math.round(e / 2),
            c = Math.round(n / 2 + 28);
          this.noBackground ? s.clearRect(0, 0, e, n) : (s.fillStyle = "LightGreen", s.fillRect(0, 0, e, n)), this.pony && a.drawPony2D(s, i.toRenderInfo(this.pony), this.state || a.createDefaultPonyState(), l, c, !1);
          var f = this.canvas.getContext("2d");
          this.noBackground && f.clearRect(0, 0, this.canvas.width, this.canvas.height), f.save(), r.disableImageSmoothing(f), f.scale(t, t), f.drawImage(this.buffer, 0, 0), f.restore()
        }, t.$inject = ["$element"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
  ...
  System.registerDynamic("47", ["21", "2c", "46"], !0, function(t, e, n) {
    ...
    var r = t("21"),
      ...
      a = function() {
        function t(t, e) {
          var n = this;
          this.maxSayLength = r.SAY_MAX_LENGTH, this.isOpen = !1, this.input = e[0].querySelector(".chat-input"), o.onChat = function() {
            return t(function() {
              return n.chat()
            })
        ...
        return t.prototype.send = function() {
          ...
          this.close(), o.player && t && o.socket.server.say(t)
          ...
          this.isOpen || (this.chat(), this.message = "/")
        }, t.prototype.open = function() {
          var t = this;
          this.isOpen || (this.isOpen = !0, setTimeout(function() {
            return t.input.focus()
          }))
        }, t.prototype.close = function() {
          this.isOpen && (this.input.blur(), this.isOpen = !1, this.message = null)
        }, t.prototype.toggle = function() {
          this.isOpen ? this.close() : this.open()
        }, t.$inject = ["$timeout", "$element"], t
      }();
    return e.ChatBox = a, Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = {
      controller: a,
      controllerAs: "vm",
  ...
  System.registerDynamic("49", ["2c", "48"], !0, function(t, e, n) {
    "use strict";
    var r = t("2c"),
      i = r.default.game,
      o = function() {
        function t(t, e) {
          this.$timeout = t, this.gameService = e
        }
        ...
        return Object.defineProperty(t.prototype, "scale", {
          ...
          i.changeScale()
        }, t.$inject = ["$timeout", "gameService"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = {
  ...
  System.registerDynamic("4a", [], !0, function(t, e, n) {
    return n.exports = '<li ng-if="vm.model.account" uib-dropdown><a uib-dropdown-toggle class="cursor-pointer">{{vm.model.account.name}} <span class="caret"></span></a><ul uib-dropdown-menu><li><a href="/account">Account settings</a></li><li><a href="/auth/sign-out" target="_self" class="cursor-pointer">Sign out</a></li></ul></li>', n.exports});
  System.registerDynamic("4b", ["4a"], !0, function(t, e, n) {
    "use strict";
    var r = function() {
      function t(t, e) {
        this.model = e, t.addClass("account-button")
      }

      return t.$inject = ["$element", "model"], t
    }();
    return e.AccountButton = r, Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = {
      controller: r,
      controllerAs: "vm",
  ...
  System.registerDynamic("51", ["22", "20", "50"], !0, function(t, e, n) {
    ...
    var r = t("22"),
      ...
      o = function() {
        function t(t, e, n) {
          this.$location = t, this.gameService = e, this.model = n, this.handleError = r.errorHandler(this)
        }
        ...
        return Object.defineProperty(t.prototype, "server", {
          ...
          var t = this;
          return this.error = null, this.model.savePony(this.model.pony).then(function(e) {
          ...
          location.reload(!0);
        }, t.$inject = ["$location", "gameService", "model"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = {
  ...
  System.registerDynamic("54", [], !0, function(t, e, n) {
    "use strict";
    ! function(t) {
      t[t.None = 0] = "None", t[t.Ignore = 1] = "Ignore", t[t.Unignore = 2] = "Unignore", t[t.Report = 3] = "Report", t[t.Mute = 4] = "Mute", t[t.Unmute = 5] = "Unmute", t[t.Shadow = 6] = "Shadow", t[t.Unshadow = 7] = "Unshadow", t[t.Timeout = 8] = "Timeout"
  ...
  System.registerDynamic("55", [getCodeName("Lodash")], !0, function(t, e, n) {
    ...
    return e.hasRole = r, e.isAdmin = i, e.isMod = o, n.exports});
  System.registerDynamic("56", ["57", "58", "59"], !0, function(t, e, n) {
    "use strict";

    function r(t) {
      m = [t.LINEAR, t.NEAREST_MIPMAP_LINEAR, t.LINEAR_MIPMAP_NEAREST, t.LINEAR_MIPMAP_NEAREST], g = [t.NEAREST, t.LINEAR, t.NEAREST_MIPMAP_NEAREST, t.NEAREST_MIPMAP_LINEAR, t.LINEAR_MIPMAP_NEAREST, t.LINEAR_MIPMAP_LINEAR], y = [t.REPEAT, t.CLAMP_TO_EDGE, t.MIRRORED_REPEAT]
    }

    function i(t, e, n) {
      var r = t.gl,
        i = r.getParameter(r.MAX_TEXTURE_SIZE);
      if (e < 0 || e > i || n < 0 || n > i) throw new Error("gl-texture2d: Invalid texture size");
    ...
    function s(t, e, n, r, i, o, s, u) {
      var l = u.dtype,
        c = u.shape.slice();
      if (c.length < 2 || c.length > 3) throw new Error("gl-texture2d: Invalid ndarray, must be 2d or 3d");
      var f = 0,
        p = 0,
        m = a(c, u.stride.slice());
      "float32" === l ? f = t.FLOAT : "float64" === l ? (f = t.FLOAT, m = !1, l = "float32") : "uint8" === l ? f = t.UNSIGNED_BYTE : (f = t.UNSIGNED_BYTE, m = !1, l = "uint8");
      var g = 1;
      if (2 === c.length) p = t.LUMINANCE, c = [c[0], c[1], 1], u = h(u.data, c, [u.stride[0], u.stride[1], 1], u.offset);
      else {
        if (3 !== c.length) throw new Error("gl-texture2d: Invalid shape for texture");
        if (1 === c[2]) p = t.ALPHA;
        else if (2 === c[2]) p = t.LUMINANCE_ALPHA;
        else if (3 === c[2]) p = t.RGB;
        else {
      ...
      if (p !== t.LUMINANCE && p !== t.ALPHA || i !== t.LUMINANCE && i !== t.ALPHA || (p = i), p !== i) throw new Error("gl-texture2d: Incompatible texture format for setPixels");
      var y = u.size,
        _ = s.indexOf(r) < 0;
      if (_ && s.push(r), f === o && m) 0 === u.offset && u.data.length === y ? _ ? t.texImage2D(t.TEXTURE_2D, r, i, c[0], c[1], 0, i, o, u.data) : t.texSubImage2D(t.TEXTURE_2D, r, e, n, c[0], c[1], i, o, u.data) : _ ? t.texImage2D(t.TEXTURE_2D, r, i, c[0], c[1], 0, i, o, u.data.subarray(u.offset, u.offset + y)) : t.texSubImage2D(t.TEXTURE_2D, r, e, n, c[0], c[1], i, o, u.data.subarray(u.offset, u.offset + y));
      else {
        var w;
        w = o === t.FLOAT ? v.mallocFloat32(y) : v.mallocUint8(y);
        var x = h(w, c, [c[2], c[2] * c[0], 1]);
        f === t.FLOAT && o === t.UNSIGNED_BYTE ? b(x, u) : d.assign(x, u), _ ? t.texImage2D(t.TEXTURE_2D, r, i, c[0], c[1], 0, i, o, w.subarray(0, y)) : t.texSubImage2D(t.TEXTURE_2D, r, e, n, c[0], c[1], i, o, w.subarray(0, y)), o === t.FLOAT ? v.freeFloat32(w) : v.freeUint8(w)
      }
    }
    ...
    function l(t, e, n, r, i) {
      ...
      if (e < 0 || e > a || n < 0 || n > a) throw new Error("gl-texture2d: Invalid texture shape");
      ...
      var s = u(t);
      return t.texImage2D(t.TEXTURE_2D, 0, r, e, n, 0, r, i, null), new o(t, s, e, n, r, i)
    }

    function c(t, e, n, r) {
      var i = u(t);
      return t.texImage2D(t.TEXTURE_2D, 0, n, n, r, e), new o(t, i, 0 | e.width, 0 | e.height, n, r)
    }
    ...
    function f(t, e) {
      ...
      var s = a(r, e.stride.slice()),
        l = 0;
      "float32" === n ? l = t.FLOAT : "float64" === n ? (l = t.FLOAT, s = !1, n = "float32") : "uint8" === n ? l = t.UNSIGNED_BYTE : (l = t.UNSIGNED_BYTE, s = !1, n = "uint8");
      var c = 0;
      if (2 === r.length) c = t.LUMINANCE, r = [r[0], r[1], 1], e = h(e.data, r, [e.stride[0], e.stride[1], 1], e.offset);
      else {
        if (3 !== r.length) throw new Error("gl-texture2d: Invalid shape for texture");
        if (1 === r[2]) c = t.ALPHA;
        else if (2 === r[2]) c = t.LUMINANCE_ALPHA;
        else if (3 === r[2]) c = t.RGB;
        else {
          if (4 !== r[2]) throw new Error("gl-texture2d: Invalid shape for pixel coords");
          c = t.RGBA
        }
      }
      l !== t.FLOAT || t.getExtension("OES_texture_float") || (l = t.UNSIGNED_BYTE, s = !1);
      var f, p, m = e.size;
      if (s) f = 0 === e.offset && e.data.length === m ? e.data : e.data.subarray(e.offset, e.offset + m);
      else {
        var g = [r[2], r[2] * r[0], 1];
        p = v.malloc(m, n);
        var y = h(p, r, g, 0);
        "float32" !== n && "float64" !== n || l !== t.UNSIGNED_BYTE ? d.assign(y, e) : b(y, e), f = p.subarray(0, m)
      }
      var _ = u(t);
      return t.texImage2D(t.TEXTURE_2D, 0, c, r[0], r[1], 0, c, l, f), s || v.free(p), new o(t, _, r[0], r[1], c, l)
    }

    function p(t) {
      if (arguments.length <= 1) throw new Error("gl-texture2d: Missing arguments for texture2d constructor");
      if (m || r(t), "number" == typeof arguments[1]) return l(t, arguments[1], arguments[2], arguments[3] || t.RGBA, arguments[4] || t.UNSIGNED_BYTE);
      ...
      if ("object" == typeof arguments[1]) {
        var e = arguments[1];
        if (e instanceof HTMLCanvasElement || e instanceof HTMLImageElement || e instanceof HTMLVideoElement || e instanceof ImageData) return c(t, e, arguments[2] || t.RGBA, arguments[3] || t.UNSIGNED_BYTE);
        if (e.shape && e.data && e.stride) return f(t, e)
      }
    ...
    return Object.defineProperties(_, {
      minFilter: {
        ...
        set: function(t) {
          this.bind();
          var e = this.gl;
          if (this.type === e.FLOAT && m.indexOf(t) >= 0 && (e.getExtension("OES_texture_float_linear") || (t = e.NEAREST)), g.indexOf(t) < 0) throw new Error("gl-texture2d: Unknown filter mode " + t);
      ...
      var i = this.gl;
      if (this.bind(), Array.isArray(e) ? (r = n, n = 0 | e[1], e = 0 | e[0]) : (e = e || 0, n = n || 0), r = r || 0, t instanceof HTMLCanvasElement || t instanceof ImageData || t instanceof HTMLImageElement || t instanceof HTMLVideoElement) {
        var o = this._mipLevels.indexOf(r) < 0;
        o ? (i.texImage2D(i.TEXTURE_2D, 0, this.format, this.format, this.type, t), this._mipLevels.push(r)) : i.texSubImage2D(i.TEXTURE_2D, r, e, n, this.format, this.type, t)
      } else {
  ...
  System.registerDynamic("5a", ["56"], !0, function(t, e, n) {
    return n.exports = t("56"), n.exports});
  System.registerDynamic("5b", ["5a"], !0, function(t, e, n) {
    ...
    function o(t, e) {
      ...
      y = new Array(n + 1);
      for (var r = 0; r <= n; ++r) {
        for (var i = new Array(n), o = 0; o < r; ++o) i[o] = t.COLOR_ATTACHMENT0 + o;
        for (var o = r; o < n; ++o) i[o] = t.NONE;
        y[r] = i
      }
    }
    ...
    function s(t, e, n, r, i, o) {
      if (!r) return null;
      var a = h(t, e, n, i, r);
      return a.magFilter = t.NEAREST, a.minFilter = t.NEAREST, a.mipSamples = 1, a.bind(), t.framebufferTexture2D(t.FRAMEBUFFER, o, t.TEXTURE_2D, a.handle, 0), a
    }

    function u(t, e, n, r, i) {
      var o = t.createRenderbuffer();
      return t.bindRenderbuffer(t.RENDERBUFFER, o), t.renderbufferStorage(t.RENDERBUFFER, r, e, n), t.framebufferRenderbuffer(t.FRAMEBUFFER, i, t.RENDERBUFFER, o), o
    }
    ...
    function l(t) {
      ...
      for (var m = 0; m < f; ++m) t.color[m] = s(n, l, c, v, n.RGBA, n.COLOR_ATTACHMENT0 + m);
      0 === f ? (t._color_rb = u(n, l, c, n.RGBA4, n.COLOR_ATTACHMENT0), p && p.drawBuffersWEBGL(y[0])) : f > 1 && p.drawBuffersWEBGL(y[f]);
      ...
      if (b !== n.FRAMEBUFFER_COMPLETE) {
        t._destroyed = !0, n.bindFramebuffer(n.FRAMEBUFFER, null), n.deleteFramebuffer(t.handle), t.handle = null, t.depth && (t.depth.dispose(), t.depth = null), t._depth_rb && (n.deleteRenderbuffer(t._depth_rb), t._depth_rb = null);
        for (var m = 0; m < t.color.length; ++m) t.color[m].dispose(), t.color[m] = null;
        t._color_rb && (n.deleteRenderbuffer(t._color_rb), t._color_rb = null), i(n, e), a(b)
      }
      i(n, e)
    }

    function c(t, e, n, r, i, o, a, s) {
      this.gl = t, this._shape = [0 | e, 0 | n], this._destroyed = !1, this._ext = s, this.color = new Array(i);
      for (var u = 0; u < i; ++u) this.color[u] = null;
      this._color_rb = null, this.depth = null, this._depth_rb = null, this._colorType = r, this._useDepth = o, this._useStencil = a;
      var c = this,
        f = [0 | e, 0 | n];
    ...
    function f(t, e, n) {
      ...
      if (t._shape[0] !== e || t._shape[1] !== n) {
        ...
        if (e < 0 || e > s || n < 0 || n > s) throw new Error("gl-fbo: Can't resize FBO, invalid dimensions");
        t._shape[0] = e, t._shape[1] = n;
        for (var u = r(o), l = 0; l < t.color.length; ++l) t.color[l].shape = t._shape;
        t._color_rb && (o.bindRenderbuffer(o.RENDERBUFFER, t._color_rb), o.renderbufferStorage(o.RENDERBUFFER, o.RGBA4, t._shape[0], t._shape[1])), t.depth && (t.depth.shape = t._shape), t._depth_rb && (o.bindRenderbuffer(o.RENDERBUFFER, t._depth_rb), t._useDepth && t._useStencil ? o.renderbufferStorage(o.RENDERBUFFER, o.DEPTH_STENCIL, t._shape[0], t._shape[1]) : t._useDepth ? o.renderbufferStorage(o.RENDERBUFFER, o.DEPTH_COMPONENT16, t._shape[0], t._shape[1]) : t._useStencil && o.renderbufferStorage(o.RENDERBUFFER, o.STENCIL_INDEX, t._shape[0], t._shape[1])), o.bindFramebuffer(o.FRAMEBUFFER, t.handle);
        var c = o.checkFramebufferStatus(o.FRAMEBUFFER);
        c !== o.FRAMEBUFFER_COMPLETE && (t.dispose(), i(o, u), a(c)), i(o, u)
      }
    }

    function p(t, e, n, r) {
      d || (d = t.FRAMEBUFFER_UNSUPPORTED, v = t.FRAMEBUFFER_INCOMPLETE_ATTACHMENT, m = t.FRAMEBUFFER_INCOMPLETE_DIMENSIONS, g = t.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT);
      var i = t.getExtension("WEBGL_draw_buffers");
      if (!y && i && o(t, i), Array.isArray(e) && (r = n, n = 0 | e[1], e = 0 | e[0]), "number" != typeof e) throw new Error("gl-fbo: Missing shape parameter");
      var a = t.getParameter(t.MAX_RENDERBUFFER_SIZE);
      if (e < 0 || e > a || n < 0 || n > a) throw new Error("gl-fbo: Parameters are too large for FBO");
      r = r || {};
      var s = 1;
      if ("color" in r) {
        ...
        if (s > 1) {
          ...
          if (s > t.getParameter(i.MAX_COLOR_ATTACHMENTS_WEBGL)) throw new Error("gl-fbo: Context does not support " + s + " draw buffers")
        }
      }
      var u = t.UNSIGNED_BYTE,
        l = t.getExtension("OES_texture_float");
      if (r.float && s > 0) {
        if (!l) throw new Error("gl-fbo: Context does not support floating point textures");
        u = t.FLOAT
      } else r.preferFloat && s > 0 && l && (u = t.FLOAT);
      var f = !0;
      "depth" in r && (f = !!r.depth);
      var p = !1;
      return "stencil" in r && (p = !!r.stencil), new c(t, e, n, u, s, f, p, i)
    }
    ...
    return Object.defineProperties(b, {
      ...
      width: {
        ...
        set: function(t) {
          return t = 0 | t, f(this, t, this._shape[1]),
            t
        },
        enumerable: !1
      },
      height: {
        ...
        set: function(t) {
          return t = 0 | t, f(this, this._shape[0], t), t
        },
        enumerable: !1
      }
    }), b.bind = function() {
  ...
  System.registerDynamic("5c", ["5b"], !0, function(t, e, n) {
    return n.exports = t("5b"), n.exports});
  System.registerDynamic("2a", ["5e", "22", "21", "44", "32", "5d"], !0, function(t, e, n) {
    "use strict";
    var r = t("5e"),
      i = t("22"),
      o = t("21"),
      ...
      f = function() {
        function t(t, e, n, r) {
          this.id = t, this.site = r, this.type = "pony", this.x = 0, this.y = 0, this.vx = 0, this.vy = 0, this.canCollide = !0, this.collisions = !0, this.collider = {
            x: -.4,
            y: -.2,
            w: .8,
            h: .4
          }, this.interactive = !0, this.selected = !1, this.right = !1, this.walking = !1, this.nextBlink = 0, this.time = 5 * Math.random(), this.state = a.createDefaultPonyState();
          var o = a.PONY_WIDTH,
            u = a.PONY_HEIGHT;
          this.bounds = {
            x: -o / 2,
            ...
            w: 40,
            h: 50
          }, this.info = s.toRenderInfo(s.decompressPonyInfo(e)), this.right = i.hasFlag(n, 1)
        }

        return t.prototype.update = function(t) {
          this.time += t, this.time - this.nextBlink > 1 && (this.nextBlink = this.time + 2 * Math.random() + 3), this.walking = !(!this.vx && !this.vy), this.right = i.isFacingRight(this.vx, this.right);
          var e = Math.floor((this.time - this.nextBlink) * o.frameTime);
          this.state.blinkFrame = a.BLINK_FRAMES[e] || 1, this.state.animation = this.walking ? u.trot : u.stand, this.state.animationFrame = Math.floor(this.time * o.frameTime) % this.state.animation.frames
        }, t.prototype.draw = function(t) {
          r.mat2d.identity(l), r.mat2d.translate(l, l, r.vec2.set(c, Math.round(this.x * o.tileWidth), Math.round(this.y * o.tileHeight))), r.mat2d.scale(l, l, r.vec2.set(c, this.right ? -1 : 1, 1)), t.transform = l, a.drawPonyGL(t, this.info, this.state, 0, 0, this.right, this.selected), t.transform = null
    ...
    return e.Pony = f, n.exports});
  System.registerDynamic("2b", ["21", "22", "23"], !0, function(t, e, n) {
    "use strict";
    ...
    var i = t("21"),
      ...
      s = function() {
        function t(t, e) {
          this.regionsX = t, this.regionsY = e, this.regions = [], this.minRegionX = 0, this.minRegionY = 0, this.maxRegionX = 0, this.maxRegionY = 0, this.updateMinMaxRegion()
        }
        ...
        return Object.defineProperty(t.prototype, "width", {
          ...
          this.minRegionX = this.regionsX, this.minRegionY = this.regionsY, this.maxRegionX = 0, this.maxRegionY = 0;
          for (var t = 0; t < this.regionsY; t++)
            for (var e = 0; e < this.regionsX; e++) this.getRegion(e, t) && (this.minRegionX = Math.min(e, this.minRegionX), this.minRegionY = Math.min(t, this.minRegionY), this.maxRegionX = Math.max(e, this.maxRegionX), this.maxRegionY = Math.max(t, this.maxRegionY))
        }, t.prototype.setRegion = function(t, e, n) {
          t >= 0 && e >= 0 && t < this.regionsX && e < this.regionsY && (this.regions[t + e * this.regionsX] = null, this.setDirty(t * i.REGION_SIZE - 1, e * i.REGION_SIZE - 1, i.REGION_SIZE + 2, i.REGION_SIZE + 2), this.regions[t + e * this.regionsX] = n, this.updateMinMaxRegion())
          ...
          for (var i = 0; i < r; i++)
            for (var o = 0; o < n; o++) this.doRelativeToRegion(o + t, i + e, function(t, e, n) {
              return t.setDirty(e, n)
            })
        }, t.prototype.isCollision = function(t, e, n) {
          var r = this.getTile(e, n);
          if (!a.canWalk(r)) return !0;
          if (!t.collider) return !1;
          var i = !1;
          ...
          this.forEachRegion(function(n) {
            n.entities.forEach(function(n) {
              if (n.update && n.update(t), n.vx || n.vy)
                if (n.canCollide) {
                  var r = n.x + n.vx * t,
                    i = n.y + n.vy * t;
                  e.isCollision(n, r, i) ? e.isCollision(n, n.x, i) ? e.isCollision(n, r, n.y) || (n.x = r) : n.y = i : (n.x = r, n.y = i)
                } else n.x += n.vx * t, n.y += n.vy * t;
              if (n.set && n.set(), n.says && (n.says.timer -= t, n.says.timer < 0 && (n.says.timer = 0, n.says = null)), n.coverBounds) {
    ...
    var r = t("21"),
      ...
      o = function() {
        ...
        return t.prototype.update = function(t, e) {
          ...
          this.x = Math.floor(i.clamp(this.x, d, v)), this.y = Math.floor(i.clamp(this.y, m, g))
  ...
  System.registerDynamic("23", [], !0, function(t, e, n) {
    ...
    ! function(t) {
      t[t.None = 0] = "None", t[t.Dirt = 1] = "Dirt", t[t.Grass = 2] = "Grass"
    ...
    e.TILE_COUNTS = [
      ...
      [14, 3],
      [47, 4]
    ], e.TILE_COUNT_MAP = [], e.TILE_MAP_MAP = [], e.TILE_COUNTS.forEach(function(t) {
      var n = t[0],
        r = t[1];
      return e.TILE_COUNT_MAP[n] = r
    });
    for (var a = 0, s = 0; s <= 47; s++) e.TILE_MAP_MAP[s] = a, a += e.TILE_COUNT_MAP[s] || 1;
    return e.canWalk = r, e.isValidTile = i, e.TILE_MAP = [46, 46, 22, 22, 46, 46, 22, 22, 21, 21, 17, 11, 21, 21, 17, 11, 19, 19, 18, 18, 19, 19, 12, 12, 14, 14, 24, 28, 14, 14, 30, 6, 46, 46, 22, 22, 46, 46, 22, 22, 21, 21, 17, 11, 21, 21, 17, 11, 19, 19, 18, 18, 19, 19, 12, 12, 14, 14, 24, 28, 14, 14, 30, 6, 20, 20, 13, 13, 20, 20, 13, 13, 16, 16, 23, 32, 16, 16, 23, 32, 15, 15, 25, 25, 15, 15, 34, 34, 26, 26, 45, 41, 26, 26, 42, 36, 20, 20, 13, 13, 20, 20, 13, 13, 10, 10, 31, 4, 10, 10, 31, 4, 15, 15, 25, 25, 15, 15, 34, 34, 27, 27, 43, 37, 27, 27, 35, 5, 46, 46, 22, 22, 46, 46, 22, 22, 21, 21, 17, 11, 21, 21, 17, 11, 19, 19, 18, 18, 19, 19, 12, 12, 14, 14, 24, 28, 14, 14, 30, 6, 46, 46, 22, 22, 46, 46, 22, 22, 21, 21, 17, 11, 21, 21, 17, 11, 19, 19, 18, 18, 19, 19, 12, 12, 14, 14, 24, 28, 14, 14, 30, 6, 20, 20, 13, 13, 20, 20, 13, 13, 16, 16, 23, 32, 16, 16, 23, 32, 9, 9, 33, 33, 9, 9, 8, 8, 29, 29, 44, 39, 29, 29, 38, 7, 20, 20, 13, 13, 20, 20, 13, 13, 10, 10, 31, 4, 10, 10, 31, 4, 9, 9, 33, 33, 9, 9, 8, 8, 2, 2, 40, 3, 2, 2, 1, 0], n.exports});
  System.registerDynamic("60", [getCodeName("Lodash"), "36", "24"], !0, function(t, e, n) {
    ...
    var o = t(getCodeName("Lodash")),
      ...
      d = 288e4;
    return e.getLight = r, e.getTime = i, n.exports});
  System.registerDynamic("61", ["59", "58", "57"], !0, function(t, e, n) {
    ...
    function i(t, e, n, r, i, o) {
      ...
      if (a + o > n) throw new Error("gl-buffer: If resizing buffer, must not specify offset");
      return t.bufferSubData(e, o, i), n
    }

    function o(t, e) {
      for (var n = u.malloc(t.length, e), r = t.length, i = 0; i < r; ++i) n[i] = t[i];
      return n
    }
    ...
    function s(t, e, n, i) {
      if (n = n || t.ARRAY_BUFFER, i = i || t.DYNAMIC_DRAW, n !== t.ARRAY_BUFFER && n !== t.ELEMENT_ARRAY_BUFFER) throw new Error("gl-buffer: Invalid type for webgl buffer, must be either gl.ARRAY_BUFFER or gl.ELEMENT_ARRAY_BUFFER");
      if (i !== t.DYNAMIC_DRAW && i !== t.STATIC_DRAW && i !== t.STREAM_DRAW) throw new Error("gl-buffer: Invalid usage for buffer, must be either gl.DYNAMIC_DRAW, gl.STATIC_DRAW or gl.STREAM_DRAW");
    ...
    return p.bind = function() {
      ...
      if ("number" != typeof e && (e = -1), this.bind(), "object" == typeof t && "undefined" != typeof t.shape) {
        ...
        if (n === t.dtype && a(t.shape, t.stride)) 0 === t.offset && t.data.length === t.shape[0] ? this.length = i(this.gl, this.type, this.length, this.usage, t.data, e) : this.length = i(this.gl, this.type, this.length, this.usage, t.data.subarray(t.offset, t.shape[0]), e);
        else {
          var s = u.malloc(t.size, n),
            p = c(s, t.shape);
          l.assign(p, t), e < 0 ? this.length = i(this.gl, this.type, this.length, this.usage, s, e) : this.length = i(this.gl, this.type, this.length, this.usage, s.subarray(0, t.size), e), u.free(s)
        }
      } else if (Array.isArray(t)) {
        var h;
        h = this.type === this.gl.ELEMENT_ARRAY_BUFFER ? o(t, "uint16") : o(t, "float32"), e < 0 ? this.length = i(this.gl, this.type, this.length, this.usage, h, e) : this.length = i(this.gl, this.type, this.length, this.usage, h.subarray(0, t.length), e), u.free(h)
      } else if ("object" == typeof t && "number" == typeof t.length) this.length = i(this.gl, this.type, this.length, this.usage, t, e);
      else {
  ...
  System.registerDynamic("62", ["61"], !0, function(t, e, n) {
    return n.exports = t("61"), n.exports});
  System.registerDynamic("63", ["64"], !0, function(t, e, n) {
    ...
    return r.prototype.bind = function(t) {
      ...
      if (this.bind(), a(this.gl, e, t), this.unbind(), this._attribs.length = 0, t)
  ...
  System.registerDynamic("64", [], !0, function(t, e, n) {
    ...
    function r(t, e, n) {
      ...
      if (n) {
        if (n.length > r) throw new Error("gl-vao: Too many vertex attributes (" + n.length + "/" + r + ")");
        for (var i = 0; i < n.length; ++i) {
          ...
          if (o.buffer) {
            var a = o.buffer,
              ...
              c = o.stride || 0,
              f = o.offset || 0;
            a.bind(), t.enableVertexAttribArray(i), t.vertexAttribPointer(i, s, u, l, c, f)
          } else {
        ...
        for (var i = 0; i < r; ++i) t.disableVertexAttribArray(i)
      }
    }

    return n.exports = r, n.exports});
  System.registerDynamic("65", ["64"], !0, function(t, e, n) {
    ...
    }, r.prototype.dispose = function() {}, r.prototype.unbind = function() {}, r.prototype.draw = function(t, e, n) {
      n = n || 0;
      var r = this.gl;
  ...
  System.registerDynamic("66", ["63", "65"], !0, function(t, e, n) {
    ...
    function i(t, e, n, i) {
      ...
      return s = u ? o(t, u) : a(t), s.update(e, n, i), s
    }
  ...
  System.registerDynamic("67", ["66"], !0, function(t, e, n) {
    return n.exports = t("66"), n.exports});
  System.registerDynamic("68", ["62", "6a", "67", "22", "24", "69"], !0, function(t, e, n) {
    ...
    function r(t, e, n, r, i, o, a, s) {
      if (s) {
        var u = t;
        t = s[0] * u + s[2] * e + s[4], e = s[1] * u + s[3] * e + s[5]
      }
      return o[a++] = t, o[a++] = e, o[a++] = n, o[a++] = r, o[a++] = i, a
    }
    ...
    var i = t("62"),
      ...
      d = function() {
        function t(t) {
          this.gl = t, this.tris = 0, this.globalAlpha = 1, this.count = 0, this.capacity = 0, this.index = 0, this.ensureCapacity(f);
          var e = s.createCanvas(1, 1),
            n = e.getContext("2d");
          n.fillStyle = "white", n.fillRect(0, 0, 1, 1), this.defaultTexture = o(t, e)
        }

        return t.prototype.dispose = function() {
          this.vertexBuffer && (this.vertexBuffer.dispose(), this.vertexBuffer = null), this.indexBuffer && (this.indexBuffer.dispose(), this.indexBuffer = null), this.vao && (this.vao.dispose(), this.vao = null)
        }, t.prototype.begin = function(t) {
          t.bind(), this.tris = 0, this.texture = this.defaultTexture, this.vao.bind()
        }, t.prototype.drawImage = function(t, e, n, i, o, a, s, l, c, f) {
          t = t || this.defaultTexture, this.texture !== t && this.flush(), this.ensureCapacity(this.count + 1) || (this.flush(), this.ensureCapacity(this.count + 1)), this.texture = t, e || (e = u.WHITE);
          var p = e.toFloat(this.globalAlpha),
            ...
            S = this.transform,
            T = this.index;
          T = r(_, w, m, g, p, $, T, S), T = r(x, w, y, g, p, $, T, S), T = r(x, E, y, b, p, $, T, S), T = r(_, E, m, b, p, $, T, S), this.index = T, this.count++, this.tris += 2
          ...
          if (this.capacity < t) {
            ...
            this.vertices && n.set(this.vertices), this.capacity = e, this.vertices = n, this.indices = l.createIndices(this.capacity), this.dispose();
            var r = this.gl.STATIC_DRAW,
              o = 4 * h;
            this.vertexBuffer = i(this.gl, this.vertices, this.gl.ARRAY_BUFFER, r), this.indexBuffer = i(this.gl, this.indices, this.gl.ELEMENT_ARRAY_BUFFER, this.gl.STATIC_DRAW), this.vao = a(this.gl, [{
              name: "position",
          ...
          if (this.index && this.texture) {
            ...
            this.vertexBuffer.update(t, 0), this.texture && this.texture.bind(0);
            var e = this.index / (4 * h);
            e && this.vao.draw(this.gl.TRIANGLES, 6 * e, 0), this.texture = null, this.count = 0, this.index = 0
          }
        }, t
      }();
    return e.SpriteBatch = d, n.exports});
  System.registerDynamic("6b", [], !0, function(t, e, n) {
    ...
    var o = function() {
      function t(t, e, n, i, o) {
        if (this.t = e, this.l = n, this.b = i, this.r = o, !t.tex) throw new Error("creating sprite button before sprites texture initialization");
        this.topLeft = r(t, t.x, t.y, n, e), this.topRight = r(t, t.x + t.w - o, t.y, o, e), this.bottomLeft = r(t, t.x, t.y + t.h - i, n, i), this.bottomRight = r(t, t.x + t.w - o, t.y + t.h - i, o, i), this.top = r(t, t.x + n, t.y, t.w - (n + o), e), this.bottom = r(t, t.x + n, t.y + t.h - i, t.w - (n + o), i), this.left = r(t, t.x, t.y + e, n, t.h - (e + i)), this.right = r(t, t.x + t.w - o, t.y + e, o, t.h - (e + i)), this.bg = r(t, t.x + n, t.y + e, t.w - (n + o), t.h - (e + i))
      }
      ...
      return t.prototype.draw = function(t, e, n, r, o, a) {
        var s = n + o - this.r,
          ...
          l = o - (this.l + this.r),
          c = a - (this.t + this.b);
        t.drawSprite(this.topLeft, e, n, r), t.drawSprite(this.topRight, e, s, r), t.drawSprite(this.bottomLeft, e, n, u), t.drawSprite(this.bottomRight, e, s, u), i(t, this.top, e, n + this.l, r, l, this.t), i(t, this.left, e, n, r + this.t, this.l, c), i(t, this.bg, e, n + this.l, r + this.t, l, c), i(t, this.right, e, n + o - this.r, r + this.t, this.r, c), i(t, this.bottom, e, n + this.l, r + a - this.b, l, this.b)
      }, t
    }();
    return e.SpriteButton = o, n.exports});
  System.registerDynamic("6c", ["22"], !0, function(t, e, n) {
    ...
    var r = t("22"),
      ...
      l = function() {
        function t(t) {
          var e = this;
          this.lineSpacing = 2, this.characterSpacing = 1, this.chars = [], this.emotes = [], this.emotePictures = [], t.forEach(function(t) {
            t && (e.chars[t.code] = t.sprite)
          });
          var n = this.chars[0],
            r = 3;
          this.height = n.h, this.chars[i] = {
            x: 0,
            y: 0,
            w: r,
            h: n.h,
        ...
        return t.prototype.getChar = function(t) {
          ...
          for (var n = 0; n < t.length; n++) {
            var i = n,
              o = t.charCodeAt(n);
            r.isSurrogate(o) && n + 1 < t.length && (o = r.fromSurrogate(o, t.charCodeAt(n + 1)), n++), o !== u && e(o, i)
          }
          ...
          r.isSurrogate(i) && e.length > 1 && (i = r.fromSurrogate(i, e.charCodeAt(1))), n && (this.emotePictures[i] = n)
          ...
          if (o) return t.drawSprite(o, null, r, i - 1), o.w;
          var a = this.getChar(e);
          return t.drawSprite(a, n, r, i), a.w
          ...
          return this.forEachChar(t, function(t) {
            t === s ? (n = Math.max(n, i), i = 0, r++) : (i && (i += e.characterSpacing), i += e.measureChar(t))
          }), {
            w: Math.max(n, i),
          ...
          this.forEachChar(e, function(e, u) {
            e === s ? (a = r, i += o.height + o.lineSpacing) : a += o.drawChar(t, e, n, a, i) + o.characterSpacing
          })
          ...
          this.forEachChar(e, function(e, l) {
            e === s ? (u = r, i += a.height + a.lineSpacing) : u += a.drawChar(t, e, n, u, o && o.indexOf(l) !== -1 ? i - 1 : i) + a.characterSpacing
          })
        }, t.prototype.drawTextAligned = function(t, e, n, r, i, o) {
          void 0 === i && (i = "left"), void 0 === o && (o = "top");
          var a = r.x,
            s = r.y;
          if ("left" !== i || "top" !== o) {
            var u = this.measureText(e);
            "left" !== i && (a += "center" === i ? (r.w - u.w) / 2 : r.w - u.w), "top" !== o && (s += "middle" === o ? (r.h - u.h) / 2 : r.h - u.h)
          }
          this.drawText(t, e, n, a, s)
        }, t
      }();
    return e.SpriteFont = l, n.exports});
  ...
  System.registerDynamic("6e", ["6d"], !0, function(t, e, n) {
    return n.exports = t("6d"), n.exports});
  System.registerDynamic("6f", [getCodeName("BufferForTheBrowser")], !0, function(t, e, n) {
    return function(t) {
      function e(t) {
  ...
  System.registerDynamic("70", ["6f"], !0, function(t, e, n) {
    return n.exports = t("6f"), n.exports});
  System.registerDynamic("71", ["6e", "70"], !0, function(t, e, n) {
    ...
    function o(t, e) {
      ...
      for (var m = 0; m < e; ++m) o.push("if(typeof i" + m + "==='number'&&i" + m + ">=0){d=i" + m + "|0;b+=c" + m + "*d;a" + m + "-=d}");
      o.push("return new " + n + "(this.data," + s.map(function(t) {
          return "a" + t
        }).join(",") + "," + s.map(function(t) {
          return "c" + t
        }).join(",") + ",b)}"), o.push("proto.step=function " + n + "_step(" + l.join(",") + "){var " + s.map(function(t) {
          return "a" + t + "=this.shape[" + t + "]"
        }).join(",") + "," + s.map(function(t) {
          return "b" + t + "=this.stride[" + t + "]"
        }).join(",") + ",c=this.offset,d=0,ceil=Math.ceil");
      for (var m = 0; m < e; ++m) o.push("if(typeof i" + m + "==='number'){d=i" + m + "|0;if(d<0){c+=b" + m + "*(a" + m + "-1);a" + m + "=ceil(-a" + m + "/d)}else{a" + m + "=ceil(a" + m + "/d)}b" + m + "*=d}");
      o.push("return new " + n + "(this.data," + s.map(function(t) {
          return "a" + t
        }).join(",") + "," + s.map(function(t) {
          return "b" + t
        }).join(",") + ",c)}");
      for (var g = new Array(e), y = new Array(e), m = 0; m < e; ++m) g[m] = "a[i" + m + "]", y[m] = "b[i" + m + "]";
      o.push("proto.transpose=function " + n + "_transpose(" + l + "){" + l.map(function(t, e) {
          return t + "=(" + t + "===undefined?" + e + ":" + t + "|0)"
        }).join(";"), "var a=this.shape,b=this.stride;return new " + n + "(this.data," + g.join(",") + "," + y.join(",") + ",this.offset)}"), o.push("proto.pick=function " + n + "_pick(" + l + "){var a=[],b=[],c=this.offset");
      for (var m = 0; m < e; ++m) o.push("if(typeof i" + m + "==='number'&&i" + m + ">=0){c=(c+this.stride[" + m + "]*i" + m + ")|0}else{a.push(this.shape[" + m + "]);b.push(this.stride[" + m + "])}");
      o.push("var ctor=CTOR_LIST[a.length+1];return ctor(this.data,a,b,c)}"), o.push("return function construct_" + n + "(data,shape,stride,offset){return new " + n + "(data," + s.map(function(t) {
          return "shape[" + t + "]"
        }).join(",") + "," + s.map(function(t) {
          return "stride[" + t + "]"
        }).join(",") + ",offset)}");
    ...
    function a(t) {
      ...
      if (c) switch (Object.prototype.toString.call(t)) {
    ...
    function s(t, e, n, r) {
      ...
      if (void 0 === n) {
        n = new Array(s);
        for (var u = s - 1, l = 1; u >= 0; --u) n[u] = l, l *= e[u]
      }
      if (void 0 === r) {
        r = 0;
        for (var u = 0; u < s; ++u) n[u] < 0 && (r -= (e[u] - 1) * n[u])
      }
      for (var c = a(t), p = f[c]; p.length <= s + 1;) p.push(o(c, p.length - 1));
      var i = p[s + 1];
      return i(t, e, n, r)
    }
    ...
    return n.exports = s, n.exports});
  System.registerDynamic("57", ["71"], !0, function(t, e, n) {
    return n.exports = t("71"), n.exports});
  System.registerDynamic("72", [], !0, function(t, e, n) {
    ...
    function o(t, e, n) {
      return 0 === t.length ? t : e ? (n || t.sort(e), r(t, e)) : (n || t.sort(), i(t))
    }

    return n.exports = o, n.exports});
  System.registerDynamic("73", ["72"], !0, function(t, e, n) {
    return n.exports = t("72"), n.exports});
    ...
    return function(e) {
      ...
      function r(t, e, n) {
        var r, i, o = t.length,
          ...
          c = 0,
          f = 0;
        for (r = 0; r < o; ++r) l.push(["i", r, "=0"].join(""));
        for (i = 0; i < a; ++i)
          for (r = 0; r < o; ++r) f = c, c = t[r], 0 === r ? l.push(["d", i, "s", r, "=t", i, "p", c].join("")) : l.push(["d", i, "s", r, "=(t", i, "p", c, "-s", f, "*t", i, "p", f, ")"].join(""));
        for (u.push("var " + l.join(",")), r = o - 1; r >= 0; --r) c = t[r], u.push(["for(i", r, "=0;i", r, "<s", c, ";++i", r, "){"].join(""));
        for (u.push(n), r = 0; r < o; ++r) {
          for (f = c, c = t[r], i = 0; i < a; ++i) u.push(["p", i, "+=d", i, "s", r].join(""));
          s && (r > 0 && u.push(["index[", f, "]-=s", f].join("")), u.push(["++index[", c, "]"].join(""))), u.push("}")
        }
        return u.join("\n")
      }

      function i(t, e, n, i) {
        for (var o = e.length, a = n.arrayArgs.length, s = n.blockSize, u = n.indexArgs.length > 0, l = [], c = 0; c < a; ++c) l.push(["var offset", c, "=p", c].join(""));
        for (var c = t; c < o; ++c) l.push(["for(var j" + c + "=SS[", e[c], "]|0;j", c, ">0;){"].join("")), l.push(["if(j", c, "<", s, "){"].join("")), l.push(["s", e[c], "=j", c].join("")), l.push(["j", c, "=0"].join("")), l.push(["}else{s", e[c], "=", s].join("")), l.push(["j", c, "-=", s, "}"].join("")), u && l.push(["index[", e[c], "]=j", c].join(""));
        for (var c = 0; c < a; ++c) {
          for (var f = ["offset" + c], p = t; p < o; ++p) f.push(["j", p, "*t", c, "p", e[p]].join(""));
          l.push(["p", c, "=(", f.join("+"), ")"].join(""))
        }
        l.push(r(e, n, i));
        for (var c = t; c < o; ++c) l.push("}");
        return l.join("\n")
      }
          ...
          if (!(s.count <= 0)) {
            ...
            switch (e.argTypes[a]) {
              ...
              case "array":
                ...
                var h = "l" + a,
                  d = "a" + c;
                if (0 === e.arrayBlockIndices[c]) 1 === s.count ? "generic" === n[c] ? s.lvalue ? (i.push(["var ", h, "=", d, ".get(", l, ")"].join("")), r = r.replace(u, h), o.push([d, ".set(", l, ",", h, ")"].join(""))) : r = r.replace(u, [d, ".get(", l, ")"].join("")) : r = r.replace(u, [d, "[", l, "]"].join("")) : "generic" === n[c] ? (i.push(["var ", h, "=", d, ".get(", l, ")"].join("")), r = r.replace(u, h), s.lvalue && o.push([d, ".set(", l, ",", h, ")"].join(""))) : (i.push(["var ", h, "=", d, "[", l, "]"].join("")), r = r.replace(u, h), s.lvalue && o.push([d, "[", l, "]=", h].join("")));
                else {
                  for (var v = [s.name], m = [l], g = 0; g < Math.abs(e.arrayBlockIndices[c]); g++) v.push("\\s*\\[([^\\]]+)\\]"), m.push("$" + (g + 1) + "*t" + c + "b" + g);
                  if (u = new RegExp(v.join(""), "g"), l = m.join("+"), "generic" === n[c]) throw new Error("cwise: Generic arrays not supported in combination with blocks!");
      ...
      function s(t) {
        for (var e = new Array(t.length), n = !0, r = 0; r < t.length; ++r) {
          var i = t[r],
            o = i.match(/\d+/);
          o = o ? o[0] : "", 0 === i.charAt(0) ? e[r] = "u" + i.charAt(1) + o : e[r] = i.charAt(0) + o, r > 0 && (n = n && e[r] === e[r - 1])
        }
        return n ? e[0] : e.join("")
      }

      function u(t, e) {
        for (var n = e[1].length - Math.abs(t.arrayBlockIndices[0]) | 0, u = new Array(t.arrayArgs.length), c = new Array(t.arrayArgs.length), f = 0; f < t.arrayArgs.length; ++f) c[f] = e[2 * f], u[f] = e[2 * f + 1];
        for (var p = [], h = [], d = [], v = [], m = [], f = 0; f < t.arrayArgs.length; ++f) {
          t.arrayBlockIndices[f] < 0 ? (d.push(0), v.push(n), p.push(n), h.push(n + t.arrayBlockIndices[f])) : (d.push(t.arrayBlockIndices[f]), v.push(t.arrayBlockIndices[f] + n), p.push(0), h.push(t.arrayBlockIndices[f]));
          for (var g = [], y = 0; y < u[f].length; y++) d[f] <= u[f][y] && u[f][y] < v[f] && g.push(u[f][y] - d[f]);
          m.push(g)
        }
        ...
        for (var f = 0; f < t.arrayArgs.length; ++f) {
          ...
          for (var y = 0; y < n; ++y) w.push(["t", f, "p", y, "=t", f, "[", d[f] + y, "]"].join(""));
          for (var y = 0; y < Math.abs(t.arrayBlockIndices[f]); ++y) w.push(["t", f, "b", y, "=t", f, "[", p[f] + y, "]"].join(""))
        }
        for (var f = 0; f < t.scalarArgs.length; ++f) b.push("Y" + f);
        if (t.shapeArgs.length > 0 && w.push("shape=SS.slice(0)"), t.indexArgs.length > 0) {
          for (var x = new Array(n), f = 0; f < n; ++f) x[f] = "0";
          w.push(["index=[", x.join(","), "]"].join(""))
        }
        for (var f = 0; f < t.offsetArgs.length; ++f) {
          for (var E = t.offsetArgs[f], $ = [], y = 0; y < E.offset.length; ++y) 0 !== E.offset[y] && (1 === E.offset[y] ? $.push(["t", E.array, "p", y].join("")) : $.push([E.offset[y], "*t", E.array, "p", y].join("")));
          0 === $.length ? w.push("q" + f + "=0") : w.push(["q", f, "=", $.join("+")].join(""))
        }
        var S = l([].concat(t.pre.thisVars).concat(t.body.thisVars).concat(t.post.thisVars));
        w = w.concat(S), _.push("var " + w.join(","));
        for (var f = 0; f < t.arrayArgs.length; ++f) _.push("p" + f + "|=0");
        t.pre.body.length > 3 && _.push(a(t.pre, t, c));
        var T = a(t.body, t, c),
          k = o(m);
        k < n ? _.push(i(k, m[0], t, T)) : _.push(r(m[0], t, T)), t.post.body.length > 3 && _.push(a(t.post, t, c)), t.debug && console.log("-----Generated cwise routine for ", e, ":\n" + _.join("\n") + "\n----------");
  ...
  System.registerDynamic("76", ["74"], !0, function(t, e, n) {
    ...
    function r(t) {
      ...
      ], u = [], l = [], c = 0; c < t.arrayArgs.length; ++c) {
        var f = t.arrayArgs[c];
        n.push(["t", f, "=array", f, ".dtype,", "r", f, "=array", f, ".order"].join("")), o.push("t" + f), o.push("r" + f), a.push("t" + f), a.push("r" + f + ".join()"), s.push("array" + f + ".data"), s.push("array" + f + ".stride"), s.push("array" + f + ".offset|0"), c > 0 && (u.push("array" + t.arrayArgs[0] + ".shape.length===array" + f + ".shape.length+" + (Math.abs(t.arrayBlockIndices[0]) - Math.abs(t.arrayBlockIndices[c]))), l.push("array" + t.arrayArgs[0] + ".shape[shapeIndex+" + Math.max(0, t.arrayBlockIndices[0]) + "]===array" + f + ".shape[shapeIndex+" + Math.max(0, t.arrayBlockIndices[c]) + "]"))
      }
      t.arrayArgs.length > 1 && (e.push("if (!(" + u.join(" && ") + ")) throw new Error('cwise: Arrays do not all have the same dimensionality!')"), e.push("for(var shapeIndex=array" + t.arrayArgs[0] + ".shape.length-" + Math.abs(t.arrayBlockIndices[0]) + "; shapeIndex-->0;) {"), e.push("if (!(" + l.join(" && ") + ")) throw new Error('cwise: Arrays do not all have the same shape!')"), e.push("}"));
      for (var c = 0; c < t.scalarArgs.length; ++c) s.push("scalar" + t.scalarArgs[c]);
      n.push(["type=[", a.join(","), "].join()"].join("")), n.push("proc=CACHED[type]"), e.push("var " + n.join(",")), e.push(["if(!proc){", "CACHED[type]=proc=compile([", o.join(","), "])}", "return proc(", s.join(","), ")}"].join("")), t.debug && console.log("-----Generated thunk:\n" + e.join("\n") + "\n----------");
  ...
  System.registerDynamic("78", ["77"], !0, function(t, e, n) {
    return n.exports = t("77"), n.exports});
  ...
  System.registerDynamic("58", ["79"], !0, function(t, e, n) {
    return n.exports = t("79"), n.exports});
  ...
  System.registerDynamic("7b", ["7a"], !0, function(t, e, n) {
    return n.exports = t("7a"), n.exports});
  ...
  System.registerDynamic("7d", ["7c"], !0, function(t, e, n) {
    return n.exports = t("7c"), n.exports});
  System.registerDynamic("87", ["7b", "7d", getCodeName("BufferForTheBrowser")], !0, function(t, e, n) {
    var r = this;
    return function(n) {
      "use strict";
      ...
      var x = w.DATA,
        E = w.BUFFER;
      e.free = function(t) {
        if (n.isBuffer(t)) E[y.log2(t.length)].push(t);
        else {
      ...
      }, e.freeUint8 = e.freeUint16 = e.freeUint32 = e.freeInt8 = e.freeInt16 = e.freeInt32 = e.freeFloat32 = e.freeFloat = e.freeFloat64 = e.freeDouble = e.freeUint8Clamped = e.freeDataView = o, e.freeArrayBuffer = i, e.freeBuffer = function(t) {
        ...
        return null
      }, e.mallocArrayBuffer = a, e.mallocUint8 = s, e.mallocUint16 = u, e.mallocUint32 = l, e.mallocInt8 = c, e.mallocInt16 = f, e.mallocInt32 = p, e.mallocFloat32 = e.mallocFloat = h, e.mallocFloat64 = e.mallocDouble = d, e.mallocUint8Clamped = v, e.mallocDataView = m, e.mallocBuffer = g, e.clearCache = function() {
        for (var t = 0; t < 32; ++t) w.UINT8[t].length = 0, w.UINT16[t].length = 0, w.UINT32[t].length = 0, w.INT8[t].length = 0, w.INT16[t].length = 0, w.INT32[t].length = 0, w.FLOAT[t].length = 0, w.DOUBLE[t].length = 0, w.UINT8C[t].length = 0, x[t].length = 0, E[t].length = 0
      }
    }(t(getCodeName("BufferForTheBrowser")).Buffer), n.exports});
  System.registerDynamic("59", ["87"], !0, function(t, e, n) {
    return n.exports = t("87"), n.exports});
  ...
  System.registerDynamic("6a", ["88"], !0, function(t, e, n) {
    return n.exports = t("88"), n.exports});
  System.registerDynamic("89", ["6a"], !0, function(t, e, n) {
    "use strict";

    function r(t, e) {
      e.forEach(function(e) {
        e.tex = o(t, e.img), e.sprites.filter(function(t) {
          return !!t
        }).forEach(function(t) {
          return t.tex = e.tex
        })
    ...
    function i(t) {
      t.forEach(function(t) {
        t.tex && (t.tex.dispose(), t.tex = null), t.sprites.forEach(function(t) {
          return t.tex = null
        })
      })
    }
    ...
    var o = t("6a");
    return e.createTexturesForSpriteSheets = r, e.releaseTexturesForSpriteSheets = i, n.exports});
  System.registerDynamic("8a", [], !0, function(t, e, n) {
    ...
    function s() {
      m && d && (m = !1, d.length ? v = d.concat(v) : g = -1, v.length && u())
    }
    ...
    return h.nextTick = function(t) {
      ...
      v.push(new l(t, e)), 1 !== v.length || m || o(u)
  ...
  System.registerDynamic("8b", ["8a"], !0, function(t, e, n) {
    return n.exports = t("8a"), n.exports});
  System.registerDynamic("8c", ["8b"], !0, function(e, n, r) {
    return r.exports = System._nodeRequire ? process : e("8b"), r.exports});
  System.registerDynamic("75", ["8c"], !0, function(t, e, n) {
    return n.exports = t("8c"), n.exports});
      ...
      function o(t, e, n, o) {
        ...
        function c(t, e) {
          ...
          for (var r in e) {
            var i = e[r],
              o = t;
            o += parseInt(r) + "" === r ? "[" + r + "]" : "." + r, "object" == typeof i ? n.push.apply(n, c(o, i)) : n.push([o, i])
          }
          return n
        }
          ...
          switch (t) {
            ...
            default:
              ...
              if (0 === t.indexOf("mat") && 4 === t.length) {
                var n = t.charCodeAt(t.length - 1) - 48;
                if (n < 2 || n > 4) throw new s("", "Invalid uniform dimension type for matrix " + name + ": " + t);
                return i(n * n, 0)
              }
        ...
        function h(t, e, i) {
          ...
          } else o[i] ? Object.defineProperty(t, e, {
            get: u(i),
            set: f(i),
            enumerable: !0,
            configurable: !1
        ...
        function d(t) {
          ...
          if (Array.isArray(t)) {
            ...
            for (var n = 0; n < t.length; ++n) h(e, n, t[n])
          } else {
            e = {};
  ...
  System.registerDynamic("90", ["8f"], !0, function(t, e, n) {
    ...
    function i(t, e, n, i, o, a, s) {
      for (var u = ["gl", "v"], l = [], c = 0; c < o; ++c) u.push("x" + c), l.push("x" + c);
      ...
      Object.defineProperty(a, s, {
        set: function(e) {
          return t.disableVertexAttribArray(i[n]), f(t, i[n], e), e
        },
        get: function() {
          return p
        },
    ...
    function o(t, e, n, r, o, a, s) {
      for (var u = new Array(o), l = new Array(o), c = 0; c < o; ++c) i(t, e, n[c], r, o, u, c), l[c] = u[c];
      Object.defineProperty(u, "location", {
        set: function(t) {
          if (Array.isArray(t))
            for (var e = 0; e < o; ++e) l[e].location = t[e];
          else
            for (var e = 0; e < o; ++e) l[e].location = t + e;
          return t
        },
        get: function() {
          for (var t = new Array(o), e = 0; e < o; ++e) t[e] = r[n[e]];
          return t
        },
        enumerable: !0
      }), u.pointer = function(e, i, a, s) {
        e = e || t.FLOAT, i = !!i, a = a || o * o, s = s || 0;
        for (var u = 0; u < o; ++u) {
          var l = r[n[u]];
          t.vertexAttribPointer(l, o, e, i, a, s + u * o), t.enableVertexAttribArray(l)
        }
      };
      var f = new Array(o),
      ...
      Object.defineProperty(a, s, {
        set: function(e) {
          for (var i = 0; i < o; ++i) {
            var a = r[n[i]];
            if (t.disableVertexAttribArray(a), Array.isArray(e[0])) p.call(t, a, e[i]);
            else {
              for (var s = 0; s < o; ++s) f[s] = e[o * i + s];
              p.call(t, a, f)
            }
          }
          return e
        ...
        switch (p) {
          ...
          default:
            if (p.indexOf("vec") >= 0) {
              ...
              if (d < 2 || d > 4) throw new s("", "Invalid data type for attribute " + f + ": " + p);
              i(t, e, h[0], r, d, a, f)
            } else {
    ...
    return u.pointer = function(t, e, n, r) {
      ...
      o.vertexAttribPointer(a, i._dimension, t || o.FLOAT, !!e, n || 0, r || 0), o.enableVertexAttribArray(a)
        ...
        for (var i = t[r].name, o = i.split("."), a = n, s = 0; s < o.length; ++s) {
          ...
          if (u.length > 1) {
            ...
            for (var l = 1; l < u.length; ++l) {
              var c = parseInt(u[l]);
              l < u.length - 1 || s < o.length - 1 ? (c in a || (l < u.length - 1 ? a[c] = [] : a[c] = {}), a = a[c]) : e ? a[c] = r : a[c] = t[r].type
            }
          } else s < o.length - 1 ? (u[0] in a || (a[u[0]] = {}), a = a[u[0]]) : e ? a[u[0]] = r : a[u[0]] = t[r].type
        }
      return n
    }
    ...
    return function(t) {
      ...
      n.format = function(t, e) {
        var r, s, u, l, c, f, p, h = 1,
          ...
          y = "";
        for (s = 0; s < d; s++)
          if (v = i(t[s]), "string" === v) m[m.length] = t[s];
          else if ("array" === v) {
            if (l = t[s], l[2])
              for (r = e[h], u = 0; u < l[2].length; u++) {
                if (!r.hasOwnProperty(l[2][u])) throw new Error(n("[sprintf] property '%s' does not exist", l[2][u]));
                r = r[l[2][u]]
              } else r = l[1] ? e[l[1]] : e[h++];
            if ("function" == i(r) && (r = r()), a.not_string.test(l[8]) && a.not_json.test(l[8]) && "number" != i(r) && isNaN(r)) throw new TypeError(n("[sprintf] expecting number but found %s", i(r)));
            switch (a.number.test(l[8]) && (g = r >= 0), l[8]) {
              case "b":
                r = r.toString(2);
                break;
              case "c":
            ...
            a.json.test(l[8]) ? m[m.length] = r : (!a.number.test(l[8]) || g && !l[3] ? y = "" : (y = g ? "+" : "-",
              r = r.toString().replace(a.sign, "")), f = l[4] ? "0" === l[4] ? "0" : l[4].charAt(1) : " ", p = l[6] - (y + r).length, c = l[6] && p > 0 ? o(f, p) : "", m[m.length] = l[5] ? y + r + c : "0" === f ? y + c + r : c + y + r)
          }
        return m.join("")
      }, n.cache = {}, n.parse = function(t) {
        for (var e = t, n = [], r = [], i = 0; e;) {
          if (null !== (n = a.text.exec(e))) r[r.length] = n[0];
          else if (null !== (n = a.modulo.exec(e))) r[r.length] = "%";
          else {
            if (null === (n = a.placeholder.exec(e))) throw new SyntaxError("[sprintf] unexpected placeholder");
            if (n[2]) {
              i |= 1;
              var o = [],
                s = n[2],
              ...
              for (o[o.length] = u[1];
                ...
                if (null !== (u = a.key_access.exec(s))) o[o.length] = u[1];
                else {
      ...
      var s = function(t, e, r) {
        return r = (e || []).slice(0), r.splice(0, 0, t), n.apply(null, r)
      };
      "undefined" != typeof e ? (e.sprintf = n, e.vsprintf = s) : (t.sprintf = n, t.vsprintf = s, "function" == typeof r && r.amd && r(function() {
        return {
          sprintf: n,
          vsprintf: s
        }
      }))
    }("undefined" == typeof window ? this : window), n.exports});
  System.registerDynamic("92", ["91"], !0, function(t, e, n) {
    return n.exports = t("91"), n.exports});
  ...
  System.registerDynamic("9a", ["96", "95", "98", "97", "99"], !0, function(t, e, n) {
    function r(t) {
      ...
      function n(t) {
        ...
        return L += N, W = W.slice(N), V
      }

      function r(t) {
        return B.length && e(B.join("")), U = w, e("(eof)"), V
      }

      function $() {
        return B = B.length ? [] : B, "/" === P && "*" === F ? (Y = L + N - 1, U = f, P = F, N + 1) : "/" === P && "/" === F ? (Y = L + N - 1, U = p, P = F, N + 1) : "#" === F ? (U = h, Y = L + N, N) : /\s/.test(F) ? (U = _, Y = L + N, N) : (q = /\d/.test(F), G = /[^\w_]/.test(F), Y = L + N, U = q ? v : G ? d : c, N)
      }

      function S() {
        return /[^\s]/g.test(F) ? (e(B.join("")), U = l, N) : (B.push(F), P = F, N + 1)
      }

      function T() {
        return "\n" === F && "\\" !== P ? (e(B.join("")), U = l, N) : (B.push(F), P = F, N + 1)
      }
      ...
      function M() {
        return "/" === F && "*" === P ? (B.push(F), e(B.join("")), U = l, N + 1) : (B.push(F), P = F, N + 1)
      }

      function A() {
        if ("." === P && /\d/.test(F)) return U = m, N;
        if ("/" === P && "*" === F) return U = f, N;
        if ("/" === P && "/" === F) return U = p, N;
        if ("." === F && B.length) {
          for (; C(B););
        ...
        return B.push(F), P = F, N + 1
      }

      function C(t) {
        for (var n, r, i = 0;;) {
          if (n = o.indexOf(t.slice(0, t.length + i).join("")), r = o[n], n === -1) {
            if (i-- + t.length > 0) continue;
            r = t.slice(0, 1).join("")
          }
          return e(r), Y += r.length, B = B.slice(r.length), B.length
        }
      }

      function D() {
        return /[^a-fA-F0-9]/.test(F) ? (e(B.join("")), U = l, N) : (B.push(F), P = F, N + 1)
      }

      function O() {
        return "." === F ? (B.push(F), U = m, P = F, N + 1) : /[eE]/.test(F) ? (B.push(F), U = m, P = F, N + 1) : "x" === F && 1 === B.length && "0" === B[0] ? (U = x, B.push(F), P = F, N + 1) : /[^\d]/.test(F) ? (e(B.join("")), U = l, N) : (B.push(F), P = F, N + 1)
      }

      function I() {
        return "f" === F && (B.push(F), P = F, N += 1), /[eE]/.test(F) ? (B.push(F), P = F, N + 1) : "-" === F && /[eE]/.test(P) ? (B.push(F), P = F, N + 1) : /[^\d]/.test(F) ? (e(B.join("")), U = l, N) : (B.push(F), P = F, N + 1)
      }

      function R() {
        if (/[^\d\w_]/.test(F)) {
          var t = B.join("");
          return U = Z.indexOf(t) > -1 ? b : X.indexOf(t) > -1 ? y : g, e(B.join("")), U = l, N
        }
        return B.push(F), P = F, N + 1
      }
      ...
      var X = a,
        Z = i;
      return "300 es" === t.version && (X = u, Z = s),
        function(t) {
          return V = [], null !== t ? n(t) : r()
        }
    }
  ...
  System.registerDynamic("a0", ["9f"], !0, function(t, e, n) {
    return n.exports = t("9f"), n.exports});
  System.registerDynamic("a1", [], !0, function(t, e, n) {
    "use strict";

    function r(t, e) {
      if ("string" != typeof t) throw new TypeError("repeat-string expects a string.");
      if (1 === e) return t;
      if (2 === e) return t + t;
      var n = t.length * e;
      for (i === t && "undefined" != typeof i || (i = t, o = ""); n > o.length && e > 0 && (1 & e && (o += t), e >>= 1);) t += t;
      return o.substr(0, n)
    }
  ...
  System.registerDynamic("a6", ["a5"], !0, function(t, e, n) {
    return n.exports = t("a5"), n.exports});
    ...
    function r(t, e, n) {
      ...
      for (var l = i("Error compiling %s shader %s:\n", u, r), c = i("%s%s", l, t), f = t.split("\n"), p = {}, h = 0; h < f.length; h++) {
        ...
        if ("" !== d) {
          ...
          if (isNaN(v)) throw new Error(i("Could not parse error: %s", d));
          p[v] = d
        }
      }
      for (var m = s(e).split("\n"), h = 0; h < m.length; h++)
        if (p[h + 3] || p[h + 2] || p[h + 1]) {
          ...
          if (l += g + "\n", p[h + 1]) {
            var y = p[h + 1];
            y = y.substr(y.split(":", 3).join(":").length + 1).trim(), l += i("^^^ %s\n\n", y)
          }
        }
      return {
        long: l.trim(),
  ...
  System.registerDynamic("a8", ["a7"], !0, function(t, e, n) {
    return n.exports = t("a7"), n.exports});
  ...
  System.registerDynamic("ac", ["ab"], !0, function(t, e, n) {
    return n.exports = t("ab"), n.exports});
  System.registerDynamic("ad", ["8f", "a8", "ac"], !0, function(t, e, n) {
    ...
    function s(t) {
      var e = h.get(t);
      return e || (e = new i(t), h.set(t, e)), e
    }
    ...
    return v.getShaderReference = function(t, e) {
      ...
      var i = [t.id, e.id, n.join(":"), r.join(":")].join("@"),
        o = this.programs[i];
      return o && this.gl.isProgram(o) || (this.programs[i] = o = a(this.gl, t.shader, e.shader, n, r), t.programs.push(i), e.programs.push(i)), o
    }, n.exports});
  ...
  System.registerDynamic("8f", [], !0, function(t, e, n) {
    ...
    return r.prototype = new Error, r.prototype.name = "GLError", r.prototype.constructor = r, n.exports = r, n.exports});
  System.registerDynamic("af", ["8d", "90", "8e", "ad", "ae", "8f"], !0, function(t, e, n) {
    ...
    return p.bind = function() {
      ...
      function o() {
        ...
        for (var t = 0; t < n.length; ++t) M[t] = d.getUniformLocation(h.program, n[t].name)
      }

      if (!e || 1 === arguments.length) {
        var p = t;
        t = p.vertex, e = p.fragment, n = p.uniforms, r = p.attributes
      }
      var h = this,
        d = h.gl,
        v = h._vref;
      h._vref = l.shader(d, d.VERTEX_SHADER, t), v && v.dispose(), h.vertShader = h._vref.shader;
      var m = this._fref;
      if (h._fref = l.shader(d, d.FRAGMENT_SHADER, e), m && m.dispose(), h.fragShader = h._fref.shader, !n || !r) {
        var g = d.createProgram();
        if (d.attachShader(g, h.fragShader), d.attachShader(g, h.vertShader), d.linkProgram(g), !d.getProgramParameter(g, d.LINK_STATUS)) {
          var y = d.getProgramInfoLog(g);
          throw new f(y, "Error linking program:" + y)
        }
        n = n || c.uniforms(d, g), r = r || c.attributes(d, g), d.deleteProgram(g)
      }
      r = r.slice(), r.sort(i);
      for (var b = [], _ = [], w = [], x = 0; x < r.length; ++x) {
        var E = r[x];
        if (E.type.indexOf("mat") >= 0) {
          for (var $ = 0 | E.type.charAt(E.type.length - 1), S = new Array($), T = 0; T < $; ++T) S[T] = w.length, _.push(E.name + "[" + T + "]"), "number" == typeof E.location ? w.push(E.location + T) : Array.isArray(E.location) && E.location.length === $ && "number" == typeof E.location[T] ? w.push(0 | E.location[T]) : w.push(-1);
          b.push({
            name: E.name,
            type: E.type,
            locations: S
          ...
          type: E.type,
          locations: [w.length]
        }), _.push(E.name), "number" == typeof E.location ? w.push(0 | E.location) : w.push(-1)
      }
      for (var k = 0, x = 0; x < w.length; ++x)
        if (w[x] < 0) {
          for (; w.indexOf(k) >= 0;) k += 1;
          w[x] = k
        }
      var M = new Array(n.length);
      o(), h._relink = o, h.types = {
        uniforms: u(n),
        attributes: u(r)
      }, h.attributes = s(d, h, b, w), Object.defineProperty(h, "uniforms", a(d, h, n, M))
    }, n.exports = o, n.exports});
  System.registerDynamic("b0", ["af"], !0, function(t, e, n) {
    return n.exports = t("af"), n.exports});
  ...
  System.registerDynamic("b3", ["b2"], !0, function(t, e, n) {
    ...
    return i.create = function() {
      ...
      var r = e[0],
        ...
        h = n[4],
        d = n[5];
      return t[0] = r * l + o * c, t[1] = i * l + a * c, t[2] = r * f + o * p, t[3] = i * f + a * p, t[4] = r * h + o * d + s, t[5] = i * h + a * d + u, t
    }, i.mul = i.multiply, i.rotate = function(t, e, n) {
      var r = e[0],
        i = e[1],
        o = e[2],
  ...
  System.registerDynamic("b4", ["b2"], !0, function(t, e, n) {
    ...
    return i.create = function() {
      ...
      return g[0] = t, g[1] = e, g[2] = n, g[3] = i, g[4] = o, g[5] = a, g[6] = s, g[7] = u, g[8] = l, g[9] = c, g[10] = f, g[11] = p, g[12] = h, g[13] = d, g[14] = v, g[15] = m, g
    }, i.set = function(t, e, n, r, i, o, a, s, u, l, c, f, p, h, d, v, m) {
      return t[0] = e, t[1] = n, t[2] = r, t[3] = i, t[4] = o, t[5] = a, t[6] = s, t[7] = u, t[8] = l, t[9] = c, t[10] = f, t[11] = p, t[12] = h, t[13] = d, t[14] = v, t[15] = m, t
    }, i.identity = function(t) {
      return t[0] = 1, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = 1, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1, t
      ...
      return C ? (C = 1 / C, t[0] = (s * A - u * M + l * k) * C, t[1] = (i * M - r * A - o * k) * C, t[2] = (v * E - m * x + g * w) * C, t[3] = (p * x - f * E - h * w) * C, t[4] = (u * T - a * A - l * S) * C, t[5] = (n * A - i * T + o * S) * C, t[6] = (m * _ - d * E - g * b) * C, t[7] = (c * E - p * _ + h * b) * C, t[8] = (a * M - s * T + l * $) * C, t[9] = (r * T - n * M - o * $) * C, t[10] = (d * x - v * _ + g * y) * C, t[11] = (f * _ - c * x - h * y) * C, t[12] = (s * S - a * k - u * $) * C, t[13] = (n * k - r * S + i * $) * C, t[14] = (v * b - d * w - m * y) * C, t[15] = (c * w - f * b + p * y) * C, t) : null
    }, i.SIMD.invert = function(t, e) {
      var n, r, i, o, a, s, u, l, c, f, p = SIMD.Float32x4.load(e, 0),
        h = SIMD.Float32x4.load(e, 4),
        d = SIMD.Float32x4.load(e, 8),
        v = SIMD.Float32x4.load(e, 12);
      return a = SIMD.Float32x4.shuffle(p, h, 0, 1, 4, 5), r = SIMD.Float32x4.shuffle(d, v, 0, 1, 4, 5), n = SIMD.Float32x4.shuffle(a, r, 0, 2, 4, 6), r = SIMD.Float32x4.shuffle(r, a, 1, 3, 5, 7), a = SIMD.Float32x4.shuffle(p, h, 2, 3, 6, 7), o = SIMD.Float32x4.shuffle(d, v, 2, 3, 6, 7), i = SIMD.Float32x4.shuffle(a, o, 0, 2, 4, 6), o = SIMD.Float32x4.shuffle(o, a, 1, 3, 5, 7), a = SIMD.Float32x4.mul(i, o), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), s = SIMD.Float32x4.mul(r, a), u = SIMD.Float32x4.mul(n, a), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), s = SIMD.Float32x4.sub(SIMD.Float32x4.mul(r, a), s), u = SIMD.Float32x4.sub(SIMD.Float32x4.mul(n, a), u), u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1), a = SIMD.Float32x4.mul(r, i), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), s = SIMD.Float32x4.add(SIMD.Float32x4.mul(o, a), s), c = SIMD.Float32x4.mul(n, a), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), s = SIMD.Float32x4.sub(s, SIMD.Float32x4.mul(o, a)), c = SIMD.Float32x4.sub(SIMD.Float32x4.mul(n, a), c), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), a = SIMD.Float32x4.mul(SIMD.Float32x4.swizzle(r, 2, 3, 0, 1), o), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), i = SIMD.Float32x4.swizzle(i, 2, 3, 0, 1), s = SIMD.Float32x4.add(SIMD.Float32x4.mul(i, a), s), l = SIMD.Float32x4.mul(n, a), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), s = SIMD.Float32x4.sub(s, SIMD.Float32x4.mul(i, a)), l = SIMD.Float32x4.sub(SIMD.Float32x4.mul(n, a), l), l = SIMD.Float32x4.swizzle(l, 2, 3, 0, 1), a = SIMD.Float32x4.mul(n, r), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), l = SIMD.Float32x4.add(SIMD.Float32x4.mul(o, a), l), c = SIMD.Float32x4.sub(SIMD.Float32x4.mul(i, a), c), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), l = SIMD.Float32x4.sub(SIMD.Float32x4.mul(o, a), l), c = SIMD.Float32x4.sub(c, SIMD.Float32x4.mul(i, a)), a = SIMD.Float32x4.mul(n, o), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), u = SIMD.Float32x4.sub(u, SIMD.Float32x4.mul(i, a)), l = SIMD.Float32x4.add(SIMD.Float32x4.mul(r, a), l), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), u = SIMD.Float32x4.add(SIMD.Float32x4.mul(i, a), u), l = SIMD.Float32x4.sub(l, SIMD.Float32x4.mul(r, a)), a = SIMD.Float32x4.mul(n, i), a = SIMD.Float32x4.swizzle(a, 1, 0, 3, 2), u = SIMD.Float32x4.add(SIMD.Float32x4.mul(o, a), u), c = SIMD.Float32x4.sub(c, SIMD.Float32x4.mul(r, a)), a = SIMD.Float32x4.swizzle(a, 2, 3, 0, 1), u = SIMD.Float32x4.sub(u, SIMD.Float32x4.mul(o, a)), c = SIMD.Float32x4.add(SIMD.Float32x4.mul(r, a), c), f = SIMD.Float32x4.mul(n, s), f = SIMD.Float32x4.add(SIMD.Float32x4.swizzle(f, 2, 3, 0, 1), f), f = SIMD.Float32x4.add(SIMD.Float32x4.swizzle(f, 1, 0, 3, 2), f), a = SIMD.Float32x4.reciprocalApproximation(f), f = SIMD.Float32x4.sub(SIMD.Float32x4.add(a, a), SIMD.Float32x4.mul(f, SIMD.Float32x4.mul(a, a))), (f = SIMD.Float32x4.swizzle(f, 0, 0, 0, 0)) ? (SIMD.Float32x4.store(t, 0, SIMD.Float32x4.mul(f, s)), SIMD.Float32x4.store(t, 4, SIMD.Float32x4.mul(f, u)), SIMD.Float32x4.store(t, 8, SIMD.Float32x4.mul(f, l)), SIMD.Float32x4.store(t, 12, SIMD.Float32x4.mul(f, c)), t) : null
      ...
      var n = e[0],
        ...
        m = e[14],
        g = e[15];
      return t[0] = s * (p * g - h * m) - f * (u * g - l * m) + v * (u * h - l * p), t[1] = -(r * (p * g - h * m) - f * (i * g - o * m) + v * (i * h - o * p)), t[2] = r * (u * g - l * m) - s * (i * g - o * m) + v * (i * l - o * u), t[3] = -(r * (u * h - l * p) - s * (i * h - o * p) + f * (i * l - o * u)), t[4] = -(a * (p * g - h * m) - c * (u * g - l * m) + d * (u * h - l * p)), t[5] = n * (p * g - h * m) - c * (i * g - o * m) + d * (i * h - o * p), t[6] = -(n * (u * g - l * m) - a * (i * g - o * m) + d * (i * l - o * u)), t[7] = n * (u * h - l * p) - a * (i * h - o * p) + c * (i * l - o * u), t[8] = a * (f * g - h * v) - c * (s * g - l * v) + d * (s * h - l * f), t[9] = -(n * (f * g - h * v) - c * (r * g - o * v) + d * (r * h - o * f)), t[10] = n * (s * g - l * v) - a * (r * g - o * v) + d * (r * l - o * s), t[11] = -(n * (s * h - l * f) - a * (r * h - o * f) + c * (r * l - o * s)), t[12] = -(a * (f * m - p * v) - c * (s * m - u * v) + d * (s * p - u * f)), t[13] = n * (f * m - p * v) - c * (r * m - i * v) + d * (r * p - i * f), t[14] = -(n * (s * m - u * v) - a * (r * m - i * v) + d * (r * u - i * s)), t[15] = n * (s * p - u * f) - a * (r * p - i * f) + c * (r * u - i * s), t
    }, i.SIMD.adjoint = function(t, e) {
      var n, r, i, o, a, s, u, l, c, f, p, h, d, n = SIMD.Float32x4.load(e, 0),
        r = SIMD.Float32x4.load(e, 4),
        i = SIMD.Float32x4.load(e, 8),
        o = SIMD.Float32x4.load(e, 12);
      return c = SIMD.Float32x4.shuffle(n, r, 0, 1, 4, 5), s = SIMD.Float32x4.shuffle(i, o, 0, 1, 4, 5), a = SIMD.Float32x4.shuffle(c, s, 0, 2, 4, 6), s = SIMD.Float32x4.shuffle(s, c, 1, 3, 5, 7), c = SIMD.Float32x4.shuffle(n, r, 2, 3, 6, 7), l = SIMD.Float32x4.shuffle(i, o, 2, 3, 6, 7), u = SIMD.Float32x4.shuffle(c, l, 0, 2, 4, 6), l = SIMD.Float32x4.shuffle(l, c, 1, 3, 5, 7), c = SIMD.Float32x4.mul(u, l), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), f = SIMD.Float32x4.mul(s, c), p = SIMD.Float32x4.mul(a, c), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), f = SIMD.Float32x4.sub(SIMD.Float32x4.mul(s, c), f), p = SIMD.Float32x4.sub(SIMD.Float32x4.mul(a, c), p), p = SIMD.Float32x4.swizzle(p, 2, 3, 0, 1), c = SIMD.Float32x4.mul(s, u), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), f = SIMD.Float32x4.add(SIMD.Float32x4.mul(l, c), f), d = SIMD.Float32x4.mul(a, c), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), f = SIMD.Float32x4.sub(f, SIMD.Float32x4.mul(l, c)), d = SIMD.Float32x4.sub(SIMD.Float32x4.mul(a, c), d), d = SIMD.Float32x4.swizzle(d, 2, 3, 0, 1), c = SIMD.Float32x4.mul(SIMD.Float32x4.swizzle(s, 2, 3, 0, 1), l), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), u = SIMD.Float32x4.swizzle(u, 2, 3, 0, 1), f = SIMD.Float32x4.add(SIMD.Float32x4.mul(u, c), f), h = SIMD.Float32x4.mul(a, c), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), f = SIMD.Float32x4.sub(f, SIMD.Float32x4.mul(u, c)), h = SIMD.Float32x4.sub(SIMD.Float32x4.mul(a, c), h), h = SIMD.Float32x4.swizzle(h, 2, 3, 0, 1), c = SIMD.Float32x4.mul(a, s), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), h = SIMD.Float32x4.add(SIMD.Float32x4.mul(l, c), h), d = SIMD.Float32x4.sub(SIMD.Float32x4.mul(u, c), d), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), h = SIMD.Float32x4.sub(SIMD.Float32x4.mul(l, c), h), d = SIMD.Float32x4.sub(d, SIMD.Float32x4.mul(u, c)), c = SIMD.Float32x4.mul(a, l), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), p = SIMD.Float32x4.sub(p, SIMD.Float32x4.mul(u, c)), h = SIMD.Float32x4.add(SIMD.Float32x4.mul(s, c), h), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), p = SIMD.Float32x4.add(SIMD.Float32x4.mul(u, c), p), h = SIMD.Float32x4.sub(h, SIMD.Float32x4.mul(s, c)), c = SIMD.Float32x4.mul(a, u), c = SIMD.Float32x4.swizzle(c, 1, 0, 3, 2), p = SIMD.Float32x4.add(SIMD.Float32x4.mul(l, c), p), d = SIMD.Float32x4.sub(d, SIMD.Float32x4.mul(s, c)), c = SIMD.Float32x4.swizzle(c, 2, 3, 0, 1), p = SIMD.Float32x4.sub(p, SIMD.Float32x4.mul(l, c)), d = SIMD.Float32x4.add(SIMD.Float32x4.mul(s, c), d), SIMD.Float32x4.store(t, 0, f), SIMD.Float32x4.store(t, 4, p), SIMD.Float32x4.store(t, 8, h), SIMD.Float32x4.store(t, 12, d), t
      ...
      var r = e[0],
        ...
        w = n[2],
        x = n[3];
      return t[0] = b * r + _ * s + w * f + x * v, t[1] = b * i + _ * u + w * p + x * m, t[2] = b * o + _ * l + w * h + x * g, t[3] = b * a + _ * c + w * d + x * y, b = n[4], _ = n[5], w = n[6], x = n[7], t[4] = b * r + _ * s + w * f + x * v, t[5] = b * i + _ * u + w * p + x * m, t[6] = b * o + _ * l + w * h + x * g, t[7] = b * a + _ * c + w * d + x * y, b = n[8], _ = n[9], w = n[10], x = n[11], t[8] = b * r + _ * s + w * f + x * v, t[9] = b * i + _ * u + w * p + x * m, t[10] = b * o + _ * l + w * h + x * g, t[11] = b * a + _ * c + w * d + x * y, b = n[12], _ = n[13], w = n[14], x = n[15], t[12] = b * r + _ * s + w * f + x * v, t[13] = b * i + _ * u + w * p + x * m, t[14] = b * o + _ * l + w * h + x * g, t[15] = b * a + _ * c + w * d + x * y, t
    }, i.multiply = r.USE_SIMD ? i.SIMD.multiply : i.scalar.multiply, i.mul = i.multiply, i.scalar.translate = function(t, e, n) {
      var r, i, o, a, s, u, l, c, f, p, h, d, v = n[0],
        m = n[1],
        g = n[2];
      return e === t ? (t[12] = e[0] * v + e[4] * m + e[8] * g + e[12], t[13] = e[1] * v + e[5] * m + e[9] * g + e[13], t[14] = e[2] * v + e[6] * m + e[10] * g + e[14], t[15] = e[3] * v + e[7] * m + e[11] * g + e[15]) : (r = e[0], i = e[1], o = e[2], a = e[3], s = e[4], u = e[5], l = e[6], c = e[7], f = e[8], p = e[9], h = e[10], d = e[11], t[0] = r, t[1] = i, t[2] = o, t[3] = a, t[4] = s, t[5] = u, t[6] = l, t[7] = c, t[8] = f, t[9] = p, t[10] = h, t[11] = d, t[12] = r * v + s * m + f * g + e[12], t[13] = i * v + u * m + p * g + e[13], t[14] = o * v + l * m + h * g + e[14], t[15] = a * v + c * m + d * g + e[15]), t
      ...
      var o, a, s, u, l, c, f, p, h, d, v, m, g, y, b, _, w, x, E, $, S, T, k, M, A = i[0],
        C = i[1],
        D = i[2],
        O = Math.sqrt(A * A + C * C + D * D);
      return Math.abs(O) < r.EPSILON ? null : (O = 1 / O, A *= O, C *= O, D *= O, o = Math.sin(n), a = Math.cos(n), s = 1 - a, u = e[0], l = e[1], c = e[2], f = e[3], p = e[4], h = e[5], d = e[6], v = e[7], m = e[8], g = e[9], y = e[10], b = e[11], _ = A * A * s + a, w = C * A * s + D * o, x = D * A * s - C * o, E = A * C * s - D * o, $ = C * C * s + a, S = D * C * s + A * o, T = A * D * s + C * o, k = C * D * s - A * o, M = D * D * s + a, t[0] = u * _ + p * w + m * x, t[1] = l * _ + h * w + g * x, t[2] = c * _ + d * w + y * x, t[3] = f * _ + v * w + b * x, t[4] = u * E + p * $ + m * S, t[5] = l * E + h * $ + g * S, t[6] = c * E + d * $ + y * S, t[7] = f * E + v * $ + b * S, t[8] = u * T + p * k + m * M, t[9] = l * T + h * k + g * M, t[10] = c * T + d * k + y * M, t[11] = f * T + v * k + b * M, e !== t && (t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t)
      ...
      var r = Math.sin(n),
        ...
        f = e[10],
        p = e[11];
      return e !== t && (t[0] = e[0], t[1] = e[1], t[2] = e[2], t[3] = e[3], t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t[4] = o * i + l * r, t[5] = a * i + c * r, t[6] = s * i + f * r, t[7] = u * i + p * r, t[8] = l * i - o * r, t[9] = c * i - a * r, t[10] = f * i - s * r, t[11] = p * i - u * r, t
      ...
      var r = Math.sin(n),
        ...
        f = e[10],
        p = e[11];
      return e !== t && (t[4] = e[4], t[5] = e[5], t[6] = e[6], t[7] = e[7], t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t[0] = o * i - l * r, t[1] = a * i - c * r, t[2] = s * i - f * r, t[3] = u * i - p * r, t[8] = o * r + l * i, t[9] = a * r + c * i, t[10] = s * r + f * i, t[11] = u * r + p * i, t
      ...
      var r = Math.sin(n),
        ...
        f = e[6],
        p = e[7];
      return e !== t && (t[8] = e[8], t[9] = e[9], t[10] = e[10], t[11] = e[11], t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t[0] = o * i + l * r, t[1] = a * i + c * r, t[2] = s * i + f * r, t[3] = u * i + p * r, t[4] = l * i - o * r, t[5] = c * i - a * r, t[6] = f * i - s * r, t[7] = p * i - u * r, t
      ...
      var r = e[0],
        ...
        g = a * u,
        y = a * l;
      return t[0] = 1 - (h + v), t[1] = f + y, t[2] = p - g, t[3] = 0, t[4] = f - y, t[5] = 1 - (c + v), t[6] = d + m, t[7] = 0, t[8] = p + g, t[9] = d - m, t[10] = 1 - (c + h), t[11] = 0, t[12] = n[0], t[13] = n[1], t[14] = n[2], t[15] = 1, t
      ...
      var i = e[0],
        ...
        w = r[1],
        x = r[2];
      return t[0] = (1 - (d + m)) * _, t[1] = (p + b) * _, t[2] = (h - y) * _, t[3] = 0, t[4] = (p - b) * w, t[5] = (1 - (f + m)) * w, t[6] = (v + g) * w, t[7] = 0, t[8] = (h + y) * x, t[9] = (v - g) * x, t[10] = (1 - (f + d)) * x, t[11] = 0, t[12] = n[0], t[13] = n[1], t[14] = n[2], t[15] = 1, t
      ...
      var o = e[0],
        ...
        S = i[1],
        T = i[2];
      return t[0] = (1 - (v + g)) * w, t[1] = (h + _) * w, t[2] = (d - b) * w, t[3] = 0, t[4] = (h - _) * x, t[5] = (1 - (p + g)) * x, t[6] = (m + y) * x, t[7] = 0, t[8] = (d + b) * E, t[9] = (m - y) * E, t[10] = (1 - (p + v)) * E, t[11] = 0, t[12] = n[0] + $ - (t[0] * $ + t[4] * S + t[8] * T), t[13] = n[1] + S - (t[1] * $ + t[5] * S + t[9] * T), t[14] = n[2] + T - (t[2] * $ + t[6] * S + t[10] * T), t[15] = 1, t
      ...
      var n = e[0],
        ...
        m = o * s,
        g = o * u;
      return t[0] = 1 - f - d, t[1] = c + g, t[2] = p - m, t[3] = 0, t[4] = c - g, t[5] = 1 - l - d, t[6] = h + v, t[7] = 0, t[8] = p + m, t[9] = h - v, t[10] = 1 - l - f, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1, t
      ...
      var a, s, u, l, c, f, p, h, d, v, m = e[0],
        ...
        E = n[1],
        $ = n[2];
      return Math.abs(m - x) < r.EPSILON && Math.abs(g - E) < r.EPSILON && Math.abs(y - $) < r.EPSILON ? i.identity(t) : (p = m - x, h = g - E, d = y - $, v = 1 / Math.sqrt(p * p + h * h + d * d), p *= v, h *= v, d *= v, a = _ * d - w * h, s = w * p - b * d, u = b * h - _ * p, v = Math.sqrt(a * a + s * s + u * u), v ? (v = 1 / v, a *= v, s *= v, u *= v) : (a = 0, s = 0, u = 0), l = h * u - d * s, c = d * a - p * u, f = p * s - h * a, v = Math.sqrt(l * l + c * c + f * f), v ? (v = 1 / v, l *= v, c *= v, f *= v) : (l = 0, c = 0, f = 0), t[0] = a, t[1] = l, t[2] = p, t[3] = 0, t[4] = s, t[5] = c, t[6] = h, t[7] = 0, t[8] = u, t[9] = f, t[10] = d, t[11] = 0, t[12] = -(a * m + s * g + u * y), t[13] = -(l * m + c * g + f * y), t[14] = -(p * m + h * g + d * y), t[15] = 1, t)
    }, i.str = function(t) {
  ...
  System.registerDynamic("b5", ["b2"], !0, function(t, e, n) {
    ...
    return i.create = function() {
      ...
      var n = e[0],
        ...
        h = l * o - a * u,
        d = n * f + r * p + i * h;
      return d ? (d = 1 / d, t[0] = f * d, t[1] = (-c * r + i * l) * d, t[2] = (s * r - i * a) * d, t[3] = p * d, t[4] = (c * n - i * u) * d, t[5] = (-s * n + i * o) * d, t[6] = h * d, t[7] = (-l * n + r * u) * d, t[8] = (a * n - r * o) * d, t) : null
    }, i.adjoint = function(t, e) {
      var n = e[0],
        r = e[1],
        i = e[2],
      ...
      var r = e[0],
        ...
        b = n[7],
        _ = n[8];
      return t[0] = p * r + h * a + d * l, t[1] = p * i + h * s + d * c, t[2] = p * o + h * u + d * f, t[3] = v * r + m * a + g * l, t[4] = v * i + m * s + g * c, t[5] = v * o + m * u + g * f, t[6] = y * r + b * a + _ * l, t[7] = y * i + b * s + _ * c, t[8] = y * o + b * u + _ * f, t
      ...
      var r = e[0],
        ...
        p = n[0],
        h = n[1];
      return t[0] = r, t[1] = i, t[2] = o, t[3] = a, t[4] = s, t[5] = u, t[6] = p * r + h * a + l, t[7] = p * i + h * s + c, t[8] = p * o + h * u + f, t
      ...
      var r = e[0],
        ...
        p = Math.sin(n),
        h = Math.cos(n);
      return t[0] = h * r + p * a, t[1] = h * i + p * s, t[2] = h * o + p * u, t[3] = h * a - p * r, t[4] = h * s - p * i, t[5] = h * u - p * o, t[6] = l, t[7] = c, t[8] = f, t
    }, i.scale = function(t, e, n) {
      var r = n[0],
        i = n[1];
      ...
      var n = e[0],
        ...
        m = o * s,
        g = o * u;
      return t[0] = 1 - f - d, t[3] = c - g, t[6] = p + m, t[1] = c + g, t[4] = 1 - l - d, t[7] = h - v, t[2] = p - m, t[5] = h + v, t[8] = 1 - l - f, t
      ...
      var n = e[0],
        ...
        A = p * g - h * m,
        C = y * A - b * M + _ * k + w * T - x * S + E * $;
      return C ? (C = 1 / C, t[0] = (s * A - u * M + l * k) * C, t[1] = (u * T - a * A - l * S) * C, t[2] = (a * M - s * T + l * $) * C, t[3] = (i * M - r * A - o * k) * C, t[4] = (n * A - i * T + o * S) * C, t[5] = (r * T - n * M - o * $) * C, t[6] = (v * E - m * x + g * w) * C, t[7] = (m * _ - d * E - g * b) * C, t[8] = (d * x - v * _ + g * y) * C, t) : null
    }, i.str = function(t) {
  ...
  System.registerDynamic("b6", ["b2", "b5", "b7", "b8"], !0, function(t, e, n) {
    ...
    return s.create = function() {
      ...
      return function(r, i, a) {
        var u = o.dot(i, a);
        return u < -.999999 ? (o.cross(t, e, i), o.length(t) < 1e-6 && o.cross(t, n, i), o.normalize(t, t), s.setAxisAngle(r, t, Math.PI), r) : u > .999999 ? (r[0] = 0, r[1] = 0, r[2] = 0, r[3] = 1, r) : (o.cross(t, i, a), r[0] = t[0], r[1] = t[1], r[2] = t[2], r[3] = 1 + u, s.normalize(r, r))
      }
    }(), s.setAxes = function() {
      var t = i.create();
      return function(e, n, r, i) {
        return t[0] = r[0], t[3] = r[1], t[6] = r[2], t[1] = i[0], t[4] = i[1], t[7] = i[2], t[2] = -n[0], t[5] = -n[1],
          t[8] = -n[2], s.normalize(e, s.fromMat3(e, t))
      }
      ...
      var i, o, a, s, u, l = e[0],
        ...
        v = n[2],
        m = n[3];
      return o = l * h + c * d + f * v + p * m, o < 0 && (o = -o, h = -h, d = -d, v = -v, m = -m), 1 - o > 1e-6 ? (i = Math.acos(o), a = Math.sin(i), s = Math.sin((1 - r) * i) / a, u = Math.sin(r * i) / a) : (s = 1 - r, u = r), t[0] = s * l + u * h, t[1] = s * c + u * d, t[2] = s * f + u * v, t[3] = s * p + u * m, t
    }, s.sqlerp = function() {
      var t = s.create(),
        e = s.create();
    ...
    }, s.exactEquals = a.exactEquals, s.equals = a.equals, n.exports = s, n.exports});
  ...
  System.registerDynamic("b7", ["b2"], !0, function(t, e, n) {
    ...
    return i.create = function() {
      ...
      var a = 1 - o,
        ...
        f = 3 * u * a,
        p = u * o;
      return t[0] = e[0] * l + n[0] * c + r[0] * f + i[0] * p, t[1] = e[1] * l + n[1] * c + r[1] * f + i[1] * p, t[2] = e[2] * l + n[2] * c + r[2] * f + i[2] * p, t
    }, i.random = function(t, e) {
      e = e || 1;
      var n = 2 * r.RANDOM() * Math.PI,
        i = 2 * r.RANDOM() - 1,
      ...
      var r = e[0],
        ...
        p = l * o + a * i - s * r,
        h = -a * r - s * i - u * o;
      return t[0] = c * l + h * -a + f * -u - p * -s, t[1] = f * l + h * -s + p * -a - c * -u, t[2] = p * l + h * -u + c * -s - f * -a, t
  ...
  System.registerDynamic("b8", ["b2"], !0, function(t, e, n) {
    ...
    return i.create = function() {
      ...
      var r = e[0],
        ...
        p = l * o + a * i - s * r,
        h = -a * r - s * i - u * o;
      return t[0] = c * l + h * -a + f * -u - p * -s, t[1] = f * l + h * -s + p * -a - c * -u, t[2] = p * l + h * -u + c * -s - f * -a, t[3] = e[3], t
    }, i.forEach = function() {
      var t = i.create();
      return function(e, n, r, i, o, a) {
        var s, u;
  ...
  System.registerDynamic("ba", ["b2", "b1", "b3", "b5", "b4", "b6", "b9", "b7", "b8"], !0, function(t, e, n) {
    return e.glMatrix = t("b2"), e.mat2 = t("b1"), e.mat2d = t("b3"), e.mat3 = t("b5"), e.mat4 = t("b4"), e.quat = t("b6"), e.vec2 = t("b9"), e.vec3 = t("b7"), e.vec4 = t("b8"), n.exports});
  System.registerDynamic("5e", ["ba"], !0, function(t, e, n) {
    return n.exports = t("ba"), n.exports});
  System.registerDynamic("69", ["b0", "5e"], !0, function(t, e, n) {
    "use strict";

    function r(t, e) {
      for (var n = Math.max(t, e), r = 256; r < n;) r *= 2;
      return r
    }
    ...
    function i(t) {
      ...
      if (!n) throw new Error("Failed to create WebGL context");
      return n
    }

    function o(t) {
      for (var e = 6 * t, n = new Uint16Array(e), r = 0, i = 0; r < e; i += 4) n[r++] = i + 0, n[r++] = i + 1, n[r++] = i + 2, n[r++] = i + 0, n[r++] = i + 2, n[r++] = i + 3;
      return n
    }

    function a(t, e, n, r, i, o) {
      return void 0 === r && (r = 1), void 0 === i && (i = 0), void 0 === o && (o = 0), p.mat4.identity(t), p.mat4.translate(t, t, p.vec3.fromValues(-1, 1, 0)), p.mat4.scale(t, t, p.vec3.fromValues(2 / e, -2 / n, 1)), p.mat4.scale(t, t, p.vec3.fromValues(r, r, 1)), p.mat4.translate(t, t, p.vec3.fromValues(i, o, 0)), t
    }
    ...
    return e.getRenderTargetSize = r, e.getWebGLContext = i, e.createIndices = o, e.createViewMatrix = a, e.createViewMatrix2 = s, e.createBasicShader = u, e.createSpriteShader = l, e.createPaletteShader = c, n.exports});
  System.registerDynamic("bb", [], !0, function(t, e, n) {
    ...
    var i = function() {
      ...
      return t.prototype.initialize = function() {
        var t = this;
        this.initialized || (this.initialized = !0, window.addEventListener("keydown", function(e) {
          !r(e) && t.manager.setValue(e.keyCode, 1) && (e.preventDefault(), e.stopPropagation())
        }), window.addEventListener("keyup", function(e) {
          t.manager.setValue(e.keyCode, 0) && (e.preventDefault(), e.stopPropagation())
        }), window.addEventListener("blur", function(e) {
          t.manager.clear()
        }))
      }, t.prototype.update = function() {}, t.prototype.draw = function() {}, t
    }();
    return e.KeyboardController = i, n.exports});
  System.registerDynamic("bc", [], !0, function(t, e, n) {
        ...
        return t.prototype.initialize = function() {
          ...
          if (!this.initialized) {
            ...
            e.addEventListener("mousemove", function(e) {
              t.manager.setValue(1e3, Math.floor(e.clientX)), t.manager.setValue(1001, Math.floor(e.clientY))
    ...
    return e.MouseController = i, n.exports});
  System.registerDynamic("bd", ["22"], !0, function(t, e, n) {
    ...
    var i = t("22"),
      ...
      s = function() {
        function t(t) {
          this.manager = t, this.touchId = -1, this.touchStartTime = 0, this.touchStart = {
            x: 0,
            y: 0
          }, this.touchCurrent = {
            x: 0,
            y: 0
          }, this.originShown = !1, this.positionShown = !1
        }

        return t.prototype.initialize = function() {
          var t = this;
          if (!this.initialized) {
            this.initialized = !0, this.origin = document.getElementById("touch-origin"), this.position = document.getElementById("touch-position");
            var e = document.getElementById("canvas");
            e.addEventListener("touchstart", function(e) {
              if (e.preventDefault(), e.stopPropagation(), t.touchId === -1) {
                var n = e.changedTouches.item(0);
                t.touchId = n.identifier, t.touchStartTime = Date.now(), t.touchStart = t.touchCurrent = {
                  x: n.clientX,
                  y: n.clientY
                }
              }
              ...
              e.preventDefault(), e.stopPropagation();
              var n = r(e, t.touchId);
              n && (t.touchIsDrag || (t.manager.setValue(1e3, t.touchStart.x), t.manager.setValue(1001, t.touchStart.y), t.manager.setValue(1002, 1)), t.resetTouch())
            }), window.addEventListener("blur", function() {
              return t.resetTouch()
            })
          }
        }, t.prototype.update = function() {}, t.prototype.draw = function() {
          var t = this.touchIsDrag && this.touchId !== -1,
            e = this.touchId !== -1;
          if (this.originShown !== t && (this.originShown = t, this.origin.style.display = t ? "block" : "none"), this.positionShown !== e && (this.positionShown = e, this.position.style.display = e ? "block" : "none"), t) {
            var n = "translate3d(" + (this.touchStart.x - 50) + "px, " + (this.touchStart.y - 50) + "px, 0px)";
            this.originTransform !== n && (this.originTransform = n, i.setTransform(this.origin, n))
          }
          if (e) {
            var n = "translate3d(" + (this.touchCurrent.x - 25) + "px, " + (this.touchCurrent.y - 25) + "px, 0px)";
            this.positionTransform !== n && (this.positionTransform = n, i.setTransform(this.position, n))
          }
        }, t.prototype.resetTouch = function() {
          this.touchId = -1, this.touchStart = this.touchCurrent = {
            x: 0,
            y: 0
          }, this.touchIsDrag = !1, this.updateInput()
          ...
          if (r > o) {
            ...
            this.touchIsDrag = !0, this.manager.setValue(2e3, -Math.cos(n) * i), this.manager.setValue(2001, -Math.sin(n) * i)
          } else this.manager.setValue(2e3, 0), this.manager.setValue(2001, 0)
        }, t
      }();
    return e.TouchController = s, n.exports});
  System.registerDynamic("be", [getCodeName("Lodash")], !0, function(t, e, n) {
    ...
    var r = t(getCodeName("Lodash")),
      ...
      o = function() {
        function t(t) {
          this.manager = t, this.gamepadIndex = -1
        }

        return t.prototype.initialize = function() {
          var t = this;
          this.initialized || (this.initialized = !0, window.addEventListener("gamepadconnected", function(e) {
          ...
          if (this.gamepadIndex !== -1) {
            ...
            if (!e) return void this.scanGamepads();
            ...
            if (o > i) {
              ...
              this.manager.setValue(2e3, Math.cos(s) * a), this.manager.setValue(2001, Math.sin(s) * a)
            } else this.zeroed || (this.manager.setValue(2e3, 0), this.manager.setValue(2001, 0), this.zeroed = !0);
            this.manager.setValue(3003, e.buttons[r] && e.buttons[r].pressed ? 1 : 0)
          }
        }, t.prototype.draw = function() {}, t.prototype.scanGamepads = function() {
    ...
    return e.GamePadController = o, n.exports});
  System.registerDynamic("bf", [getCodeName("Lodash"), "bb", "bc", "bd", "be"], !0, function(t, e, n) {
    ...
    var r = t(getCodeName("Lodash")),
      ...
      u = function() {
        ...
        return Object.defineProperty(t.prototype, "axisX", {
          ...
          this.controllers = [new i.KeyboardController(this), new o.MouseController(this), new a.TouchController(this), new s.GamePadController(this)], this.controllers.forEach(function(t) {
            return t.initialize()
          })
        }, t.prototype.update = function() {
          ...
          r.forEach(function(t) {
            n.actions[t] || (n.actions[t] = []), n.actions[t].push(e)
          })
        }, t.prototype.getAction = function() {
          for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n - 0] = arguments[n];
          return e.reduce(function(e, n) {
            var r = !!t.inputs[n];
            return t.inputs[n] = 0, e || r
          }, !1)
    ...
    return e.InputManager = u, n.exports});
  System.registerDynamic("43", ["22"], !0, function(t, e, n) {
    "use strict";

    function r(t, e, n) {
      t.width === e && t.height === n || (t.width = e, t.height = n)
    }
    ...
    function o(t, e, n) {
      return t = t || a.createCanvas(e, n), r(t, e, n), t
    }

    var a = t("22");
    return e.resizeCanvas = r, e.resizeCanvasToElementSize = i, e.createOrResizeCanvas = o, n.exports});
  System.registerDynamic("c0", ["5e", "5c", "22", "21", "2a", "2b", "5f", "24", "23", "60", "68", "6b", "6c", "89", "69", "1f", "bf", "3c", "43", "20"], !0, function(t, e, n) {
    ...
    function o(t) {
      t.addEmoticon(":apple:", "ðŸŽ", w.apple.color), t.addEmoticon(":heart:", "â¤", w.heartemote), t.addEmoticon(":pumpkin:", "ðŸŽƒ", w.pumpkinemote), t.addEmoticon(":pizza:", "ðŸ•", w.pizzaemote), t.addEmoticon(":rock:", "â½¯", w.rockemote), t.addEmoticon(":face:", "ãƒ„"), t.addEmoticon(":derp:", "ã‚·")
    }
    ...
    var a = t("5e"),
      ...
      T = function() {
        function t() {
          this.map = new f.Map(0, 0), this.scale = u.getPixelRatio() > 1 ? 3 : 2, this.baseTime = 0, this.camera = new p.Camera, this.failedToCreateWebGL = !1, this.apply = function(t) {
            return t()
          }, this.input = new x.InputManager, this.timeSize = 0, this.lastStats = 0, this.sent = 0, this.recv = 0, this.textJump = 0, this.hideText = !1, this.viewMatrix = a.mat4.create(), this.initialized = !1
        }

        return t.prototype.changeScale = function() {
          this.scale = this.scale % 4 + 1
        }, t.prototype.load = function() {
          return this.loadPromise || (this.loadPromise = E.loadSpriteSheets(w.spriteSheets, "/images/"))
        }, t.prototype.init = function() {
          var t = this;
          this.initialized || (this.initialized = !0, this.canvas = document.getElementById("canvas"), this.stats = document.getElementById("stats"), this.clock = document.getElementById("clock"), this.input.initialize(), this.input.onReleased([80, 3003], function() {
          ...
          }), this.resizeCanvas(), window.addEventListener("resize", function() {
            return t.resizeCanvas()
          }), this.gl || this.initWebGL())
        }, t.prototype.initWebGL = function() {
          try {
            this.updateCamera();
            var t = this.gl = _.getWebGLContext(this.canvas),
              e = _.getRenderTargetSize(this.camera.w, this.camera.h);
            this.frameBuffer = s(t, [e, e], {
              depth: !1
            }), this.spriteShader = _.createSpriteShader(t), this.spriteBatch = new m.SpriteBatch(t), b.createTexturesForSpriteSheets(t, w.spriteSheets), this.spriteBatch.rectSprite = w.pixel, this.button = new g.SpriteButton(w.bubble, 2, 2, 2, 2), this.font = new y.SpriteFont(w.font), o(this.font)
          } catch (t) {
            throw console.error(t), this.releaseWebGL(), t
          }
        }, t.prototype.releaseWebGL = function() {
          this.gl = null, this.font = null, this.button = null, this.frameBuffer && (this.frameBuffer.dispose(), this.frameBuffer = null), this.spriteShader && (this.spriteShader.dispose(), this.spriteShader = null), this.spriteBatch && (this.spriteBatch.dispose(), this.spriteBatch = null), b.releaseTexturesForSpriteSheets(w.spriteSheets)
        }, t.prototype.updateCamera = function() {
          this.camera.w = Math.ceil(this.canvas.width / this.scale), this.camera.h = Math.ceil(this.canvas.height / this.scale)
        }, t.prototype.release = function() {
          this.selected = null, this.socket && (this.socket.disconnect(), this.socket = null)
        }, t.prototype.startup = function(t, e) {
          this.selected = null, this.socket = t, this.apply = e
        }, t.prototype.update = function(t) {
          if (this.socket && this.socket.isConnected) {
            var e = this.camera,
              n = this.player,
              r = this.map;
            if (i(this), this.input.update(), this.updateCamera(), n && r) {
              var o = this.input.axisX,
                ...
                g = p.y * v;
              if (n.vx !== m || n.vy !== g) {
                var y = u.encodeMovement(n.x, n.y, f, h),
                  b = y[0],
                  _ = y[1];
                this.socket.server.update(b, _)
              }
              if (n.vx = m, n.vy = g, e.update(n, r), this.input.getAction(1002)) {
                var w = this.scale / u.getPixelRatio(),
                  x = e.screenToWorld({
                    x: this.input.getRange(1e3) / w,
                    y: this.input.getRange(1001) / w
                  }),
                  E = r.pickEntity(x, this.input.isPressed(16));
                if (E) "pony" === E.type ? this.select(E) : this.socket.server.interact(E.id);
                else if (this.selected) this.select(null);
                else {
                  var $ = this.map.getTile(0 | x.x, 0 | x.y) === d.TileType.Grass ? d.TileType.Dirt : d.TileType.Grass;
                  this.socket.server.changeTile(0 | x.x, 0 | x.y, $)
                }
              }
              r.update(t);
              var S = n.x * l.tileWidth,
                T = n.y * l.tileHeight;
              r.forEachEntity(function(t) {
                t.coverBounds && (t.coverLifted = u.containsPoint(t.x * l.tileWidth, t.y * l.tileHeight, t.coverBounds, S, T))
              })
            }
            this.timeSize += t, this.textJump += 4 * t, this.timeSize > 1 && (this.sent = 8 * this.socket.sentSize / this.timeSize / 1024, this.recv = 8 * this.socket.receivedSize / this.timeSize / 1024, this.socket.sentSize = 0, this.socket.receivedSize = 0, this.timeSize = 0)
          }
          ...
          this.selected !== t && this.apply(function() {
            e.selected && (e.selected.selected = !1), e.selected = t, e.selected && (e.selected.selected = !0)
          })
        }, t.prototype.draw = function(t) {
          var e = this;
          if (this.gl) {
            var n = this.gl,
              r = this.camera.w,
              i = this.camera.h,
              o = Math.round(this.scale),
              a = v.getLight(this.getTime()),
              s = _.getRenderTargetSize(r, i);
            if (s !== this.frameBuffer.shape[0]) {
              var l = n.getParameter(n.MAX_RENDERBUFFER_SIZE);
              if (s > l) return void this.scale++;
              this.frameBuffer.shape = [s, s]
            }
            this.frameBuffer.bind(), n.enable(n.SCISSOR_TEST), n.scissor(0, 0, r, i), n.viewport(0, 0, r, i), n.disable(n.DEPTH_TEST), n.enable(n.BLEND), n.blendEquation(n.FUNC_ADD), n.blendFunc(n.SRC_ALPHA, n.ONE_MINUS_SRC_ALPHA), n.clearColor(h.BG_COLOR.floatR, h.BG_COLOR.floatG, h.BG_COLOR.floatB, 1), n.clear(n.COLOR_BUFFER_BIT), this.spriteBatch.begin(this.spriteShader), this.spriteShader.uniforms.transform = _.createViewMatrix(this.viewMatrix, this.camera.w, this.camera.h, 1, -this.camera.x, -this.camera.y), this.spriteShader.uniforms.lighting = a.toFloatArray(), this.map && this.map.draw(this.spriteBatch, this.camera), this.spriteBatch.end();
            var f = this.spriteBatch.tris;
            if (this.spriteBatch.begin(this.spriteShader), this.spriteShader.uniforms.transform = _.createViewMatrix(this.viewMatrix, this.camera.w, this.camera.h, 1), this.spriteShader.uniforms.lighting = [1, 1, 1, 1], !this.hideText) {
              var p = this.scale / u.getPixelRatio(),
                d = this.camera.screenToWorld({
                  x: this.input.getRange(1e3) / p,
                  y: this.input.getRange(1001) / p
                });
              this.map.forEachRegion(function(t) {
                t.entities.forEach(function(t) {
                  if (t !== e.player && t.name) {
                    var n = t.interactBounds || t.bounds;
                    if (n && u.contains(t.x, t.y, n, d)) {
            ...
            this.socket && this.socket.isConnected || this.drawMessage(this.spriteBatch, "Connecting..."), this.spriteBatch.end(), f += this.spriteBatch.tris, this.input.draw(), n.disable(n.SCISSOR_TEST), n.bindFramebuffer(n.FRAMEBUFFER, null), n.viewport(0, 0, this.canvas.width, this.canvas.height), this.spriteBatch.begin(this.spriteShader), this.spriteShader.uniforms.transform = _.createViewMatrix2(this.viewMatrix, this.canvas.width, this.canvas.height, o), this.spriteShader.uniforms.lighting = [1, 1, 1, 1], this.spriteBatch.drawImage(this.frameBuffer.color[0], null, 0, 0, r, i, 0, 0, r, i), this.spriteBatch.end();
            var m = Date.now();
            if (m - this.lastStats > 1e3) {
              var g = this.sent.toFixed(),
                y = this.recv.toFixed(),
                b = this.map ? this.map.entitiesDrawn : 0,
                w = this.map ? this.map.getTotalEntities() : 0,
                x = this.map ? this.map.getTotalEntities(function(t) {
                  return t instanceof c.Pony
                }) : 0;
              this.stats.textContent = t.toFixed(0) + " fps " + g + "/" + y + " kb/s " + x + " ponies" + (S.debug ? " (" + b + "/" + w + ") " + f + " tris" : ""), this.lastStats = m, this.clock.textContent = v.getTime(this.getTime())
            }
          }
          ...
          var t = window.innerWidth,
            ...
            r = Math.round(t * n),
            i = Math.round(e * n);
          $.resizeCanvas(this.canvas, r, i)
        }, t.prototype.drawMessage = function(t, e) {
          var n = 100,
            r = Math.round((this.camera.h - n) / 2);
          t.drawRect(h.GRAY, 0, r, this.camera.w, n), this.font.drawTextAligned(t, e, h.WHITE, {
            x: 0,
            y: r,
            w: this.camera.w,
            h: n
          ...
          if (u.intersect(0, 0, this.camera.w, this.camera.h, n - c.w / 2, i - c.h / 2, c.w, c.h)) {
            var f = .2,
              ...
              _ = u.clamp(Math.round(y), 0, m.length);
            i += _ < m.length ? m[_] : v[b];
            var x = Math.min(p, d, 1),
              E = 4,
              $ = n - Math.round(c.w / 2),
              S = i - c.h;
            t.globalAlpha = .6 * x, this.button.draw(t, h.BLACK, $ - E, S - E, c.w + 2 * E, c.h + 2 * E), t.drawSprite(w.nipple, h.BLACK, n - Math.round(w.nipple.w / 2), i + E), t.globalAlpha = x, this.font.drawText(t, o, r(a), $, S), t.globalAlpha = 1
          }
        }, t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = T, n.exports});
  System.registerDynamic("2c", ["c0"], !0, function(t, e, n) {
    "use strict";
    var r, i = t("c0");
    return Object.defineProperty(e, "__esModule", {
      value: !0
  ...
  System.registerDynamic("2d", [getCodeName("Lodash"), "20"], !0, function(t, e, n) {
    ...
    function o(t) {
      var e = t.id,
        ...
        r = t.url,
        i = t.provider,
        o = s.oauthProviders.find(function(t) {
          return t.id === i
        });
      return {
        id: e,
  ...
  System.registerDynamic("c2", ["53", "21", "54", "22", "55", "2c", "2d", "c1"], !0, function(t, e, n) {
    ...
    var r = t("53"),
      ...
      p = function() {
        function t(t, e) {
          this.$element = t, this.model = e, this.timeouts = i.TIMEOUTS, this.canvas = t.find("canvas")[0]
        }
        ...
        return Object.defineProperty(t.prototype, "isMod", {
          ...
          if (t.pony) {
            this.name = this.pony.name.replace(/:apple:/g, "ðŸŽ").replace(/:heart:/g, "â¤").replace(/:pumpkin:/g, "ðŸŽƒ").replace(/:pizza:/g, "ðŸ•").replace(/:rock:/g, "â½¯").replace(/:face:/g, "ãƒ„").replace(/:derp:/g, "ã‚·"), this.site = this.pony.site ? l.toSocialSiteInfo(this.pony.site) : null;
            var e = this.canvas.getContext("2d");
            e.save(), e.fillStyle = "#444", e.fillRect(0, 0, this.canvas.width, this.canvas.height), this.pony && (e.translate(9 * f, 54 * f), e.scale(-f, f), a.disableImageSmoothing(e), this.pony.drawHead(e)), e.restore()
          }
        }, t.prototype.report = function() {
          this.isMod && this.action(o.PlayerAction.Report)
        }, t.prototype.timeout = function(t) {
          this.isMod && (this.action(o.PlayerAction.Timeout, t), this.pony.timeout = a.fromNow(t).toISOString())
        }, t.prototype.toggleIgnore = function() {
          this.action(this.pony.ignored ? o.PlayerAction.Unignore : o.PlayerAction.Ignore), this.pony.ignored = !this.pony.ignored
        }, t.prototype.toggleMute = function() {
          this.isMod && (this.action(this.pony.muted ? o.PlayerAction.Unmute : o.PlayerAction.Mute), this.pony.muted = !this.pony.muted)
        }, t.prototype.toggleShadow = function() {
          this.isMod && (this.action(this.pony.shadow ? o.PlayerAction.Unshadow : o.PlayerAction.Shadow), this.pony.shadow = !this.pony.shadow)
        }, t.prototype.blur = function() {
          this.isMod && (c.socket.server.setNote(this.pony.id, this.pony.note), this.isNoteOpen = !1)
        }, t.prototype.keydown = function(t) {
          27 === t.keyCode && this.blur()
        }, t.prototype.action = function(t, e) {
          void 0 === e && (e = 0), c.socket.server.playerAction(this.pony.id, t, e)
        }, t.$inject = ["$element", "model"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = {
  ...
  System.registerDynamic("c3", [getCodeName("BlueBird"), "53", "2e", "31", "33", "35", "37", "39", "3b", "3e", "40", "41", "42", "47", "49", "4b", "4d", "4f", "51", "c2"], !0, function(t, e, n) {
    ...
    function r(t) {
      t.run(["$rootScope", function(t) {
        i.setScheduler || Rollbar.error("Promise.setScheduler error: " + Object.keys(i).map(function(t) {
            return t + ": " + i[t].toString().substr(0, 60)
      ...
      }), t.service("gameService", a.GameService), t.service("model", s.Model), t.service("applyCallback", ["$rootScope", function(t) {
        return function(e) {
          t.$$phase ? e() : t.$apply(e)
        }
      }]), t.directive("agDrag", u.default), t.directive("agAutoFocus", function() {
        return {
          restrict: "A",
          link: function(t, e) {
            setTimeout(function() {
        ...
        return {
          restrict: "E",
          link: function(t, e, n) {
            !n.target && n.href && /^https?:/.test(n.href) && (e[0].setAttribute("target", "_blank"), e[0].setAttribute("rel", "noopener noreferrer"))
          }
        }
      }), t.component("colorPicker", l.default), t.component("checkBox", c.default), t.component("fillOutline", f.default), t.component("spriteBox", p.default), t.component("spriteSelection", h.default), t.component("spriteSetSelection", d.default), t.component("bitmapBox", v.default), t.component("characterPreview", m.default), t.component("chatBox", g.default), t.component("settingsBox", y.default), t.component("accountButton", b.default), t.component("menuBar", _.menuBar), t.component("menuItem", _.menuItem), t.component("signInBox", w.default), t.component("playBox", x.default), t.component("ponyBox", E.default)
    }
  ...
  System.registerDynamic("45", ["1f", "3c"], !0, function(t, e, n) {
    ...
    var i, o = t("1f"),
      a = t("3c");
    return e.loadSpriteSheets = r, n.exports});
  System.registerDynamic("c5", [], !0, function(t, e, n) {
    ...
    function i(t, e) {
      try {
        localStorage.setItem(t, e), a = null
      } catch (n) {
        a || (a = {}), this.data[t] = e
      }
    }
    ...
    var a = null;
    return e.getItem = r, e.setItem = i, e.removeItem = o, n.exports});
  System.registerDynamic("c6", [getCodeName("Lodash"), "21", "22", "44", "32", "1f", "45", "5d", "20", "c5"], !0, function(t, e, n) {
    ...
    var r = t(getCodeName("Lodash")),
      ...
      h = u.ponyNoses[0],
      d = function() {
        function t(t, e, n, r, s, l) {
          var f = this;
          this.$http = e, this.$timeout = n, this.$location = r, this.gameService = s, this.model = l, this.maxNameLength = i.PLAYER_NAME_MAX_LENGTH, this.state = a.createDefaultPonyState(), this.saved = [], this.brushType = "brush", this.brush = "orange", this.horns = u.ponyHorns, this.manes = u.ponyManes, this.backManes = u.ponyBackManes, this.tails = u.ponyTails, this.facialHair = u.ponyFacialHair, this.wings = u.ponyWings, this.headAccessories = u.ponyHeadAccessories, this.earAccessories = u.ponyEarAccessories, this.faceAccessories = u.ponyFaceAccessories, this.neckAccessories = u.ponyNeckAccessories, this.frontLegAccessories = u.ponyFrontLegAccessoriesStand[0], this.backLegAccessories = u.ponyBackLegAccessoriesStand[0], this.frontHooves = [null, [
            [u.ponyFetlocksFrontStand[0]]
          ]], this.backHooves = [null, [
            [u.ponyFetlocksBackStand[0]]
          ]], this.animations = c.animations, this.activeAnimation = 0, this.muzzles = u.ponyNoses.map(function(t) {
            return {
              fill: null,
              outline: t.muzzle,
              extra: t.mouth
            ...
            outline: h.muzzle,
            extra: h.fangs
          }], this.loaded = !1, this.playAnimation = !0, this.cmSize = i.CM_SIZE, this.deleting = !1, this.nextBlink = 0, this.blinkFrames = a.BLINK_FRAMES, this.blinkFrame = -1, this.handleError = o.errorHandler(this), this.destroyed = !1, t.$on("$destroy", function() {
            return f.destroy()
          })
        }
        ...
        return Object.defineProperty(t.prototype, "customOutlines", {
          ...
          var t = this;
          if (this.$timeout(function() {
              t.model.account || t.$location.url("/")
            }, 1e3), f.debug) {
            var e, n;
            window.addEventListener("keydown", function(r) {
              71 === r.keyCode && (n || e || (n = t.pony.backLegAccessory, e = t.pony.frontLegAccessory, t.pony.backLegAccessory = null, t.pony.frontLegAccessory = null))
            }), window.addEventListener("keyup", function(r) {
              71 === r.keyCode && (t.pony.backLegAccessory = n, t.pony.frontLegAccessory = e, n = null, e = null)
            })
          }
          var r = Date.now();
          return l.loadSpriteSheets().then(function() {
            t.destroyed || (t.loaded = !0, t.interval = setInterval(function() {
              var e = Date.now();
              t.update(e - r), r = e
            }, 1e3 / 24))
          })
        }, t.prototype.destroy = function() {
          this.destroyed = !0, clearInterval(this.interval)
        }, t.prototype.update = function(t) {
          var e = Date.now();
          this.state.animation = this.animations[this.activeAnimation], this.playAnimation && (this.state.animationFrame = (this.state.animationFrame + 1) % this.state.animation.frames), this.blinkFrame === -1 ? this.nextBlink < e && (this.blinkFrame = 0) : (this.blinkFrame++, this.blinkFrame >= this.blinkFrames.length && (this.nextBlink = e + 2e3 * Math.random() + 3e3, this.blinkFrame = -1)), this.state.blinkFrame = this.blinkFrame === -1 ? 1 : this.blinkFrames[this.blinkFrame]
          ...
          this.deleting = !1, this.pony = s.createDefaultPony()
        }, t.prototype.select = function(t) {
          t && (this.deleting = !1, this.pony = t)
          ...
          return this.error = null, this.deleting = !1, this.model.savePony(this.pony).catch(this.handleError)
          ...
          return this.error = null, this.deleting = !1, this.model.removePony(this.pony).catch(this.handleError)
          ...
          this.deleting = !1, this.pony = r.cloneDeep(this.pony), this.pony.name = "", delete this.pony.id
        ...
        }, t.$inject = ["$scope", "$http", "$timeout", "$location", "gameService", "model"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = d, n.exports});
  System.registerDynamic("c7", [getCodeName("Lodash"), "21", "22"], !0, function(t, e, n) {
    ...
    var r = t(getCodeName("Lodash")),
      ...
      a = function() {
        function t(t, e, n) {
          var r = this;
          this.$location = e, this.model = n, this.nameMinLength = i.ACCOUNT_NAME_MIN_LENGTH, this.nameMaxLength = i.ACCOUNT_NAME_MAX_LENGTH, this.settings = {}, this.handleError = o.errorHandler(this), t.$watchCollection("[vm.settings.filterSwearWords, vm.settings.filterCyrillic]", function() {
        ...
        return t.prototype.init = function() {
          ...
          t ? (this.settings = r.clone(t.settings), this.data = {
            name: t.name
          }) : this.$location.url("/")
          ...
          this.canSubmit && (this.error = null, this.model.updateAccount(this.data).catch(this.handleError))
        ...
        }, t.$inject = ["$scope", "$location", "model"], t
      }();
    return Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.default = a, n.exports});
  System.registerDynamic("3a", ["36"], !0, function(t, e, n) {
    "use strict";

    function r(t) {
      var e = a.default.parseWithAlpha(t, 1).hsva();
      return e.v *= .7, e.s = Math.min(1.3 * e.s, 1), a.default.fromHsvaObject(e).css()
    }
    ...
    function o(t, e) {
      ...
      return n.v *= e, a.default.fromHsvaObject(n).css()
    }

    var a = t("36");
    return e.fillToOutline = r, e.colorToFar = i, e.darkenColor = o, n.exports});
  System.registerDynamic("32", [getCodeName("Lodash"), "1f", "22", "3a", "21", "36"], !0, function(t, e, n) {
    ...
    function S(t, e, n) {
      if (void 0 === n && (n = !0), !t || n && 0 === t.type) return null;
      var r = e ? m(e) : null,
    ...
    var D = t(getCodeName("Lodash")),
      ...
      F = t("21"),
      P = t("36");
    return e.fixPony = r, e.createSpriteSet = i, e.createDefaultCM = o, e.createDefaultPony = a, e.toRenderInfo = d, e.randomizePony = v, e.compressPonyInfo = k, e.decompressPonyInfo = M, e.toPalette = C, n.exports});
  System.registerDynamic("24", ["36"], !0, function(t, e, n) {
    "use strict";
    var r = t("36");
    return e.WHITE = r.default.parse("white"), e.BLACK = r.default.parse("black"), e.ORANGE = r.default.parse("orange"), e.BLUE = r.default.parse("blue"), e.GRAY = r.default.parse("#444"), e.RED = r.default.parse("red"), e.PURPLE = r.default.parse("purple"), e.BG_COLOR = r.default.parse("LightGreen"), e.ADMIN_COLOR = r.default.parse("HotPink"), e.SYSTEM_COLOR = r.default.parse("#999"), e.SHADOW_COLOR = new r.default(0, 0, 0, .3), e.SHINES_COLOR = new r.default(255, 255, 255, .4), n.exports});
  System.registerDynamic("c8", [], !0, function(t, e, n) {
    ...
    }, n.exports = a, n.exports});
  System.registerDynamic("c9", ["c8"], !0, function(t, e, n) {
    return n.exports = t("c8"), n.exports});
  System.registerDynamic("36", ["c9"], !0, function(t, e, n) {
    ...
    var i = t("c9"),
      o = function() {
        function t(t, e, n, r) {
          void 0 === t && (t = 0), void 0 === e && (e = 0), void 0 === n && (n = 0), void 0 === r && (r = 1), this.r = 0 | t, this.g = 0 | e, this.b = 0 | n, this.a = +r
        }
        ...
        return Object.defineProperty(t.prototype, "floatR", {
          ...
          return void 0 === t && (t = 1), i.colorToFloat(this.r, this.g, this.b, this.a * t * 255)
          ...
          var e = this.hsva();
          return e.h += e.h >= 180 ? -180 : 180, t.fromHsvaObject(e)
          ...
          if ("string" != typeof e) return new t(0, 0, 0, 0);
          if (e = e.trim().toLowerCase(), "" === e || "none" === e || "transparent" === e) return new t(0, 0, 0, 0);
          e = t.names[e] || e;
          var n = /(\d+)[ ,]+(\d+)[ ,]+(\d+)([ ,]+(\d*\.?\d+))?/.exec(e);
          if (n) return new t(parseInt(n[1], 10), parseInt(n[2], 10), parseInt(n[3], 10), n[5] ? parseFloat(n[5]) : 1);
          e = e.replace(/^#+/, "");
          var r, i, o, a;
          return 3 === e.length ? (r = 17 * parseInt(e.charAt(0), 16), i = 17 * parseInt(e.charAt(1), 16), o = 17 * parseInt(e.charAt(2), 16), a = 1) : (r = parseInt(e.substr(0, 2), 16), i = parseInt(e.substr(2, 2), 16), o = parseInt(e.substr(4, 2), 16), a = e.length >= 8 ? parseInt(e.substr(6, 2), 16) / 255 : 1), new t(r, i, o, a)
          ...
          void 0 === i && (i = 0), t /= 255, e /= 255, n /= 255, i /= 360;
          ...
          t = Math.max(0, Math.min(360, 360 === t ? 0 : t)), e = Math.max(0, Math.min(1, e)), n = Math.max(0, Math.min(1, n));
          var i = n,
            o = n,
            a = n;
          if (0 !== e) {
  ...
  System.registerDynamic("21", [], !0, function(t, e, n) {
    "use strict";
    return e.PONY_SPEED_TROT = 4, e.PONY_SPEED_WALK = 2, e.SAYS_TIME = 6, e.REGION_SIZE = 20, e.MAP_SIZE = 3, e.CLOUD_COUNT = 10, e.CM_SIZE = 5, e.SAY_MAX_LENGTH = 64, e.PLAYER_NAME_MAX_LENGTH = 20, e.ACCOUNT_NAME_MIN_LENGTH = 1, e.ACCOUNT_NAME_MAX_LENGTH = 32, e.PONY_LIMIT = 16, e.frameTime = 24, e.tileWidth = 32, e.tileHeight = 24, e.tileCols = 4, e.tileRows = 8, e.MINUTE = 6e4, e.HOUR = 36e5, e.TIMEOUTS = [{
      value: 0,
      label: "unmute"
    }, {
      value: 5 * e.MINUTE,
  ...
  System.registerDynamic("22", [getCodeName("BlueBird"), getCodeName("Lodash"), "21"], !0, function(t, e, n) {
    ...
    function S(t, e) {
      void 0 === e && (e = !1);
      for (var n = e ? K : Z, r = "", i = 0; i < t; i++) r += n[Math.random() * n.length | 0];
      return r
    }
    ...
    function T(t) {
      var n = t.data,
        r = t.status,
        i = n;
      throw 500 !== r && 5 === Math.floor(r / 100) ? new Error(e.PROTECTION_ERROR) : 403 === r ? new Error(e.ACCESS_ERROR) : new Error(i && i.error || e.OFFLINE_ERROR)
    }
    ...
    function O(t) {
      "imageSmoothingEnabled" in t ? t.imageSmoothingEnabled = !1 : (t.webkitImageSmoothingEnabled = !1, t.mozImageSmoothingEnabled = !1, t.msImageSmoothingEnabled = !1)
    }
      ...
      var e, n = !1,
        r = G.resolve(t.load()).then(function() {
          ...
          e = requestAnimationFrame(function n(s) {
            e = requestAnimationFrame(n), o++, s - i > 1e3 && (a = 1e3 * o / (s - i), o = 0, i = s), t.update((s - r) / 1e3), t.draw(a), r = s
          })
        }),
        i = function() {
          cancelAnimationFrame(e), n = !0
        };
      return {
        promise: r,
        cancel: i
    ...
    e.matchString = r, e.fromNow = i, e.hasFlag = o, e.at = a, e.clamp = s, e.findById = u, e.remove = l, e.removeById = c, e.randomInt = f, e.randomItem = p, e.normalize = h, e.contains = d, e.containsPoint = v, e.length = m, e.distance = g, e.entitiesIntersect = y, e.rectsIntersect = b, e.addRects = _, e.collidersIntersect = w, e.intersect = x, e.isSurrogate = E, e.fromSurrogate = $, e.randomString = S, e.ACCESS_ERROR = "Access denied", e.OFFLINE_ERROR = "Server is offline", e.PROTECTION_ERROR = "DDOS protection error, reload the page to continue", e.handleReject = T, e.toPromise = k, e.errorHandler = M, e.getPixelRatio = A, e.createCanvas = C, e.loadImage = D, e.disableImageSmoothing = O;
    var Q = [
        [0, -1],
        [.5, -1],
        [1, -1],
      ...
      et = 2 * Math.PI,
      nt = Q.length / et;
    return e.flagsToSpeed = I, e.dirToVector = R, e.vectorToDir = F, e.encodeMovement = P, e.decodeMovement = j, e.isFacingRight = N, e.setupSetTes = L, e.start = U, e.setTransform = B, e.isPointer = V, e.isTouch = H, e.getButton = z, e.getX = Y, e.getY = q, n.exports});
  System.registerDynamic("3c", [getCodeName("BlueBird"), "36", "22"], !0, function(t, e, n) {
    ...
    function i(t, e) {
      return f.loadImage(e + t.src).then(function(e) {
        t.img = e, t.sprites.filter(function(t) {
          return !!t
        }).forEach(function(t) {
          return t.img = e
        })
    ...
    function s(t, e) {
      return p = p || f.createCanvas(t, e), (p.width < t || p.height < e) && (p.width = Math.max(p.width, t), p.height = Math.max(p.height, e)), p.getContext("2d")
    }
    ...
    function u(t, e, n, r, i) {
      if (e && e.img) {
        var o = s(e.w, e.h),
          a = c.default.parse(n);
        o.fillStyle = "#" + a.toHexRGB(), o.globalCompositeOperation = "source-over", o.fillRect(0, 0, e.w, e.h), o.globalCompositeOperation = "destination-in", o.drawImage(e.img, e.x, e.y, e.w, e.h, 0, 0, e.w, e.h), o.globalCompositeOperation = "multiply", o.drawImage(e.img, e.x, e.y, e.w, e.h, 0, 0, e.w, e.h);
        var u = t.globalAlpha;
        t.globalAlpha = u * a.a, t.drawImage(o.canvas, 0, 0, e.w, e.h, r + e.ox, i + e.oy, e.w, e.h), t.globalAlpha = u
      }
    }
    ...
    var l = t(getCodeName("BlueBird")),
      c = t("36"),
      f = t("22");
    e.loadSprites = r, e.loadSpriteSheets = o, e.drawSprite = a;
    var p;
    return e.drawColoredSprite = u, n.exports});
  ...
  System.registerDynamic("1f", ["cb"], !0, function(t, e, n) {
    ...
    var p = t("cb"),
      h = p["pony.png"],
      d = p["pony2.png"],
      v = [null, [159, 284, 9, 7, 31, 28],
        [276, 298, 12, 6, 29, 30],
        [511, 11, 1, 1, 38, 28], null, [504, 76, 8, 7, 31, 28],
        [288, 298, 12, 6, 29, 30],
        [457, 314, 7, 4, 33, 30],
        [437, 304, 9, 5, 32, 30],
        [354, 298, 9, 6, 31, 29],
        ...
        [82, 284, 9, 7, 31, 28],
        [276, 298, 12, 6, 29, 30],
        [305, 314, 8, 4, 31, 28], null, [234, 304, 4, 6, 31, 29],
        [69, 315, 6, 4, 29, 32],
        [320, 309, 6, 5, 34, 28],
        [81, 315, 6, 4, 35, 30],
        [159, 284, 9, 7, 31, 28],
        ...
        [150, 213, 8, 15, 35, 26],
        [203, 212, 10, 15, 34, 28],
        [60, 195, 2, 1, 37, 26], null, [270, 237, 8, 14, 35, 27],
        [117, 228, 9, 14, 34, 29],
        [485, 263, 8, 11, 35, 26],
        [92, 265, 5, 11, 39, 28],
        [180, 276, 10, 8, 31, 27],
        ...
        [275, 208, 20, 15, 21, 20],
        [413, 177, 22, 17, 20, 19],
        [411, 252, 19, 12, 22, 21], null, [388, 211, 12, 15, 21, 20],
        [85, 179, 15, 17, 20, 19],
        [92, 253, 15, 12, 25, 21],
        [240, 209, 15, 15, 26, 19],
        [266, 283, 7, 8, 34, 25],
        ...
        [295, 208, 20, 15, 21, 20],
        [413, 177, 22, 17, 20, 19],
        [430, 252, 19, 12, 22, 22], null, [509, 23, 3, 11, 21, 24],
        [460, 193, 6, 14, 20, 22],
        [59, 227, 11, 14, 23, 20],
        [23, 212, 11, 15, 24, 19],
        [47, 254, 10, 12, 29, 21],
        ...
        [446, 324, 3, 2, 24, 32],
        [473, 80, 1, 3, 23, 32],
        [511, 144, 1, 2, 27, 32], null, [92, 235, 3, 5, 24, 34],
        [155, 285, 4, 6, 23, 35],
        [0, 298, 4, 7, 24, 32],
        [96, 196, 4, 9, 23, 32],
        [439, 318, 2, 4, 25, 34], null, [462, 324, 2, 2, 24, 32],
        [473, 80, 1, 3, 23, 32],
        [432, 156, 3, 2, 25, 32], null, [92, 235, 3, 5, 24, 34],
        [155, 285, 4, 6, 23, 35],
        [4, 298, 4, 7, 24, 32],
        [96, 196, 4, 9, 23, 32],
        [511, 154, 1, 1, 27, 32], null, null, [276, 154, 1, 1, 23, 34],
        [240, 190, 4, 2, 24, 32],
        [511, 150, 1, 2, 23, 32],
        [92, 235, 3, 5, 24, 34],
        [155, 285, 4, 6, 23, 35],
        ...
        [458, 263, 9, 11, 24, 33],
        [244, 154, 11, 20, 20, 31],
        [419, 136, 13, 22, 19, 30], null, [511, 152, 1, 1, 31, 32],
        [91, 284, 9, 7, 21, 31],
        [321, 274, 11, 9, 20, 30],
        [417, 39, 5, 16, 21, 35],
        [504, 57, 8, 19, 19, 33],
        ...
        [383, 158, 20, 19, 21, 20],
        [345, 131, 22, 22, 20, 19],
        [337, 251, 19, 12, 22, 22], null, [509, 23, 3, 11, 21, 24],
        [460, 193, 6, 14, 20, 22],
        [59, 227, 11, 14, 23, 20],
        [23, 212, 11, 15, 24, 19],
        [194, 227, 10, 14, 29, 21],
        ...
        [102, 265, 5, 11, 39, 35],
        [344, 237, 7, 14, 38, 33],
        [442, 121, 3, 8, 40, 37], null, [361, 265, 5, 11, 39, 35],
        [309, 237, 7, 14, 38, 33],
        [53, 298, 3, 7, 41, 36],
        [476, 283, 4, 8, 40, 37],
        [356, 265, 5, 11, 39, 35],
        [344, 237, 7, 14, 38, 33],
        [451, 70, 3, 10, 40, 36], null, [160, 255, 5, 11, 39, 35],
        [302, 237, 7, 14, 38, 33],
        [92, 227, 3, 8, 40, 38],
        [509, 34, 3, 10, 40, 37],
        [121, 255, 7, 12, 36, 37],
        ...
        [433, 264, 7, 11, 40, 33],
        [83, 241, 9, 13, 39, 32],
        [323, 322, 2, 3, 43, 37], null, [183, 304, 5, 6, 42, 33],
        [214, 254, 7, 12, 41, 32],
        [323, 322, 2, 3, 43, 37], null, [34, 265, 7, 11, 40, 33],
        [177, 241, 9, 13, 39, 32],
        [229, 266, 6, 10, 40, 34],
        [198, 254, 8, 12, 39, 33],
        [178, 304, 5, 6, 40, 38],
        ...
        [84, 138, 13, 22, 48, 42],
        [69, 115, 15, 24, 47, 41],
        [358, 153, 13, 20, 48, 43], null, [498, 133, 13, 22, 48, 42],
        [54, 115, 15, 24, 47, 41],
        [352, 173, 13, 18, 48, 46],
        [354, 274, 2, 2, 60, 61],
        [259, 224, 11, 14, 48, 42],
        ...
        [81, 227, 11, 14, 48, 42],
        [13, 196, 13, 16, 47, 41],
        [22, 266, 10, 10, 48, 44], null, [184, 227, 10, 14, 48, 42],
        [26, 196, 13, 16, 47, 41],
        [93, 276, 11, 8, 48, 45],
        [63, 284, 10, 7, 50, 47],
        [70, 227, 11, 14, 48, 42],
        ...
        [312, 173, 14, 18, 48, 48],
        [258, 304, 3, 6, 50, 48],
        [41, 298, 3, 7, 50, 49], null, [378, 173, 5, 4, 29, 38],
        [511, 11, 1, 1, 33, 41], null, [417, 55, 5, 5, 29, 38],
        [511, 11, 1, 1, 32, 42], null, [352, 318, 4, 4, 29, 38],
        [511, 11, 1, 1, 32, 42], null, [496, 309, 5, 5, 29, 38],
        [511, 11, 1, 1, 32, 42],
        [64, 195, 2, 1, 31, 42],
        [378, 173, 5, 4, 29, 38],
        [511, 11, 1, 1, 33, 41],
        [413, 324, 3, 2, 31, 41],
        [378, 173, 5, 4, 29, 38],
        [511, 11, 1, 1, 33, 41], null, [214, 315, 5, 4, 29, 38],
        [511, 11, 1, 1, 33, 42],
        [165, 250, 3, 4, 35, 34],
        [447, 318, 2, 4, 28, 34],
        [213, 304, 5, 6, 34, 33],
        ...
        [511, 11, 1, 1, 29, 37],
        [511, 153, 1, 1, 39, 36],
        [511, 153, 1, 1, 26, 36], null, null, [342, 324, 5, 2, 34, 37],
        [377, 324, 4, 2, 27, 37], null, null, [511, 153, 1, 1, 39, 37],
        [511, 153, 1, 1, 26, 37], null, null, [367, 324, 5, 2, 34, 37],
        [405, 324, 4, 2, 27, 37], null, null, [511, 153, 1, 1, 39, 37],
        [511, 153, 1, 1, 26, 37],
        [300, 298, 12, 6, 27, 33],
        [431, 298, 7, 6, 29, 33],
        [473, 318, 11, 3, 27, 39],
        ...
        [261, 304, 3, 6, 55, 59],
        [66, 178, 10, 1, 27, 38],
        [499, 106, 12, 3, 26, 37], null, [449, 318, 12, 3, 26, 37], null, [76, 178, 7, 1, 28, 38],
        [484, 318, 9, 3, 27, 37], null, [60, 195, 2, 1, 43, 31], null, [319, 322, 2, 3, 43, 30], null, [456, 324, 2, 2, 43, 30], null, [441, 318, 2, 4, 43, 30], null, [45, 310, 5, 5, 41, 31], null, [511, 11, 1, 1, 43, 33], null, [316, 153, 15, 20, 39, 20],
        [481, 133, 17, 22, 38, 19],
        [474, 57, 30, 26, 26, 17],
        [422, 32, 32, 28, 25, 16],
        [255, 209, 15, 15, 41, 18],
        [403, 158, 17, 19, 40, 16],
        [203, 241, 8, 13, 43, 17], null, [385, 265, 15, 10, 41, 19], null, [403, 86, 21, 26, 26, 17],
        [486, 29, 23, 28, 25, 16],
        [482, 208, 15, 15, 41, 17],
        [154, 180, 16, 17, 41, 16],
        [56, 241, 9, 13, 41, 20],
        [125, 197, 10, 16, 40, 19],
        [34, 240, 13, 13, 43, 18], null, [403, 86, 21, 26, 26, 17],
        [486, 29, 23, 28, 25, 16],
        [440, 210, 13, 15, 43, 17],
        [122, 180, 16, 17, 41, 16],
        [56, 241, 9, 13, 41, 20],
    ...
    return e.ponyFrontManes = [null, [
      ...
      [a(75, 76)],
      [a(77, 78), a(79, 80), a(81, 82), a(83, 84)],
      [a(85, 86), a(87, 88)],
      [a(89, 90), a(91, 92), a(93, 94)],
      [a(95, 96), a(97, 98)],
      [a(99, 100), a(101, 102), a(103, 104), a(105, 106)]
    ],
      [
        [a(107, 108)],
        [a(109, 110), a(111, 112), a(113, 114), a(115, 116)],
        [a(117, 118), a(119, 120)],
        [a(121, 122), a(123, 124), a(125, 126)],
        [a(127, 128), a(129, 130)],
        [a(131, 132), a(133, 134), a(135, 136), a(137, 138)]
      ],
      [
        [a(139, 140)],
        [a(141, 142), a(143, 144), a(145, 146), a(147, 148), a(149, 150)]
      ],
      [
        [a(151, 152)],
        [a(153, 154), a(155, 156), a(157, 158), a(159, 160), a(161, 162)]
      ],
      [
        [a(163, 164)],
        [a(165, 166), a(167, 168), a(169, 170), a(171, 172)]
      ],
      [
        [a(173, 174)],
        [a(175, 176), a(177, 178), a(179, 180), a(181, 182), a(183, 184)]
      ],
      [
        [a(185, 186)],
        [a(187, 188), a(189, 190), a(191, 192), a(193, 194)]
      ],
      [
        [a(195, 196)],
        [a(197, 198), a(199, 200), a(201, 202), a(203, 204), a(205, 206)]
      ],
      [
        [a(207, 208)],
        [a(209, 210), a(211, 212), a(213, 214)]
      ]
    ], e.ponyBehindManes = [null, [
      [a(215, 216)],
      [, a(217, 218), a(219, 220), , a(221, 222)],
      [a(223, 224), a(225, 226)],
      [a(227, 228), a(229, 230), , a(231, 232)],
      [a(233, 234), a(235, 236)],
      [a(237, 238), a(239, 240), , , a(241, 242)]
    ],
      [],
      [
        [a(243, 244)],
      ...
      [
        [a(249, 250)],
        [, a(251, 252), a(253, 254), a(255, 256), a(257, 258), a(259, 260)]
      ]
    ], e.ponyManes = [null, [
      [a(261, 262)],
      [a(263, 264), a(265, 266), a(267, 268), a(269, 270), a(271, 272)],
      [a(273, 274), a(275, 276)],
      [a(277, 278), a(279, 280), a(281, 282), a(283, 284)],
      [a(285, 286), a(287, 288)],
      [a(289, 290), a(291, 292), a(293, 294), a(295, 296), a(297, 298)]
    ],
      [
        [a(299, 300)],
        [a(301, 302), a(303, 304), a(305, 306), a(307, 308)],
        [a(309, 310), a(311, 312)],
        [a(313, 314), a(315, 316), a(317, 318)],
        [a(319, 320), a(321, 322)],
        [a(323, 324), a(325, 326), a(327, 328), a(329, 330)]
      ],
      [
        [a(331, 332)],
        [a(333, 334), a(335, 336), a(337, 338), a(339, 340), a(341, 342), a(343, 344)]
      ],
      [
        [a(345, 346)],
        [a(347, 348), a(349, 350), a(351, 352), a(353, 354), a(355, 356)]
      ],
      [
        [a(357, 358)],
        [a(359, 360), a(361, 362), a(363, 364), a(365, 366)]
      ],
      [
        [a(367, 368)],
        [a(369, 370), a(371, 372), a(373, 374), a(375, 376), a(377, 378)]
      ],
      [
        [a(379, 380)],
        [a(381, 382), a(383, 384), a(385, 386), a(387, 388)]
      ],
      [
        [a(389, 390)],
        [a(391, 392), a(393, 394), a(395, 396), a(397, 398), a(399, 400)]
      ],
      [
        [a(401, 402)],
      ...
      [
        [a(439, 440)],
        [a(441, 442), a(443, 444), a(445, 446), a(447, 448)]
      ],
      [],
      [],
      [],
      ...
      [
        [a(449, 450), a(451, 452)],
        [a(453, 454), a(455, 456), a(457, 458), a(459, 460), a(461, 462), a(463, 464)]
      ],
      [],
      [
        [a(465, 466), a(467, 468)],
        [a(469, 470), a(471, 472), a(473, 474), a(475, 476), a(477, 478)]
      ],
      [
        [a(479, 480)],
        [a(481, 482), a(483, 484)]
      ...
      [
        [a(485, 486)],
        [a(487, 488), a(489, 490), a(491, 492), a(493, 494)]
      ],
      [
        [a(495, 496)],
        [a(497, 498), a(499, 500), a(501, 502), a(503, 504)]
      ]
      ...
      [a(505, 506)],
      [a(507, 508), a(509, 510), a(511, 512), a(513, 514)],
      [a(515, 516), a(517, 518)],
      [a(519, 520), a(521, 522)],
      [a(523, 524), a(525, 526)],
      [a(527, 528), a(529, 530)]
      ...
      [
        [a(531, 532)],
        [a(533, 534), a(535, 536), a(537, 538), a(539, 540)],
        [a(541, 542), a(543, 544)],
        [a(545, 546), a(547, 548)],
        [a(549, 550), a(551, 552)],
        [a(553, 554), a(555, 556)]
      ...
      [
        [a(557, 558)],
        [a(559, 560), a(561, 562), a(563, 564), a(565, 566), a(567, 568)]
      ],
      [
        [a(569, 570)],
        [a(571, 572), a(573, 574), a(575, 576), a(577, 578), a(579, 580)]
      ],
      [
        [a(581, 582)],
        [a(583, 584), a(585, 586), a(587, 588), a(589, 590)]
      ],
      [
        [a(591, 592)],
        [a(593, 594), a(595, 596), a(597, 598), a(599, 600), a(601, 602)]
      ]
    ], e.ponyNoses = [l(603, 604, 605), l(606, 607, 608), l(609, 610, 611), l(612, 613, 614), l(615, 616, 617), l(618, 619, 620), l(621, 622, 623)], e.ponyEyeLeft = [null, c(624, 626, 628, 630), c(632, 634, 636, 638), c(640, 642, 644, 646), c(648, 650, 652, 654), c(656, 658, 660, 662), c(664, 666, 668, 670)], e.ponyEyeRight = [null, c(625, 627, 629, 631), c(633, 635, 637, 639), c(641, 643, 645, 647), c(649, 651, 653, 655), c(657, 659, 661, 663), c(665, 667, 669, 671)], e.ponyFreckles = [null, v[674], v[675], v[676], v[677]], e.ponyHorns = [null, [
      [a(678, 679)]
    ],
      [
        [a(680, 681)]
      ...
      [a(682, 683)]
    ]], e.ponyLegFrontStand = [a(684, 685)], e.ponyLegBackStand = [a(686, 687)], e.ponyLegFrontTrot = [a(698, 699), a(700, 701), a(702, 703), a(704, 705), a(706, 707), a(708, 709), a(710, 711), a(712, 713), a(714, 715), a(716, 717), a(718, 719), a(720, 721), a(722, 723), a(724, 725), a(726, 727), a(728, 729)], e.ponyLegBackTrot = [a(730, 731), a(732, 733), a(734, 735), a(736, 737), a(738, 739), a(740, 741), a(742, 743), a(744, 745), a(746, 747), a(748, 749), a(750, 751), a(752, 753), a(754, 755), a(756, 757), a(758, 759), a(760, 761)], e.ponyBobsBodyTrot = [o(0, 1), o(0, 0), o(0, -1), o(0, -2), o(0, -2), o(0, -2), o(0, -1), o(0, 0), o(0, 1), o(0, 0), o(0, -1), o(0, -2), o(0, -2), o(0, -2), o(0, -1), o(0, 0)], e.ponyBobsHeadTrot = [o(0, 0), o(0, 0), o(0, -1), o(0, -2), o(0, -2), o(0, -2), o(0, -1), o(0, 0), o(0, 0), o(0, 0), o(0, -1), o(0, -2), o(0, -2), o(0, -2), o(0, -1), o(0, 0)], e.ponyFetlocksFrontStand = [a(762, 763)], e.ponyFetlocksFrontTrot = [a(764, 765), a(766, 767), a(768, 769), a(770, 771), a(772, 773), a(774, 775), a(776, 777), a(778, 779), a(780, 781), a(782, 783), a(784, 785), a(786, 787), a(788, 789), a(790, 791), a(792, 793), a(794, 795)], e.ponyFetlocksBackStand = [a(796, 797)], e.ponyFetlocksBackTrot = [a(798, 799), a(800, 801), a(802, 803), a(804, 805), a(806, 807), a(808, 809), a(810, 811), a(812, 813), a(814, 815), a(816, 817), a(818, 819), a(820, 821), a(822, 823), a(824, 825), a(826, 827), a(828, 829)], e.ponyFrontLegAccessoriesStand = [
      [null, [
        [a(830, 831)],
        [a(832, 833), a(834, 835), a(836, 837), a(838, 839), a(840, 841), a(842, 843)]
      ]]
    ], e.ponyFrontLegAccessoriesTrot = [
      [null, [
        [a(844, 845)],
        [a(846, 847), a(848, 849), a(850, 851), a(852, 853), a(854, 855), a(856, 857)]
      ]],
      [null, [
        [a(858, 859)],
        [a(860, 861), a(862, 863), a(864, 865), a(866, 867), a(868, 869), a(870, 871)]
      ]],
      [null, [
        [a(872, 873)],
        [a(874, 875), a(876, 877), a(878, 879), a(880, 881), a(882, 883), a(884, 885)]
      ]],
      [null, [
        [a(886, 887)],
        [a(888, 889), a(890, 891), a(892, 893), a(894, 895), a(896, 897), a(898, 899)]
      ]],
      [null, [
        [a(900, 901)],
        [a(902, 903), a(904, 905), a(906, 907), a(908, 909), a(910, 911), a(912, 913)]
      ]],
      [null, [
        [a(914, 915)],
        [a(916, 917), a(918, 919), a(920, 921), a(922, 923), a(924, 925), a(926, 927)]
      ]],
      [null, [
        [a(928, 929)],
        [a(930, 931), a(932, 933), a(934, 935), a(936, 937), a(938, 939), a(940, 941)]
      ]],
      [null, [
        [a(942, 943)],
        [a(944, 945), a(946, 947), a(948, 949), a(950, 951), a(952, 953), a(954, 955)]
      ]],
      [null, [
        [a(956, 957)],
        [a(958, 959), a(960, 961), a(962, 963), a(964, 965), a(966, 967), a(968, 969)]
      ]],
      [null, [
        [a(970, 971)],
        [a(972, 973), a(974, 975), a(976, 977), a(978, 979), a(980, 981), a(982, 983)]
      ]],
      [null, [
        [a(984, 985)],
        [a(986, 987), a(988, 989), a(990, 991), a(992, 993), a(994, 995), a(996, 997)]
      ]],
      [null, [
        [a(998, 999)],
        [a(1e3, 1001), a(1002, 1003), a(1004, 1005), a(1006, 1007), a(1008, 1009), a(1010, 1011)]
      ]],
      [null, [
        [a(1012, 1013)],
        [a(1014, 1015), a(1016, 1017), a(1018, 1019), a(1020, 1021), a(1022, 1023), a(1024, 1025)]
      ]],
      [null, [
        [a(1026, 1027)],
        [a(1028, 1029), a(1030, 1031), a(1032, 1033), a(1034, 1035), a(1036, 1037), a(1038, 1039)]
      ]],
      [null, [
        [a(1040, 1041)],
        [a(1042, 1043), a(1044, 1045), a(1046, 1047), a(1048, 1049), a(1050, 1051), a(1052, 1053)]
      ]],
      [null, [
        [a(1054, 1055)],
        [a(1056, 1057), a(1058, 1059), a(1060, 1061), a(1062, 1063), a(1064, 1065), a(1066, 1067)]
      ]]
    ], e.ponyBackLegAccessoriesStand = [
      [null, [
        [a(1068, 1069)],
        [a(1070, 1071), a(1072, 1073), a(1074, 1075), a(1076, 1077), a(1078, 1079), a(1080, 1081)]
      ]]
    ], e.ponyBackLegAccessoriesTrot = [
      [null, [
        [a(1082, 1083)],
        [a(1084, 1085), a(1086, 1087), a(1088, 1089), a(1090, 1091), a(1092, 1093), a(1094, 1095)]
      ]],
      [null, [
        [a(1096, 1097)],
        [a(1098, 1099), a(1100, 1101), a(1102, 1103), a(1104, 1105), a(1106, 1107), a(1108, 1109)]
      ]],
      [null, [
        [a(1110, 1111)],
        [a(1112, 1113), a(1114, 1115), a(1116, 1117), a(1118, 1119), a(1120, 1121), a(1122, 1123)]
      ]],
      [null, [
        [a(1124, 1125)],
        [a(1126, 1127), a(1128, 1129), a(1130, 1131), a(1132, 1133), a(1134, 1135), a(1136, 1137)]
      ]],
      [null, [
        [a(1138, 1139)],
        [a(1140, 1141), a(1142, 1143), a(1144, 1145), a(1146, 1147), a(1148, 1149), a(1150, 1151)]
      ]],
      [null, [
        [a(1152, 1153)],
        [a(1154, 1155), a(1156, 1157), a(1158, 1159), a(1160, 1161), a(1162, 1163), a(1164, 1165)]
      ]],
      [null, [
        [a(1166, 1167)],
        [a(1168, 1169), a(1170, 1171), a(1172, 1173), a(1174, 1175), a(1176, 1177), a(1178, 1179)]
      ]],
      [null, [
        [a(1180, 1181)],
        [a(1182, 1183), a(1184, 1185), a(1186, 1187), a(1188, 1189), a(1190, 1191), a(1192, 1193)]
      ]],
      [null, [
        [a(1194, 1195)],
        [a(1196, 1197), a(1198, 1199), a(1200, 1201), a(1202, 1203), a(1204, 1205), a(1206, 1207)]
      ]],
      [null, [
        [a(1208, 1209)],
        [a(1210, 1211), a(1212, 1213), a(1214, 1215), a(1216, 1217), a(1218, 1219), a(1220, 1221)]
      ]],
      [null, [
        [a(1222, 1223)],
        [a(1224, 1225), a(1226, 1227), a(1228, 1229), a(1230, 1231), a(1232, 1233), a(1234, 1235)]
      ]],
      [null, [
        [a(1236, 1237)],
        [a(1238, 1239), a(1240, 1241), a(1242, 1243), a(1244, 1245), a(1246, 1247), a(1248, 1249)]
      ]],
      [null, [
        [a(1250, 1251)],
        [a(1252, 1253), a(1254, 1255), a(1256, 1257), a(1258, 1259), a(1260, 1261), a(1262, 1263)]
      ]],
      [null, [
        [a(1264, 1265)],
        [a(1266, 1267), a(1268, 1269), a(1270, 1271), a(1272, 1273), a(1274, 1275), a(1276, 1277)]
      ]],
      [null, [
        [a(1278, 1279)],
        [a(1280, 1281), a(1282, 1283), a(1284, 1285), a(1286, 1287), a(1288, 1289), a(1290, 1291)]
      ]],
      [null, [
        [a(1292, 1293)],
        [a(1294, 1295), a(1296, 1297), a(1298, 1299), a(1300, 1301), a(1302, 1303), a(1304, 1305)]
      ]]
      ...
      [
        [a(1328, 1329)],
        [a(1330, 1331), a(1332, 1333), a(1334, 1335), a(1336, 1337)],
        [a(1338, 1339), a(1340, 1341), a(1342, 1343), a(1344, 1345)],
        [a(1346, 1347), a(1348, 1349), a(1350, 1351), a(1352, 1353)]
      ],
      [
        [a(1354, 1355)],
        [a(1356, 1357), a(1358, 1359)],
        [a(1360, 1361), a(1362, 1363), a(1364, 1365)],
        [a(1366, 1367), a(1368, 1369), a(1370, 1371), a(1372, 1373)],
        [a(1374, 1375), a(1376, 1377), a(1378, 1379)]
      ]
    ], e.ponyNeckAccessories = [null, [
      [a(1380, 1381)],
      [a(1382, 1383), a(1384, 1385)]
    ],
      [
        [a(1386, 1387)],
        [a(1388, 1389), a(1390, 1391)],
        [a(1392, 1393), a(1394, 1395), a(1396, 1397), a(1398, 1399)],
        [a(1400, 1401), a(1402, 1403)]
      ],
      [
        [a(1404, 1405)],
        [a(1406, 1407), a(1408, 1409)],
        [a(1410, 1411), a(1412, 1413), a(1414, 1415)],
        [a(1416, 1417), a(1418, 1419), a(1420, 1421), a(1422, 1423), a(1424, 1425), a(1426, 1427)],
        [a(1428, 1429), a(1430, 1431), a(1432, 1433)]
      ]
    ], e.ponyFacialHair = [null, [
      [a(1434, 1435)]
    ]], e.butterfly = [v[1720], v[1721], v[1722], v[1723]], e.ponyEyeshadow = v[672], e.ponyEyeshadowShine = v[673], e.ponyBody = a(688, 689), e.ponyHead = a(690, 691), e.ponyEar = a(692, 693), e.ponyEar2 = a(694, 695), e.ponyShadow = v[696], e.ponySelection = v[697], e.tree = f(1436, 1437, 1438, 1439, 1440), e.apple = u(1441, 1442), e.pumpkin = u(1443, 1444), e.rock = u(1445, 1446), e.bubble = v[1709], e.bubble2 = v[1710], e.cloud = v[1711], e.heartemote = v[1712], e.nipple = v[1713], e.nipple2 = v[1714], e.pixel = v[1715], e.pizzaemote = v[1716], e.pumpkinemote = v[1717], e.rockemote = v[1718], e.sign = v[1719], e.ponFreckles = [null, m[1], m[2], m[3], m[4]], e.ponLegFrontStand = [m[5]], e.ponLegBackStand = [m[6]], e.ponBody = m[7], e.ponHead = m[8], e.ponEar = m[9], e.ponEar2 = m[10], e.ponShadow = m[11], e.tileSheet = p["tiles.png"], e.tileSprite = {
      x: 0,
      y: 0,
      w: 32,
      h: 24,
  ...
  System.registerDynamic("5d", ["1f"], !0, function(t, e, n) {
    ...
    }, e.animations = [e.stand, e.trot], n.exports
  });
  System.registerDynamic("44", ["21", "22", "24", "1f", "3c", "5d"], !0, function(t, e, n) {
    ...
    function i(t, n, r, i, u, c, p) {
      var h = i - e.PONY_WIDTH / 2,
        ...
        S = h + w.x,
        T = d + w.y;
      p && t.drawSprite(y.ponySelection, null, h, d), t.drawSprite(y.ponyShadow, g.SHADOW_COLOR, h, d), l(t, y.ponyBackBehindManes, n.backMane, S, T);
      ...
      o(t, C, D, O, R, P, n.darkFrontLegAccessory, _, n.darkCoatFill, n.darkCoatOutline, n.darkFrontHoovesFill, n.darkFrontHoovesOutline), o(t, C, D, I, F, j, n.darkBackLegAccessory, _, n.darkCoatFill, n.darkCoatOutline, n.darkBackHoovesFill, n.darkBackHoovesOutline), l(t, y.ponyTails, n.tail, E, $), s(t, y.ponyBody, n.coatFill, n.coatOutline, E, $);
      ...
      o(t, h, d, O, R, P, n.frontLegAccessory, b, n.coatFill, n.coatOutline, N, L), o(t, h, d, I, F, j, n.backLegAccessory, b, n.coatFill, n.coatOutline, U, B), f(t, n.cm, E + 43, $ + 49, c && n.cmFlip), l(t, y.ponyWings, n.wings, E, $), l(t, y.ponyNeckAccessories, n.neckAccessory, E, $), a(t, n, S, T, r.blinkFrame, c)
    }

    function o(t, e, n, r, i, o, a, u, l, c, f, p) {
      s(t, m.at(r, u), l, c, e, n), s(t, m.at(i, u), f, p, e, n)
    }

    function a(t, e, n, r, i, o) {
      void 0 === i && (i = 1), l(t, y.ponyBehindManes, e.mane, n, r), s(t, y.ponyEar2, e.coatFill, e.coatOutline, n, r), s(t, y.ponyHead, e.coatFill, e.coatOutline, n, r), l(t, y.ponyFacialHair, e.facialHair, n, r);
      var a = m.at(y.ponyNoses, e.muzzle);
      t.drawSprite(a.mouth, g.WHITE, n, r), t.drawSprite(a.muzzle, e.coatOutline, n, r), e.fangs && t.drawSprite(a.fangs, g.WHITE, n, r);
      var u = 0 | e.freckles;
      o && 3 === u ? u = 4 : o && 4 === u && (u = 3), t.drawSprite(m.at(y.ponyFreckles, u), e.frecklesColor, n, r), e.eyeshadow && (t.drawSprite(y.ponyEyeshadow, e.eyeshadowColor, n, r), t.drawSprite(y.ponyEyeshadowShine, g.SHINES_COLOR, n, r));
      ...
      c(t, m.at(y.ponyEyeLeft, Math.max(i, h)), e, f, n, r), c(t, m.at(y.ponyEyeRight, Math.max(i, d)), e, p, n, r), l(t, y.ponyBackFrontManes, e.backMane, n, r), l(t, y.ponyTopManes, e.mane, n, r), l(t, y.ponyHorns, e.horn, n, r), s(t, y.ponyEar, e.coatFill, e.coatOutline, n, r), l(t, y.ponyFaceAccessories, e.faceAccessory, n, r), l(t, y.ponyEarAccessories, e.earAccessory, n, r), l(t, y.ponyFrontManes, e.mane, n, r)
    }

    function s(t, e, n, r, i, o) {
      e && e.fill && t.drawSprite(e.fill, n, i, o), e && e.outline && t.drawSprite(e.outline, r, i, o), e && e.extra && t.drawSprite(e.extra, g.WHITE, i, o)
    }
    ...
    function c(t, e, n, r, i, o) {
      e && (t.drawSprite(e.fill, n.eyeWhites, i, o), t.drawSprite(e.iris, r, i, o), t.drawSprite(e.line, g.BLACK, i, o), n.eyelashes && t.drawSprite(e.lashes, n.coatOutline, i, o))
    }
      ...
      try {
        i({
          ...
          drawRect: function(e, n, r, i, o) {
            t.fillStyle = e ? e.css() : "white", t.fillRect(n, r, i, o)
          }
        }, e, n, r, o, a, s)
      } catch (t) {
        console.error(t)
    ...
    var v = t("21"),
      ...
      b = t("3c"),
      _ = t("5d");
    return e.PONY_WIDTH = 80, e.PONY_HEIGHT = 70, e.BLINK_FRAMES = [2, 6, 6, 4, 2], e.createDefaultPonyState = r, e.drawPony2D = p, e.drawPonyGL = h, e.drawPonyGL2 = d, n.exports
  });
  System.registerDynamic("cc", ["21", "32", "44"], !0, function(t, e, n) {
    ...
    var r = t("21"),
      ...
      a = function() {
        function t(t, e, n) {
          this.$location = t, this.gameService = e, this.model = n, this.maxNameLength = r.PLAYER_NAME_MAX_LENGTH, this.state = o.createDefaultPonyState(), this.authError = t.search().error
        }
        ...
        return Object.defineProperty(t.prototype, "joining", {
          ...
          this.model.selectPony(i.createDefaultPony()), this.$location.url("/character")
        }, t.prototype.select = function(t) {
          this.model.selectPony(t)
        }, t.$inject = ["$location", "gameService", "model"], t
      }();
  ...
  System.registerDynamic("d1", [getCodeName("AngularRoute"), getCodeName("AngularAnimate"), "b", getCodeName("Angular"), "c3", "c4", "c6", "c7", "cc", "cd", "ce", "cf", "d0"], !0, function(t, e, n) {
    ...
    var o = function() {
      function t(t, e) {
        this.gameService = t, this.model = e
      }
  ...
  System.registerDynamic("20", [], !0, function(t, e, n) {
    ...
    return e.debug = "true" === r("data-debug"), e.debugOptions = e.debug && "undefined" != typeof localStorage ? localStorage : {}, e.version = r("data-version") || null, e.oauthProviders = JSON.parse(i("oauth-providers") || "[]"), n.exports
  });
  System.registerDynamic("main", ["3", "4", "5", "d1", getCodeName("BlueBird"), getCodeName("Angular"), "20"], !0, function(t, e, n) {
    "use strict";
    window.__ponytown = !0, t("3"), t("4"), t("5"), t("d1");
    var r = t(getCodeName("BlueBird")),
