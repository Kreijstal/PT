...
var modules = function(System) {
    ...
    System.registerDynamic("c0", ["5e", "5c", "22", "21", "2a", "2b", "5f", "24", "23", "60", "68", "6b", "6c", "89", "69", "1f", "bf", "3c", "43", "20"], !0, function(t, e, n) {
        ...
        function o(t) {
            t.addEmoticon(":apple:", "ðŸŽ", w.apple.color),
            t.addEmoticon(":heart:", "â¤", w.heartemote),
            t.addEmoticon(":pumpkin:", "ðŸŽƒ", w.pumpkinemote),
            t.addEmoticon(":pizza:", "ðŸ•", w.pizzaemote),
            t.addEmoticon(":rock:", "â½¯", w.rockemote),
            t.addEmoticon(":face:", "ãƒ„"),
            t.addEmoticon(":derp:", "ã‚·")
        }
    ...
    System.registerDynamic("c2", ["53", "21", "54", "22", "55", "2c", "2d", "c1"], !0, function(t, e, n) {
        ...
        p = function() {
            ...
            t.prototype.$onChanges = function(t) {
                if (t.pony) {
                    this.name = this.pony.name.replace(/:apple:/g, "ðŸŽ").replace(/:heart:/g, "â¤").replace(/:pumpkin:/g, "ðŸŽƒ").replace(/:pizza:/g, "ðŸ•").replace(/:rock:/g, "â½¯").replace(/:face:/g, "ãƒ„").replace(/:derp:/g, "ã‚·"),
